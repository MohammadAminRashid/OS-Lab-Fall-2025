...
801003b0:	e8 fb 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 84 76 10 80 	movl   $0x80107684,(%esp)
...
801004ea:	e8 f1 57 00 00       	call   80105ce0 <uartputc>
801004ef:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f6:	e8 e5 57 00 00       	call   80105ce0 <uartputc>
801004fb:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100502:	e8 d9 57 00 00       	call   80105ce0 <uartputc>
...
801005cb:	e8 00 40 00 00       	call   801045d0 <acquire>
  for(i = 0; i < n; i++)
...
80100604:	e8 67 3f 00 00       	call   80104570 <release>
  ilock(ip);
80100609:	58                   	pop    %eax
...
8010064b:	0f b6 92 d8 76 10 80 	movzbl -0x7fef8928(%edx),%edx
...
801007d8:	e8 f3 3d 00 00       	call   801045d0 <acquire>
  if (fmt == 0)
...
801007fb:	e8 70 3d 00 00       	call   80104570 <release>
...
801008b3:	e8 18 3d 00 00       	call   801045d0 <acquire>
  while((c = getc()) >= 0){
...
801008ed:	e8 7e 3c 00 00       	call   80104570 <release>
  if(doprocdump) {
...
80100b14:	0f 85 f1 00 00 00    	jne    80100c0b <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
80100b1a:	e8 31 63 00 00       	call   80106e50 <setupkvm>
...
80100b8b:	e8 f0 60 00 00       	call   80106c80 <allocuvm>
...
80100bc1:	e8 ea 5f 00 00       	call   80106bb0 <loaduvm>
...
80100c03:	e8 c8 61 00 00       	call   80106dd0 <freevm>
  if(ip){
...
80100cca:	e8 f1 3b 00 00       	call   801048c0 <strlen>
...
80100cee:	e8 cd 63 00 00       	call   801070c0 <copyout>
...
80100d03:	e8 c8 60 00 00       	call   80106dd0 <freevm>
...
80100d5f:	e8 5c 63 00 00       	call   801070c0 <copyout>
...
80100d9f:	e8 dc 3a 00 00       	call   80104880 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100dcb:	e8 50 5c 00 00       	call   80106a20 <switchuvm>
  freevm(oldpgdir);
80100dd0:	89 34 24             	mov    %esi,(%esp)
80100dd3:	e8 f8 5f 00 00       	call   80106dd0 <freevm>
  return 0;
...
80100e0d:	e9 17 ff ff ff       	jmp    80100d29 <exec+0x279>
    end_op();
80100e12:	e8 c9 1f 00 00       	call   80102de0 <end_op>
    cprintf("exec: fail\n");
...
80100e40:	e8 9b 35 00 00       	call   801043e0 <initlock>
}
...
80100e61:	e8 6a 37 00 00       	call   801045d0 <acquire>
...
80100e91:	e8 da 36 00 00       	call   80104570 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100eaa:	e8 c1 36 00 00       	call   80104570 <release>
}
...
80100ecf:	e8 fc 36 00 00       	call   801045d0 <acquire>
  if(f->ref < 1)
...
80100eec:	e8 7f 36 00 00       	call   80104570 <release>
  return f;
}
...
80100f21:	e8 aa 36 00 00       	call   801045d0 <acquire>
  if(f->ref < 1)
...
80100f5c:	e8 0f 36 00 00       	call   80104570 <release>
...
80100f8d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f8e:	e9 dd 35 00 00       	jmp    80104570 <release>
80100f93:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80100f97:	90                   	nop
    begin_op();
80100f98:	e8 d3 1d 00 00       	call   80102d70 <begin_op>
    iput(ff.ip);
80100f9d:	83 ec 0c             	sub    $0xc,%esp
80100fa0:	ff 75 e0             	push   -0x20(%ebp)
80100fa3:	e8 58 09 00 00       	call   80101900 <iput>
    end_op();
...
80100fb1:	5d                   	pop    %ebp
    end_op();
80100fb2:	e9 29 1e 00 00       	jmp    80102de0 <end_op>
...
80100fc9:	e8 62 25 00 00       	call   80103530 <pipeclose>
...
80101005:	e8 c6 07 00 00       	call   801017d0 <ilock>
    stati(f->ip, st);
8010100a:	58                   	pop    %eax
8010100b:	5a                   	pop    %edx
8010100c:	ff 75 0c             	push   0xc(%ebp)
8010100f:	ff 73 10             	push   0x10(%ebx)
80101012:	e8 99 0a 00 00       	call   80101ab0 <stati>
    iunlock(f->ip);
80101017:	59                   	pop    %ecx
80101018:	ff 73 10             	push   0x10(%ebx)
8010101b:	e8 90 08 00 00       	call   801018b0 <iunlock>
    return 0;
  }
  return -1;
}
...
8010108e:	e8 1d 08 00 00       	call   801018b0 <iunlock>
    return r;
...
80101124:	e8 87 07 00 00       	call   801018b0 <iunlock>
      end_op();
80101129:	e8 b2 1c 00 00       	call   80102de0 <end_op>
...
8010114b:	0f 4f f8             	cmovg  %eax,%edi
      begin_op();
8010114e:	e8 1d 1c 00 00       	call   80102d70 <begin_op>
      ilock(f->ip);
80101153:	83 ec 0c             	sub    $0xc,%esp
80101156:	ff 73 10             	push   0x10(%ebx)
80101159:	e8 72 06 00 00       	call   801017d0 <ilock>
      if ((r = writei(f->ip, addr + i, f->off, n1)) > 0)
...
8010116b:	e8 70 0a 00 00       	call   80101be0 <writei>
...
80101180:	e8 2b 07 00 00       	call   801018b0 <iunlock>
      end_op();
80101185:	e8 56 1c 00 00       	call   80102de0 <end_op>
      if(r < 0)
...
801011c8:	5d                   	pop    %ebp
    return pipewrite(f->pipe, addr, n);
801011c9:	e9 02 24 00 00       	jmp    801035d0 <pipewrite>
  panic("filewrite");
...
801012a5:	e8 a6 1c 00 00       	call   80102f50 <log_write>
        brelse(bp);
...
801012cd:	e8 fe 33 00 00       	call   801046d0 <memset>
  log_write(bp);
...
8010130a:	e8 c1 32 00 00       	call   801045d0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101377:	e8 f4 31 00 00       	call   80104570 <release>
...
801013a5:	e8 c6 31 00 00       	call   80104570 <release>
      return ip;
...
8010143d:	e8 0e 1b 00 00       	call   80102f50 <log_write>
  brelse(bp);
...
801014e5:	e8 66 1a 00 00       	call   80102f50 <log_write>
...
80101561:	e8 fa 31 00 00       	call   80104760 <memmove>
  brelse(bp);
...
80101585:	8b 75 08             	mov    0x8(%ebp),%esi
80101588:	bb a0 f9 10 80       	mov    $0x8010f9a0,%ebx
  initlock(&icache.lock, "icache");
8010158d:	83 ec 08             	sub    $0x8,%esp
80101590:	68 9a 72 10 80       	push   $0x8010729a
80101595:	68 60 f9 10 80       	push   $0x8010f960
8010159a:	e8 41 2e 00 00       	call   801043e0 <initlock>
  for(i = 0; i < NINODE; i++) {
8010159f:	83 c4 10             	add    $0x10,%esp
801015a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    initsleeplock(&icache.inode[i].lock, "inode");
801015a8:	83 ec 08             	sub    $0x8,%esp
801015ab:	68 a1 72 10 80       	push   $0x801072a1
801015b0:	53                   	push   %ebx
  for(i = 0; i < NINODE; i++) {
801015b1:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
801015b7:	e8 f4 2c 00 00       	call   801042b0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
801015bc:	83 c4 10             	add    $0x10,%esp
801015bf:	81 fb c0 15 11 80    	cmp    $0x801115c0,%ebx
801015c5:	75 e1                	jne    801015a8 <iinit+0x28>
  bp = bread(dev, 1);
801015c7:	83 ec 08             	sub    $0x8,%esp
801015ca:	6a 01                	push   $0x1
801015cc:	56                   	push   %esi
801015cd:	e8 fe ea ff ff       	call   801000d0 <bread>
  memmove(sb, bp->data, sizeof(*sb));
801015d2:	83 c4 0c             	add    $0xc,%esp
  bp = bread(dev, 1);
801015d5:	89 c3                	mov    %eax,%ebx
  memmove(sb, bp->data, sizeof(*sb));
801015d7:	8d 40 5c             	lea    0x5c(%eax),%eax
801015da:	6a 1c                	push   $0x1c
801015dc:	50                   	push   %eax
801015dd:	68 b4 15 11 80       	push   $0x801115b4
801015e2:	e8 79 31 00 00       	call   80104760 <memmove>
  brelse(bp);
801015e7:	89 1c 24             	mov    %ebx,(%esp)
801015ea:	e8 01 ec ff ff       	call   801001f0 <brelse>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801015ef:	ff 35 cc 15 11 80    	push   0x801115cc
801015f5:	ff 35 c8 15 11 80    	push   0x801115c8
801015fb:	ff 35 c4 15 11 80    	push   0x801115c4
80101601:	ff 35 c0 15 11 80    	push   0x801115c0
80101607:	ff 35 bc 15 11 80    	push   0x801115bc
8010160d:	ff 35 b8 15 11 80    	push   0x801115b8
80101613:	ff 35 b4 15 11 80    	push   0x801115b4
80101619:	68 ec 76 10 80       	push   $0x801076ec
8010161e:	e8 8d f0 ff ff       	call   801006b0 <cprintf>
          cprintf("javad sharifi\n");
80101623:	83 c4 24             	add    $0x24,%esp
80101626:	68 a7 72 10 80       	push   $0x801072a7
8010162b:	e8 80 f0 ff ff       	call   801006b0 <cprintf>
          cprintf("Sadegh Mahdavi\n");
80101630:	c7 04 24 b6 72 10 80 	movl   $0x801072b6,(%esp)
80101637:	e8 74 f0 ff ff       	call   801006b0 <cprintf>
          cprintf("Mohammad Amin Rashid\n");
8010163c:	83 c4 10             	add    $0x10,%esp
8010163f:	c7 45 08 c6 72 10 80 	movl   $0x801072c6,0x8(%ebp)
}
80101646:	8d 65 f8             	lea    -0x8(%ebp),%esp
80101649:	5b                   	pop    %ebx
8010164a:	5e                   	pop    %esi
8010164b:	5d                   	pop    %ebp
          cprintf("Mohammad Amin Rashid\n");
8010164c:	e9 5f f0 ff ff       	jmp    801006b0 <cprintf>
80101651:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80101658:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010165f:	90                   	nop
...
8010170a:	5d                   	pop    %ebp
      return iget(dev, inum);
8010170b:	e9 e0 fb ff ff       	jmp    801012f0 <iget>
  panic("ialloc: no inodes");
80101710:	83 ec 0c             	sub    $0xc,%esp
80101713:	68 dc 72 10 80       	push   $0x801072dc
...
8010188d:	68 f4 72 10 80       	push   $0x801072f4
80101892:	e8 e9 ea ff ff       	call   80100380 <panic>
    panic("ilock");
80101897:	83 ec 0c             	sub    $0xc,%esp
8010189a:	68 ee 72 10 80       	push   $0x801072ee
...
801018e7:	68 03 73 10 80       	push   $0x80107303
...
8010199f:	e8 4c fa ff ff       	call   801013f0 <bfree>
      ip->addrs[i] = 0;
...
80101a1f:	e8 cc f9 ff ff       	call   801013f0 <bfree>
...
80101a3d:	e8 ae f9 ff ff       	call   801013f0 <bfree>
    ip->addrs[NDIRECT] = 0;
...
80101aa3:	68 03 73 10 80       	push   $0x80107303
...
80101b4a:	e8 21 f9 ff ff       	call   80101470 <bmap>
...
80101c4a:	e8 21 f8 ff ff       	call   80101470 <bmap>
...
80101d13:	c9                   	leave
80101d14:	c3                   	ret
80101d15:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80101da2:	e8 49 f5 ff ff       	call   801012f0 <iget>
}
...
80101db2:	68 1d 73 10 80       	push   $0x8010731d
80101db7:	e8 c4 e5 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101dbc:	83 ec 0c             	sub    $0xc,%esp
80101dbf:	68 0b 73 10 80       	push   $0x8010730b
...
80101f92:	e8 59 f3 ff ff       	call   801012f0 <iget>
...
80101fe1:	68 03 73 10 80       	push   $0x80107303
...
8010208b:	68 2c 73 10 80       	push   $0x8010732c
80102090:	e8 eb e2 ff ff       	call   80100380 <panic>
    panic("dirlink");
80102095:	83 ec 0c             	sub    $0xc,%esp
80102098:	68 88 75 10 80       	push   $0x80107588
...
801021ab:	68 42 73 10 80       	push   $0x80107342
801021b0:	e8 cb e1 ff ff       	call   80100380 <panic>
    panic("idestart");
801021b5:	83 ec 0c             	sub    $0xc,%esp
801021b8:	68 39 73 10 80       	push   $0x80107339
...
801021d6:	68 54 73 10 80       	push   $0x80107354
...
8010243a:	68 40 77 10 80       	push   $0x80107740
...
8010255b:	68 a1 73 10 80       	push   $0x801073a1
...
8010262b:	68 a7 73 10 80       	push   $0x801073a7
...
8010274b:	0f b6 91 a0 79 10 80 	movzbl -0x7fef8660(%ecx),%edx
  shift ^= togglecode[data];
80102752:	0f b6 81 a0 78 10 80 	movzbl -0x7fef8760(%ecx),%eax
  shift |= shiftcode[data];
...
80102768:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010276b:	8b 04 85 80 78 10 80 	mov    -0x7fef8780(,%eax,4),%eax
...
801027a5:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
801027a8:	0f b6 81 a0 79 10 80 	movzbl -0x7fef8660(%ecx),%eax
...
80102cda:	68 ac 73 10 80       	push   $0x801073ac
...
80102cf0:	e8 4b e8 ff ff       	call   80101540 <readsb>
...
80102f37:	68 b0 73 10 80       	push   $0x801073b0
...
80102fe5:	68 bf 73 10 80       	push   $0x801073bf
80102fea:	e8 91 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102fef:	83 ec 0c             	sub    $0xc,%esp
80102ff2:	68 d5 73 10 80       	push   $0x801073d5
...
80103018:	68 f0 73 10 80       	push   $0x801073f0
...
801030b3:	e8 88 cf ff ff       	call   80100040 <binit>
  fileinit();      // file table
801030b8:	e8 73 dd ff ff       	call   80100e30 <fileinit>
  ideinit();       // disk 
...
801031be:	68 04 74 10 80       	push   $0x80107404
...
80103279:	68 09 74 10 80       	push   $0x80107409
...
801033ab:	68 0e 74 10 80       	push   $0x8010740e
...
801033d2:	68 04 74 10 80       	push   $0x80107404
...
80103408:	68 74 77 10 80       	push   $0x80107774
...
801034b0:	00 00 00 
  initlock(&p->lock, "pipe");
801034b3:	68 26 74 10 80       	push   $0x80107426
...
80103507:	e8 04 da ff ff       	call   80100f10 <fileclose>
...
80103519:	e8 f2 d9 ff ff       	call   80100f10 <fileclose>
...
801038f6:	68 2b 74 10 80       	push   $0x8010742b
...
80103a5f:	68 5b 74 10 80       	push   $0x8010745b
80103a64:	50                   	push   %eax
80103a65:	e8 16 0e 00 00       	call   80104880 <safestrcpy>
  p->cwd = namei("/");
80103a6a:	c7 04 24 64 74 10 80 	movl   $0x80107464,(%esp)
...
80103aa3:	68 42 74 10 80       	push   $0x80107442
...
80103ead:	68 b3 74 10 80       	push   $0x801074b3
80103eb2:	e8 c9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103eb7:	83 ec 0c             	sub    $0xc,%esp
80103eba:	68 a6 74 10 80       	push   $0x801074a6
...
80103ff0:	68 bf 74 10 80       	push   $0x801074bf
...
801040f9:	68 c5 74 10 80       	push   $0x801074c5
801040fe:	e8 7d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 bf 74 10 80       	push   $0x801074bf
...
8010420b:	68 84 76 10 80       	push   $0x80107684
...
8010422c:	74 ea                	je     80104218 <procdump+0x28>
      state = "???";
8010422e:	ba d6 74 10 80       	mov    $0x801074d6,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104233:	83 f8 05             	cmp    $0x5,%eax
80104236:	77 11                	ja     80104249 <procdump+0x59>
80104238:	8b 14 85 a0 7a 10 80 	mov    -0x7fef8560(,%eax,4),%edx
      state = "???";
8010423f:	b8 d6 74 10 80       	mov    $0x801074d6,%eax
...
8010424e:	68 da 74 10 80       	push   $0x801074da
...
801042ba:	68 0d 75 10 80       	push   $0x8010750d
...
80104515:	68 18 75 10 80       	push   $0x80107518
8010451a:	e8 61 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010451f:	83 ec 0c             	sub    $0xc,%esp
80104522:	68 2f 75 10 80       	push   $0x8010752f
...
8010458b:	68 36 75 10 80       	push   $0x80107536
...
801046b8:	68 3e 75 10 80       	push   $0x8010753e
...
80104adc:	8b 14 85 c0 7a 10 80 	mov    -0x7fef8540(,%eax,4),%edx
...
80104b08:	68 46 75 10 80       	push   $0x80107546
...
80104c54:	68 7e 75 10 80       	push   $0x8010757e
...
80104c6c:	68 7d 75 10 80       	push   $0x8010757d
...
8010508d:	58                   	pop    %eax
8010508e:	5a                   	pop    %edx
8010508f:	68 7e 75 10 80       	push   $0x8010757e
...
801050a8:	68 7d 75 10 80       	push   $0x8010757d
...
801058de:	00 00 ef 
  initlock(&tickslock, "time");
801058e1:	68 c3 75 10 80       	push   $0x801075c3
...
80105964:	ff 24 85 18 7b 10 80 	jmp    *-0x7fef84e8(,%eax,4)
...
80105a35:	68 14 78 10 80       	push   $0x80107814
80105a3a:	e8 71 ac ff ff       	call   801006b0 <cprintf>
    myproc()->killed = 1;
...
80105a87:	68 bc 77 10 80       	push   $0x801077bc
80105a8c:	e8 1f ac ff ff       	call   801006b0 <cprintf>
    lapiceoi();
...
80105ba3:	68 e0 77 10 80       	push   $0x801077e0
80105ba8:	e8 03 ab ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105bad:	83 c4 14             	add    $0x14,%esp
80105bb0:	68 c8 75 10 80       	push   $0x801075c8
...
80105c60:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c63:	bf cd 75 10 80       	mov    $0x801075cd,%edi
...
80105c76:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105c79:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
...
80105d4b:	e8 50 ab ff ff       	call   801008a0 <consoleintr>
}
...
80106881:	68 a1 73 10 80       	push   $0x801073a1
...
8010696d:	68 d5 75 10 80       	push   $0x801075d5
...
80106b81:	89 75 10             	mov    %esi,0x10(%ebp)
...
80106b99:	68 1a 76 10 80       	push   $0x8010761a
...
80106be8:	68 34 76 10 80       	push   $0x80107634
...
80106c70:	68 58 78 10 80       	push   $0x80107858
...
80106d0d:	68 52 76 10 80       	push   $0x80107652
80106d12:	e8 99 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106d53:	68 6a 76 10 80       	push   $0x8010766a
80106d58:	e8 53 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106e3c:	68 86 76 10 80       	push   $0x80107686
...
80106f0c:	68 97 76 10 80       	push   $0x80107697
...
80106f82:	68 a1 76 10 80       	push   $0x801076a1
...
80107057:	68 bb 76 10 80       	push   $0x801076bb
