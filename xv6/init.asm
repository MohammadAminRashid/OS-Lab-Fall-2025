...
main(void)
{
  ...
  f1:	6a 01                	push   $0x1
  f3:	6a 01                	push   $0x1
  f5:	68 b8 07 00 00       	push   $0x7b8
  fa:	e8 ac 02 00 00       	call   3ab <mknod>
    open("console", O_RDWR);
  ff:	5b                   	pop    %ebx
 100:	58                   	pop    %eax
 101:	6a 02                	push   $0x2
 103:	68 b8 07 00 00       	push   $0x7b8
 ...
 418:	89 d1                	mov    %edx,%ecx
{
 ...
 44b:	0f b6 92 9c 08 00 00 	movzbl 0x89c(%edx),%edx
 ...
 4b9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 524:	ff 24 85 44 08 00 00 	jmp    *0x844(,%eax,4)
 ...
 630:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 635:	bb 3d 08 00 00       	mov    $0x83d,%ebx
...
free(void *ap)
{
 ...
 641:	a1 44 0b 00 00       	mov    0xb44,%eax
{
 ...
 67f:	5b                   	pop    %ebx
  freep = p;
 680:	a3 44 0b 00 00       	mov    %eax,0xb44
}
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 687:	5d                   	pop    %ebp
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 44 0b 00 00       	mov    %eax,0xb44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 44 0b 00 00    	mov    0xb44,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71b:	3b 05 44 0b 00 00    	cmp    0xb44,%eax
 ...
 73e:	e8 fd fe ff ff       	call   640 <free>
  return freep;
 743:	8b 15 44 0b 00 00    	mov    0xb44,%edx
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 76f:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 ...
 77f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 787:	0b 00 00 
    base.s.size = 0;
 78a:	b8 48 0b 00 00       	mov    $0xb48,%eax
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 796:	0b 00 00 
    base.s.size = 0;
 799:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 7a0:	00 00 00 
    if(p->s.size >= nunits){
