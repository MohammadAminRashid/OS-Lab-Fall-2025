  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  55:	50                   	push   %eax
  56:	50                   	push   %eax
  57:	68 57 07 00 00       	push   $0x757
  5c:	6a 01                	push   $0x1
  5e:	e8 bd 03 00 00       	call   420 <printf>
  63:	83 c4 10             	add    $0x10,%esp
  66:	eb d9                	jmp    41 <main+0x41>
        printf(1,"No file with this name!" );
  68:	51                   	push   %ecx
  69:	51                   	push   %ecx
  6a:	68 2a 07 00 00       	push   $0x72a
  6f:	6a 01                	push   $0x1
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb 5d 07 00 00       	mov    $0x75d,%ebx
 ...
 5b1:	a1 58 0a 00 00       	mov    0xa58,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 58 0a 00 00       	mov    %eax,0xa58
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 58 0a 00 00       	mov    %eax,0xa58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 58 0a 00 00    	mov    0xa58,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 58 0a 00 00    	cmp    0xa58,%eax
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 58 0a 00 00    	mov    0xa58,%edx
 ...
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 5c 0a 00 00       	mov    $0xa5c,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 5c 0a 00 00 5c 	movl   $0xa5c,0xa5c
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 710:	00 00 00 
    if(p->s.size >= nunits){
