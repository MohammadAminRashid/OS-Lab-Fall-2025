...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 40 13 00 00 	jmp    *0x1340(,%eax,4)
    if(ecmd->argv[0] == 0)
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 a0 19 00 00       	push   $0x19a0
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 a0 19 00 00       	push   $0x19a0
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 98 19 00 00       	push   $0x1998
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 a0 19 00 00       	push   $0x19a0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 a0 19 00 00       	push   $0x19a0
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ad5:	ff 24 85 58 13 00 00 	jmp    *0x1358(,%eax,4)
...
00000ecb <simple_arithmetic_syscall>:

.globl simple_arithmetic_syscall
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
     ecb:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
     ecf:	8b 4c 24 08          	mov    0x8(%esp),%ecx
     ...
     f89:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    1100:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1105:	bb 70 13 00 00       	mov    $0x1370,%ebx
