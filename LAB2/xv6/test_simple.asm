  ...
  13:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  int result = simple_arithmetic_syscall(a, b);
  49:	53                   	push   %ebx
  4a:	e8 1c 03 00 00       	call   36b <simple_arithmetic_syscall>
  
  printf(1, "User-space: simple_arithmetic_syscall(%d, %d) = %d\n", a, b, result);
  4f:	89 04 24             	mov    %eax,(%esp)
  52:	56                   	push   %esi
  53:	53                   	push   %ebx
  54:	68 40 07 00 00       	push   $0x740
  59:	6a 01                	push   $0x1
  5b:	e8 c0 03 00 00       	call   420 <printf>
...
00000363 <grep_syscall>:
SYSCALL(grep_syscall)
 363:	b8 19 00 00 00       	mov    $0x19,%eax
 368:	cd 40                	int    $0x40
 36a:	c3                   	ret    

0000036b <simple_arithmetic_syscall>:

.globl simple_arithmetic_syscall
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
 36b:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
 36f:	8b 4c 24 08          	mov    0x8(%esp),%ecx
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb 74 07 00 00       	mov    $0x774,%ebx
 ...
 5b1:	a1 78 0a 00 00       	mov    0xa78,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 78 0a 00 00       	mov    %eax,0xa78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 78 0a 00 00    	mov    0xa78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 78 0a 00 00    	cmp    0xa78,%eax
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 78 0a 00 00    	mov    0xa78,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 78 0a 00 00    	mov    %edx,0xa78
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 78 0a 00 00 7c 	movl   $0xa7c,0xa78
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 7c 0a 00 00       	mov    $0xa7c,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 710:	00 00 00 
    if(p->s.size >= nunits){
