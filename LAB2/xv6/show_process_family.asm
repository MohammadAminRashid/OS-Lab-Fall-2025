...
int main(int argc, char *argv[])
{
  ...
  15:	8b 71 04             	mov    0x4(%ecx),%esi
        printf(1, "\n");
  18:	68 28 07 00 00       	push   $0x728
  1d:	6a 01                	push   $0x1
  1f:	e8 fc 03 00 00       	call   420 <printf>
    if (argc < 2)
  24:	83 c4 10             	add    $0x10,%esp
  27:	83 fb 01             	cmp    $0x1,%ebx
  2a:	7e 1b                	jle    47 <main+0x47>
    {
        printf(1, "\n");
        exit();
    }
  ...
  45:	74 14                	je     5b <main+0x5b>
        printf(1, "\n");
  47:	83 ec 08             	sub    $0x8,%esp
  4a:	68 28 07 00 00       	push   $0x728
  4f:	6a 01                	push   $0x1
  ...
  5b:	50                   	push   %eax
  5c:	50                   	push   %eax
  5d:	68 2a 07 00 00       	push   $0x72a
  62:	6a 01                	push   $0x1
  64:	e8 b7 03 00 00       	call   420 <printf>
  69:	83 c4 10             	add    $0x10,%esp
  6c:	eb d9                	jmp    47 <main+0x47>
  6e:	66 90                	xchg   %ax,%ax
 ...
 5b1:	a1 40 0a 00 00       	mov    0xa40,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 40 0a 00 00       	mov    %eax,0xa40
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 40 0a 00 00       	mov    %eax,0xa40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 40 0a 00 00    	mov    0xa40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 40 0a 00 00    	cmp    0xa40,%eax
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 40 0a 00 00    	mov    0xa40,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 40 0a 00 00    	mov    %edx,0xa40
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 40 0a 00 00 44 	movl   $0xa44,0xa40
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 44 0a 00 00       	mov    $0xa44,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 44 0a 00 00 44 	movl   $0xa44,0xa44
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 48 0a 00 00 00 	movl   $0x0,0xa48
 710:	00 00 00 
    if(p->s.size >= nunits){
