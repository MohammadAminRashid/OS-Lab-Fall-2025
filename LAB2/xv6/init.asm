...
main(void)
{
  ...
  f1:	6a 01                	push   $0x1
  f3:	6a 01                	push   $0x1
  f5:	68 c8 07 00 00       	push   $0x7c8
  fa:	e8 ac 02 00 00       	call   3ab <mknod>
    open("console", O_RDWR);
  ff:	5b                   	pop    %ebx
 100:	58                   	pop    %eax
 101:	6a 02                	push   $0x2
 103:	68 c8 07 00 00       	push   $0x7c8
...
0000040b <simple_arithmetic_syscall>:

.globl simple_arithmetic_syscall
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
 40b:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
 40f:	8b 4c 24 08          	mov    0x8(%esp),%ecx
 ...
 428:	89 d1                	mov    %edx,%ecx
{
 ...
 45b:	0f b6 92 ac 08 00 00 	movzbl 0x8ac(%edx),%edx
 ...
 4c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 534:	ff 24 85 54 08 00 00 	jmp    *0x854(,%eax,4)
 ...
 640:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 645:	bb 4d 08 00 00       	mov    $0x84d,%ebx
...
free(void *ap)
{
 ...
 651:	a1 54 0b 00 00       	mov    0xb54,%eax
{
 ...
 68f:	5b                   	pop    %ebx
  freep = p;
 690:	a3 54 0b 00 00       	mov    %eax,0xb54
}
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 697:	5d                   	pop    %ebp
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 54 0b 00 00       	mov    %eax,0xb54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 54 0b 00 00    	mov    0xb54,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	3b 05 54 0b 00 00    	cmp    0xb54,%eax
 ...
 74e:	e8 fd fe ff ff       	call   650 <free>
  return freep;
 753:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 797:	0b 00 00 
    base.s.size = 0;
 79a:	b8 58 0b 00 00       	mov    $0xb58,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 7a6:	0b 00 00 
    base.s.size = 0;
 7a9:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 7b0:	00 00 00 
    if(p->s.size >= nunits){
