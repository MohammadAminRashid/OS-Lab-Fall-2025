...
main(void)
{
  ...
  98:	e8 ce 02 00 00       	call   36b <wait>
  ...
  b9:	53                   	push   %ebx
  ba:	53                   	push   %ebx
  bb:	68 28 08 00 00       	push   $0x828
  c0:	6a 01                	push   $0x1
  c2:	e8 09 04 00 00       	call   4d0 <printf>
      exit();
  c7:	e8 97 02 00 00       	call   363 <exit>
      exec("sh", argv);
  cc:	50                   	push   %eax
  cd:	50                   	push   %eax
  ce:	68 5c 0b 00 00       	push   $0xb5c
  d3:	68 3b 08 00 00       	push   $0x83b
  d8:	e8 be 02 00 00       	call   39b <exec>
      printf(1, "init: exec sh failed\n");
  dd:	5a                   	pop    %edx
  de:	59                   	pop    %ecx
  df:	68 3e 08 00 00       	push   $0x83e
  e4:	6a 01                	push   $0x1
  ...
  f1:	6a 01                	push   $0x1
  f3:	6a 01                	push   $0x1
  f5:	68 d8 07 00 00       	push   $0x7d8
  fa:	e8 ac 02 00 00       	call   3ab <mknod>
    open("console", O_RDWR);
  ff:	5b                   	pop    %ebx
 100:	58                   	pop    %eax
 101:	6a 02                	push   $0x2
 103:	68 d8 07 00 00       	push   $0x7d8
 108:	e8 96 02 00 00       	call   3a3 <open>
...
00000413 <grep_syscall>:
SYSCALL(grep_syscall)
 413:	b8 19 00 00 00       	mov    $0x19,%eax
 418:	cd 40                	int    $0x40
 41a:	c3                   	ret    

0000041b <simple_arithmetic_syscall>:

.globl simple_arithmetic_syscall
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
 41b:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
 41f:	8b 4c 24 08          	mov    0x8(%esp),%ecx
 ...
 438:	89 d1                	mov    %edx,%ecx
{
 ...
 46b:	0f b6 92 bc 08 00 00 	movzbl 0x8bc(%edx),%edx
 ...
 4d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 544:	ff 24 85 64 08 00 00 	jmp    *0x864(,%eax,4)
 ...
 650:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 655:	bb 5d 08 00 00       	mov    $0x85d,%ebx
...
free(void *ap)
{
 ...
 661:	a1 64 0b 00 00       	mov    0xb64,%eax
{
 ...
 69f:	5b                   	pop    %ebx
  freep = p;
 6a0:	a3 64 0b 00 00       	mov    %eax,0xb64
}
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 6a7:	5d                   	pop    %ebp
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 64 0b 00 00       	mov    %eax,0xb64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 64 0b 00 00    	mov    0xb64,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73b:	3b 05 64 0b 00 00    	cmp    0xb64,%eax
 ...
 75e:	e8 fd fe ff ff       	call   660 <free>
  return freep;
 763:	8b 15 64 0b 00 00    	mov    0xb64,%edx
 ...
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	b8 68 0b 00 00       	mov    $0xb68,%eax
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 68 0b 00 00 68 	movl   $0xb68,0xb68
 7b6:	0b 00 00 
    base.s.size = 0;
 7b9:	c7 05 6c 0b 00 00 00 	movl   $0x0,0xb6c
 7c0:	00 00 00 
    if(p->s.size >= nunits){
