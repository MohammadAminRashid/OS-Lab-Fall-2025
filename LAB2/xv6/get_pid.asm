...
0000032b <simple_arithmetic_syscall>:

.globl simple_arithmetic_syscall
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
 32b:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
 32f:	8b 4c 24 08          	mov    0x8(%esp),%ecx
 ...
 348:	89 d1                	mov    %edx,%ecx
{
 ...
 37b:	0f b6 92 54 07 00 00 	movzbl 0x754(%edx),%edx
 ...
 3e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 454:	ff 24 85 fc 06 00 00 	jmp    *0x6fc(,%eax,4)
 ...
 560:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 565:	bb f3 06 00 00       	mov    $0x6f3,%ebx
...
free(void *ap)
{
 ...
 571:	a1 f0 09 00 00       	mov    0x9f0,%eax
{
 ...
 5af:	5b                   	pop    %ebx
  freep = p;
 5b0:	a3 f0 09 00 00       	mov    %eax,0x9f0
}
 5b5:	5e                   	pop    %esi
 5b6:	5f                   	pop    %edi
 5b7:	5d                   	pop    %ebp
 ...
 5c6:	72 ce                	jb     596 <free+0x26>
{
 ...
 5e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5ea:	a3 f0 09 00 00       	mov    %eax,0x9f0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 15 f0 09 00 00    	mov    0x9f0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 64b:	3b 05 f0 09 00 00    	cmp    0x9f0,%eax
 ...
 66e:	e8 fd fe ff ff       	call   570 <free>
  return freep;
 673:	8b 15 f0 09 00 00    	mov    0x9f0,%edx
 ...
 69c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 69f:	89 15 f0 09 00 00    	mov    %edx,0x9f0
}
 ...
 6af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6b0:	c7 05 f0 09 00 00 f4 	movl   $0x9f4,0x9f0
 6b7:	09 00 00 
    base.s.size = 0;
 6ba:	b8 f4 09 00 00       	mov    $0x9f4,%eax
    base.s.ptr = freep = prevp = &base;
 6bf:	c7 05 f4 09 00 00 f4 	movl   $0x9f4,0x9f4
 6c6:	09 00 00 
    base.s.size = 0;
 6c9:	c7 05 f8 09 00 00 00 	movl   $0x0,0x9f8
 6d0:	00 00 00 
    if(p->s.size >= nunits){
