...
00000100 <ls>:
{
 ...
 221:	6a 0e                	push   $0xe
 223:	50                   	push   %eax
 224:	ff b5 a4 fd ff ff    	pushl  -0x25c(%ebp)
 ...
 28a:	52                   	push   %edx
 28b:	ff b5 b4 fd ff ff    	pushl  -0x24c(%ebp)
 291:	50                   	push   %eax
...
0000061b <show_process_family>:
SYSCALL(show_process_family)
 61b:	b8 18 00 00 00       	mov    $0x18,%eax
 620:	cd 40                	int    $0x40
 622:	c3                   	ret    

00000623 <grep_syscall>:
SYSCALL(grep_syscall)
 623:	b8 19 00 00 00       	mov    $0x19,%eax
 628:	cd 40                	int    $0x40
 62a:	c3                   	ret    

0000062b <simple_arithmetic_syscall>:

.globl simple_arithmetic_syscall
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
 62b:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
 62f:	8b 4c 24 08          	mov    0x8(%esp),%ecx
