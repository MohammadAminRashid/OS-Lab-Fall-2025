...
8010004c:	68 40 94 10 80       	push   $0x80109440
...
8010008b:	c7 43 50 1c 0c 11 80 	movl   $0x80110c1c,0x50(%ebx)
    initsleeplock(&b->lock, "buffer");
80100092:	68 47 94 10 80       	push   $0x80109447
80100097:	50                   	push   %eax
80100098:	e8 63 5f 00 00       	call   80106000 <initsleeplock>
...
801000e4:	e8 37 62 00 00       	call   80106320 <acquire>
...
80100162:	e8 59 61 00 00       	call   801062c0 <release>
      acquiresleep(&b->lock);
80100167:	8d 43 0c             	lea    0xc(%ebx),%eax
8010016a:	89 04 24             	mov    %eax,(%esp)
8010016d:	e8 ce 5e 00 00       	call   80106040 <acquiresleep>
      return b;
...
801001a1:	68 4e 94 10 80       	push   $0x8010944e
...
801001be:	e8 1d 5f 00 00       	call   801060e0 <holdingsleep>
...
801001dc:	68 5f 94 10 80       	push   $0x8010945f
...
801001ff:	e8 dc 5e 00 00       	call   801060e0 <holdingsleep>
...
8010020f:	e8 8c 5e 00 00       	call   801060a0 <releasesleep>

  acquire(&bcache.lock);
80100214:	c7 04 24 20 c5 10 80 	movl   $0x8010c520,(%esp)
8010021b:	e8 00 61 00 00       	call   80106320 <acquire>
  b->refcnt--;
...
80100268:	5d                   	pop    %ebp
  release(&bcache.lock);
80100269:	e9 52 60 00 00       	jmp    801062c0 <release>
    panic("brelse");
8010026e:	83 ec 0c             	sub    $0xc,%esp
80100271:	68 66 94 10 80       	push   $0x80109466
...
801002a0:	e8 7b 60 00 00       	call   80106320 <acquire>
  while (n > 0)
...
801002f6:	e8 c5 5f 00 00       	call   801062c0 <release>
        ilock(ip);
801002fb:	5a                   	pop    %edx
...
8010034c:	e8 6f 5f 00 00       	call   801062c0 <release>
  ilock(ip);
80100351:	58                   	pop    %eax
...
801003a2:	68 6d 94 10 80       	push   $0x8010946d
...
801003b0:	e8 1b 04 00 00       	call   801007d0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 83 9f 10 80 	movl   $0x80109f83,(%esp)
...
801003c8:	e8 83 5d 00 00       	call   80106150 <getcallerpcs>
  for (i = 0; i < 10; i++)
...
801003d5:	83 c3 04             	add    $0x4,%ebx
    cprintf(" %p", pcs[i]);
801003d8:	68 81 94 10 80       	push   $0x80109481
...
8010051a:	e8 91 5f 00 00       	call   801064b0 <memmove>
...
80100536:	e8 e5 5e 00 00       	call   80106420 <memset>
  outb(CRTPORT + 1, pos);
...
801005a6:	68 85 94 10 80       	push   $0x80109485
...
801005e8:	e8 93 79 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80100603:	e8 78 79 00 00       	call   80107f80 <uartputc>
    uartputc(' ');
80100608:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010060f:	e8 6c 79 00 00       	call   80107f80 <uartputc>
    uartputc('\b');
80100614:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010061b:	e8 60 79 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
8010063d:	e8 3e 79 00 00       	call   80107f80 <uartputc>
    uartputc('[');
80100642:	c7 04 24 5b 00 00 00 	movl   $0x5b,(%esp)
80100649:	e8 32 79 00 00       	call   80107f80 <uartputc>
    uartputc('C');
8010064e:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80100655:	e8 26 79 00 00       	call   80107f80 <uartputc>
...
80100698:	e8 e3 78 00 00       	call   80107f80 <uartputc>
...
801006eb:	e8 30 5c 00 00       	call   80106320 <acquire>
  for (i = 0; i < n; i++)
...
80100717:	e8 a4 5b 00 00       	call   801062c0 <release>
  ilock(ip);
8010071c:	58                   	pop    %eax
...
8010075b:	0f b6 92 80 95 10 80 	movzbl -0x7fef6a80(%edx),%edx
...
80100794:	e8 e7 77 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80100918:	e8 03 5a 00 00       	call   80106320 <acquire>
  if (fmt == 0)
...
8010093b:	e8 80 59 00 00       	call   801062c0 <release>
...
8010094d:	e8 2e 76 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
8010096c:	e8 0f 76 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
8010098b:	b9 28 00 00 00       	mov    $0x28,%ecx
        s = "(null)";
80100990:	bf 98 94 10 80       	mov    $0x80109498,%edi
...
801009a4:	e8 d7 75 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
801009d7:	68 9f 94 10 80       	push   $0x8010949f
...
80100a2a:	e8 51 75 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80100b4c:	e8 2f 74 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80100c3a:	e8 41 73 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80100cc9:	e8 b2 72 00 00       	call   80107f80 <uartputc>
  for (uint i = input.e; i <= input.end_pos; i++)
...
80101072:	e8 09 6f 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
801012d2:	e8 a9 6c 00 00       	call   80107f80 <uartputc>
    uartputc(' ');
801012d7:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801012de:	e8 9d 6c 00 00       	call   80107f80 <uartputc>
    uartputc('\b');
801012e3:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801012ea:	e8 91 6c 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80101325:	e8 56 6c 00 00       	call   80107f80 <uartputc>
    uartputc(' ');
8010132a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80101331:	e8 4a 6c 00 00       	call   80107f80 <uartputc>
    uartputc('\b');
80101336:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010133d:	e8 3e 6c 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
8010148f:	e8 ec 6a 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
8010162a:	e8 f1 4c 00 00       	call   80106320 <acquire>
  if (input.e > input.end_pos)
...
80101677:	ff 24 9d 14 95 10 80 	jmp    *-0x7fef6aec(,%ebx,4)
...
80101790:	e8 2b 4b 00 00       	call   801062c0 <release>
  if (doprocdump)
...
80101813:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80101817:	90                   	nop
      if (input.mode == 2)
...
80101a00:	ff 35 98 a0 10 80    	pushl  0x8010a098
80101a06:	ff 35 94 a0 10 80    	pushl  0x8010a094
...
80101a97:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80101f7d:	e8 fe 5f 00 00       	call   80107f80 <uartputc>
    uartputc(' ');
80101f82:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80101f89:	e8 f2 5f 00 00       	call   80107f80 <uartputc>
    uartputc('\b');
80101f8e:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80101f95:	e8 e6 5f 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80101fa7:	ff b5 5c fe ff ff    	pushl  -0x1a4(%ebp)
...
80101fcd:	e8 ae 5f 00 00       	call   80107f80 <uartputc>
    uartputc(' ');
80101fd2:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80101fd9:	e8 a2 5f 00 00       	call   80107f80 <uartputc>
    uartputc('\b');
80101fde:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80101fe5:	e8 96 5f 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
8010208f:	e8 ec 5e 00 00       	call   80107f80 <uartputc>
    uartputc(' ');
80102094:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010209b:	e8 e0 5e 00 00       	call   80107f80 <uartputc>
    uartputc('\b');
801020a0:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801020a7:	e8 d4 5e 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
801020c8:	e8 b3 5e 00 00       	call   80107f80 <uartputc>
...
8010210b:	e8 70 5e 00 00       	call   80107f80 <uartputc>
    uartputc(' ');
80102110:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80102117:	e8 64 5e 00 00       	call   80107f80 <uartputc>
    uartputc('\b');
8010211c:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80102123:	e8 58 5e 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
8010215b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010215f:	90                   	nop
          input.buf[input.e++ % INPUT_BUF] = c;
...
8010224f:	ff 35 94 a0 10 80    	pushl  0x8010a094
...
80102297:	e8 e4 5c 00 00       	call   80107f80 <uartputc>
    uartputc(' ');
8010229c:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801022a3:	e8 d8 5c 00 00       	call   80107f80 <uartputc>
    uartputc('\b');
801022a8:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801022af:	e8 cc 5c 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
801023cb:	e8 b0 5b 00 00       	call   80107f80 <uartputc>
    uartputc(' ');
801023d0:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801023d7:	e8 a4 5b 00 00       	call   80107f80 <uartputc>
    uartputc('\b');
801023dc:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801023e3:	e8 98 5b 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
801023f5:	ff b5 5c fe ff ff    	pushl  -0x1a4(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80102480:	e8 fb 5a 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
801024a0:	e8 db 5a 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80102534:	e8 47 5a 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
8010254a:	e8 31 5a 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80102595:	e8 e6 59 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
801025c1:	e8 ba 59 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
801025e6:	e8 95 59 00 00       	call   80107f80 <uartputc>
    cgaputc(c);
...
80102646:	68 a8 94 10 80       	push   $0x801094a8
8010264b:	68 c0 17 11 80       	push   $0x801117c0
80102650:	e8 db 3a 00 00       	call   80106130 <initlock>
...
801026f4:	0f 85 f1 00 00 00    	jne    801027eb <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
801026fa:	e8 f1 69 00 00       	call   801090f0 <setupkvm>
...
8010275f:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80102765:	ff b5 f4 fe ff ff    	pushl  -0x10c(%ebp)
8010276b:	e8 b0 67 00 00       	call   80108f20 <allocuvm>
...
8010278d:	ff b5 14 ff ff ff    	pushl  -0xec(%ebp)
80102793:	ff b5 08 ff ff ff    	pushl  -0xf8(%ebp)
80102799:	57                   	push   %edi
8010279a:	50                   	push   %eax
8010279b:	ff b5 f4 fe ff ff    	pushl  -0x10c(%ebp)
801027a1:	e8 aa 66 00 00       	call   80108e50 <loaduvm>
...
801027dd:	ff b5 f4 fe ff ff    	pushl  -0x10c(%ebp)
801027e3:	e8 88 68 00 00       	call   80109070 <freevm>
  if(ip){
...
80102842:	e8 d9 66 00 00       	call   80108f20 <allocuvm>
...
80102861:	31 f6                	xor    %esi,%esi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80102863:	e8 28 69 00 00       	call   80109190 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
801028aa:	e8 61 3d 00 00       	call   80106610 <strlen>
801028af:	29 c3                	sub    %eax,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
801028b1:	58                   	pop    %eax
801028b2:	ff 34 b7             	pushl  (%edi,%esi,4)
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
801028b5:	83 eb 01             	sub    $0x1,%ebx
801028b8:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
801028bb:	e8 50 3d 00 00       	call   80106610 <strlen>
801028c0:	83 c0 01             	add    $0x1,%eax
801028c3:	50                   	push   %eax
801028c4:	ff 34 b7             	pushl  (%edi,%esi,4)
801028c7:	53                   	push   %ebx
801028c8:	ff b5 f4 fe ff ff    	pushl  -0x10c(%ebp)
801028ce:	e8 8d 6a 00 00       	call   80109360 <copyout>
...
801028dd:	ff b5 f4 fe ff ff    	pushl  -0x10c(%ebp)
801028e3:	e8 88 67 00 00       	call   80109070 <freevm>
...
80102939:	ff b5 f4 fe ff ff    	pushl  -0x10c(%ebp)
8010293f:	e8 1c 6a 00 00       	call   80109360 <copyout>
...
8010297f:	e8 4c 3c 00 00       	call   801065d0 <safestrcpy>
  curproc->pgdir = pgdir;
...
801029ab:	e8 10 63 00 00       	call   80108cc0 <switchuvm>
  freevm(oldpgdir);
801029b0:	89 34 24             	mov    %esi,(%esp)
801029b3:	e8 b8 66 00 00       	call   80109070 <freevm>
  return 0;
...
801029fa:	68 91 95 10 80       	push   $0x80109591
...
80102a16:	68 9d 95 10 80       	push   $0x8010959d
80102a1b:	68 00 18 11 80       	push   $0x80111800
80102a20:	e8 0b 37 00 00       	call   80106130 <initlock>
}
...
80102a41:	e8 da 38 00 00       	call   80106320 <acquire>
...
80102a71:	e8 4a 38 00 00       	call   801062c0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80102a8a:	e8 31 38 00 00       	call   801062c0 <release>
}
...
80102aaf:	e8 6c 38 00 00       	call   80106320 <acquire>
  if(f->ref < 1)
...
80102acc:	e8 ef 37 00 00       	call   801062c0 <release>
  return f;
}
...
80102adb:	68 a4 95 10 80       	push   $0x801095a4
...
80102b01:	e8 1a 38 00 00       	call   80106320 <acquire>
  if(f->ref < 1)
...
80102b3c:	e8 7f 37 00 00       	call   801062c0 <release>
...
80102b6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80102b6e:	e9 4d 37 00 00       	jmp    801062c0 <release>
...
80102b80:	ff 75 e0             	pushl  -0x20(%ebp)
...
80102bbc:	68 ac 95 10 80       	push   $0x801095ac
80102bc1:	e8 ba d7 ff ff       	call   80100380 <panic>
80102bc6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80102be2:	ff 73 10             	pushl  0x10(%ebx)
80102be5:	e8 96 07 00 00       	call   80103380 <ilock>
    stati(f->ip, st);
80102bea:	58                   	pop    %eax
80102beb:	5a                   	pop    %edx
80102bec:	ff 75 0c             	pushl  0xc(%ebp)
80102bef:	ff 73 10             	pushl  0x10(%ebx)
80102bf2:	e8 69 0a 00 00       	call   80103660 <stati>
    iunlock(f->ip);
80102bf7:	59                   	pop    %ecx
80102bf8:	ff 73 10             	pushl  0x10(%ebx)
...
80102c47:	ff 73 10             	pushl  0x10(%ebx)
80102c4a:	e8 31 07 00 00       	call   80103380 <ilock>
    if((r = readi(f->ip, addr, f->off, n)) > 0)
80102c4f:	57                   	push   %edi
80102c50:	ff 73 14             	pushl  0x14(%ebx)
80102c53:	56                   	push   %esi
80102c54:	ff 73 10             	pushl  0x10(%ebx)
...
80102c6b:	ff 73 10             	pushl  0x10(%ebx)
...
80102ca2:	68 b6 95 10 80       	push   $0x801095b6
...
80102cfe:	89 45 e0             	mov    %eax,-0x20(%ebp)
      iunlock(f->ip);
80102d01:	ff 73 10             	pushl  0x10(%ebx)
...
80102d5d:	ff 73 10             	pushl  0x10(%ebx)
...
80102d77:	68 bf 95 10 80       	push   $0x801095bf
...
80102db1:	68 c5 95 10 80       	push   $0x801095c5
...
80102ded:	ff 75 dc             	pushl  -0x24(%ebp)
80102df0:	e8 db d2 ff ff       	call   801000d0 <bread>
80102df5:	89 7d d8             	mov    %edi,-0x28(%ebp)
...
80102e49:	ff 75 e4             	pushl  -0x1c(%ebp)
  for(b = 0; b < sb.size; b += BPB){
...
80102e69:	68 cf 95 10 80       	push   $0x801095cf
80102e6e:	e8 0d d5 ff ff       	call   80100380 <panic>
80102e73:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80102e77:	90                   	nop
...
80102e95:	ff 75 dc             	pushl  -0x24(%ebp)
...
80102ead:	e8 6e 35 00 00       	call   80106420 <memset>
  log_write(bp);
...
80102eea:	e8 31 34 00 00       	call   80106320 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80102f57:	e8 64 33 00 00       	call   801062c0 <release>
...
80102f85:	e8 36 33 00 00       	call   801062c0 <release>
      return ip;
...
80102fb8:	68 e5 95 10 80       	push   $0x801095e5
...
80103037:	68 f5 95 10 80       	push   $0x801095f5
...
80103115:	68 08 96 10 80       	push   $0x80109608
...
8010312d:	ff 75 08             	pushl  0x8(%ebp)
...
80103141:	e8 6a 33 00 00       	call   801064b0 <memmove>
  brelse(bp);
80103146:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
801031a4:	ff 75 08             	pushl  0x8(%ebp)
...
801031bc:	e8 ef 32 00 00       	call   801064b0 <memmove>
  brelse(bp);
801031c1:	89 1c 24             	mov    %ebx,(%esp)
801031c4:	e8 27 d0 ff ff       	call   801001f0 <brelse>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801031c9:	ff 35 6c 3e 11 80    	pushl  0x80113e6c
801031cf:	ff 35 68 3e 11 80    	pushl  0x80113e68
801031d5:	ff 35 64 3e 11 80    	pushl  0x80113e64
801031db:	ff 35 60 3e 11 80    	pushl  0x80113e60
801031e1:	ff 35 5c 3e 11 80    	pushl  0x80113e5c
801031e7:	ff 35 58 3e 11 80    	pushl  0x80113e58
801031ed:	ff 35 54 3e 11 80    	pushl  0x80113e54
801031f3:	68 88 96 10 80       	push   $0x80109688
...
80103203:	c9                   	leave  
80103204:	c3                   	ret    
80103205:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80103236:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
8010328e:	e8 8d 31 00 00       	call   80106420 <memset>
      dip->type = type;
...
801032c3:	68 28 96 10 80       	push   $0x80109628
...
801032eb:	ff 73 a4             	pushl  -0x5c(%ebx)
...
80103331:	e8 7a 31 00 00       	call   801064b0 <memmove>
  log_write(bp);
80103336:	89 34 24             	mov    %esi,(%esp)
80103339:	e8 c2 17 00 00       	call   80104b00 <log_write>
  brelse(bp);
8010333e:	89 75 08             	mov    %esi,0x8(%ebp)
...
8010335f:	e8 bc 2f 00 00       	call   80106320 <acquire>
  ip->ref++;
80103364:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80103368:	c7 04 24 00 22 11 80 	movl   $0x80112200,(%esp)
8010336f:	e8 4c 2f 00 00       	call   801062c0 <release>
}
...
801033a2:	e8 99 2c 00 00       	call   80106040 <acquiresleep>
  if(ip->valid == 0){
...
80103418:	e8 93 30 00 00       	call   801064b0 <memmove>
    brelse(bp);
...
8010343d:	68 40 96 10 80       	push   $0x80109640
80103442:	e8 39 cf ff ff       	call   80100380 <panic>
    panic("ilock");
80103447:	83 ec 0c             	sub    $0xc,%esp
8010344a:	68 3a 96 10 80       	push   $0x8010963a
8010344f:	e8 2c cf ff ff       	call   80100380 <panic>
80103454:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80103473:	e8 68 2c 00 00       	call   801060e0 <holdingsleep>
...
8010348e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010348f:	e9 0c 2c 00 00       	jmp    801060a0 <releasesleep>
    panic("iunlock");
80103494:	83 ec 0c             	sub    $0xc,%esp
80103497:	68 4f 96 10 80       	push   $0x8010964f
...
801034c0:	e8 7b 2b 00 00       	call   80106040 <acquiresleep>
...
801034da:	e8 c1 2b 00 00       	call   801060a0 <releasesleep>
  acquire(&icache.lock);
801034df:	c7 04 24 00 22 11 80 	movl   $0x80112200,(%esp)
801034e6:	e8 35 2e 00 00       	call   80106320 <acquire>
  ip->ref--;
...
801035a0:	ff 33                	pushl  (%ebx)
801035a2:	e8 29 cb ff ff       	call   801000d0 <bread>
    for(j = 0; j < NINDIRECT; j++){
801035a7:	89 7d e4             	mov    %edi,-0x1c(%ebp)
...
80103604:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80103623:	e8 b8 2a 00 00       	call   801060e0 <holdingsleep>
...
8010363a:	e8 61 2a 00 00       	call   801060a0 <releasesleep>
  iput(ip);
8010363f:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80103653:	68 4f 96 10 80       	push   $0x8010964f
...
80103734:	ff 75 e0             	pushl  -0x20(%ebp)
80103737:	e8 74 2d 00 00       	call   801064b0 <memmove>
    brelse(bp);
...
8010382f:	01 df                	add    %ebx,%edi
    memmove(bp->data + off%BSIZE, src, m);
80103831:	ff 75 dc             	pushl  -0x24(%ebp)
80103834:	50                   	push   %eax
80103835:	e8 76 2c 00 00       	call   801064b0 <memmove>
    log_write(bp);
...
801038b8:	ff 75 0c             	pushl  0xc(%ebp)
801038bb:	ff 75 08             	pushl  0x8(%ebp)
801038be:	e8 5d 2c 00 00       	call   80106520 <strncmp>
}
801038c3:	c9                   	leave  
801038c4:	c3                   	ret    
...
8010391a:	ff 75 0c             	pushl  0xc(%ebp)
8010391d:	e8 fe 2b 00 00       	call   80106520 <strncmp>
      continue;
...
80103962:	68 69 96 10 80       	push   $0x80109669
80103967:	e8 14 ca ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
8010396c:	83 ec 0c             	sub    $0xc,%esp
8010396f:	68 57 96 10 80       	push   $0x80109657
...
801039aa:	e8 71 29 00 00       	call   80106320 <acquire>
  ip->ref++;
801039af:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
801039b3:	c7 04 24 00 22 11 80 	movl   $0x80112200,(%esp)
801039ba:	e8 01 29 00 00       	call   801062c0 <release>
...
80103a14:	ff 75 e4             	pushl  -0x1c(%ebp)
80103a17:	e8 94 2a 00 00       	call   801064b0 <memmove>
...
80103a5c:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80103a6c:	0f 84 8c 00 00 00    	je     80103afe <namex+0x17e>
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
80103a72:	8d 4e 0c             	lea    0xc(%esi),%ecx
80103a75:	83 ec 0c             	sub    $0xc,%esp
80103a78:	51                   	push   %ecx
80103a79:	89 4d e0             	mov    %ecx,-0x20(%ebp)
80103a7c:	e8 5f 26 00 00       	call   801060e0 <holdingsleep>
...
80103a9e:	e8 fd 25 00 00       	call   801060a0 <releasesleep>
  iput(ip);
...
80103ac6:	89 fb                	mov    %edi,%ebx
    memmove(name, s, len);
80103ac8:	ff 75 e4             	pushl  -0x1c(%ebp)
80103acb:	e8 e0 29 00 00       	call   801064b0 <memmove>
    name[len] = 0;
...
80103b05:	e8 d6 25 00 00       	call   801060e0 <holdingsleep>
...
80103b1c:	e8 7f 25 00 00       	call   801060a0 <releasesleep>
  iput(ip);
...
80103b55:	e8 86 25 00 00       	call   801060e0 <holdingsleep>
...
80103b6c:	e8 2f 25 00 00       	call   801060a0 <releasesleep>
}
...
80103b91:	68 4f 96 10 80       	push   $0x8010964f
...
80103bae:	ff 75 0c             	pushl  0xc(%ebp)
...
80103bf9:	ff 75 0c             	pushl  0xc(%ebp)
80103bfc:	50                   	push   %eax
80103bfd:	e8 6e 29 00 00       	call   80106570 <strncpy>
  de.inum = inum;
...
80103c3b:	68 78 96 10 80       	push   $0x80109678
80103c40:	e8 3b c7 ff ff       	call   80100380 <panic>
    panic("dirlink");
80103c45:	83 ec 0c             	sub    $0xc,%esp
80103c48:	68 2e 9d 10 80       	push   $0x80109d2e
...
80103d5b:	68 e4 96 10 80       	push   $0x801096e4
80103d60:	e8 1b c6 ff ff       	call   80100380 <panic>
    panic("idestart");
80103d65:	83 ec 0c             	sub    $0xc,%esp
80103d68:	68 db 96 10 80       	push   $0x801096db
...
80103d86:	68 f6 96 10 80       	push   $0x801096f6
80103d8b:	68 a0 3e 11 80       	push   $0x80113ea0
80103d90:	e8 9b 23 00 00       	call   80106130 <initlock>
...
80103e1e:	e8 fd 24 00 00       	call   80106320 <acquire>
...
80103e9b:	e8 20 24 00 00       	call   801062c0 <release>
...
80103ebe:	e8 1d 22 00 00       	call   801060e0 <holdingsleep>
...
80103ef8:	e8 23 24 00 00       	call   80106320 <acquire>
...
80103f55:	c9                   	leave  
  release(&idelock);
80103f56:	e9 65 23 00 00       	jmp    801062c0 <release>
...
80103fea:	68 44 97 10 80       	push   $0x80109744
...
801040b2:	e8 69 23 00 00       	call   80106420 <memset>
...
801040e8:	e8 33 22 00 00       	call   80106320 <acquire>
...
80104102:	c9                   	leave  
    release(&kmem.lock);
80104103:	e9 b8 21 00 00       	jmp    801062c0 <release>
    panic("kfree");
80104108:	83 ec 0c             	sub    $0xc,%esp
8010410b:	68 76 97 10 80       	push   $0x80109776
...
801041c3:	5d                   	pop    %ebp
801041c4:	c3                   	ret    
801041c5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801041db:	68 7c 97 10 80       	push   $0x8010977c
801041e0:	68 e0 3e 11 80       	push   $0x80113ee0
801041e5:	e8 46 1f 00 00       	call   80106130 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80104278:	e8 a3 20 00 00       	call   80106320 <acquire>
  r = kmem.freelist;
...
801042a3:	e8 18 20 00 00       	call   801062c0 <release>
}
...
801042fb:	0f b6 91 c0 98 10 80 	movzbl -0x7fef6740(%ecx),%edx
  shift ^= togglecode[data];
80104302:	0f b6 81 c0 97 10 80 	movzbl -0x7fef6840(%ecx),%eax
  shift |= shiftcode[data];
...
80104318:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010431b:	8b 04 85 a0 97 10 80 	mov    -0x7fef6860(,%eax,4),%eax
...
80104355:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80104358:	0f b6 81 c0 98 10 80 	movzbl -0x7fef6740(%ecx),%eax
...
801046b3:	e8 a8 1d 00 00       	call   80106460 <memcmp>
...
801047ae:	ff 35 84 3f 11 80    	pushl  0x80113f84
801047b4:	e8 17 b9 ff ff       	call   801000d0 <bread>
801047b9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
801047bb:	58                   	pop    %eax
801047bc:	5a                   	pop    %edx
801047bd:	ff 34 bd 8c 3f 11 80 	pushl  -0x7feec074(,%edi,4)
801047c4:	ff 35 84 3f 11 80    	pushl  0x80113f84
  for (tail = 0; tail < log.lh.n; tail++) {
...
801047e4:	e8 c7 1c 00 00       	call   801064b0 <memmove>
...
80104827:	ff 35 74 3f 11 80    	pushl  0x80113f74
8010482d:	ff 35 84 3f 11 80    	pushl  0x80113f84
...
8010488a:	68 c0 99 10 80       	push   $0x801099c0
8010488f:	68 40 3f 11 80       	push   $0x80113f40
80104894:	e8 97 18 00 00       	call   80106130 <initlock>
  readsb(dev, &sb);
80104899:	58                   	pop    %eax
...
8010492b:	e8 f0 19 00 00       	call   80106320 <acquire>
...
8010497c:	e8 3f 19 00 00       	call   801062c0 <release>
      break;
    }
  }
}
...
8010499e:	e8 7d 19 00 00       	call   80106320 <acquire>
  log.outstanding -= 1;
...
801049dc:	e8 df 18 00 00       	call   801062c0 <release>
}
...
801049f6:	e8 25 19 00 00       	call   80106320 <acquire>
    log.committing = 0;
...
80104a18:	e8 a3 18 00 00       	call   801062c0 <release>
...
80104a3e:	ff 35 84 3f 11 80    	pushl  0x80113f84
80104a44:	e8 87 b6 ff ff       	call   801000d0 <bread>
80104a49:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80104a4b:	58                   	pop    %eax
80104a4c:	5a                   	pop    %edx
80104a4d:	ff 34 9d 8c 3f 11 80 	pushl  -0x7feec074(,%ebx,4)
80104a54:	ff 35 84 3f 11 80    	pushl  0x80113f84
  for (tail = 0; tail < log.lh.n; tail++) {
...
80104a74:	e8 37 1a 00 00       	call   801064b0 <memmove>
...
80104ad4:	e8 e7 17 00 00       	call   801062c0 <release>
...
80104ae7:	68 c4 99 10 80       	push   $0x801099c4
...
80104b32:	e8 e9 17 00 00       	call   80106320 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80104b78:	c9                   	leave  
  release(&log.lock);
80104b79:	e9 42 17 00 00       	jmp    801062c0 <release>
...
80104b95:	68 d3 99 10 80       	push   $0x801099d3
80104b9a:	e8 e1 b7 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80104b9f:	83 ec 0c             	sub    $0xc,%esp
80104ba2:	68 e9 99 10 80       	push   $0x801099e9
...
80104bc8:	68 04 9a 10 80       	push   $0x80109a04
80104bcd:	e8 fe bb ff ff       	call   801007d0 <cprintf>
  idtinit();       // load idt register
80104bd2:	e8 d9 2f 00 00       	call   80107bb0 <idtinit>
...
80104bf3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80104bf6:	e8 b5 40 00 00       	call   80108cb0 <switchkvm>
  seginit();
80104bfb:	e8 20 40 00 00       	call   80108c20 <seginit>
  lapicinit();
...
80104c17:	ff 71 fc             	pushl  -0x4(%ecx)
...
80104c54:	e8 37 32 00 00       	call   80107e90 <uartinit>
  pinit();         // process table
80104c59:	e8 42 08 00 00       	call   801054a0 <pinit>
  tvinit();        // trap vectors
80104c5e:	e8 cd 2e 00 00       	call   80107b30 <tvinit>
  binit();         // buffer cache
...
80104c84:	e8 27 18 00 00       	call   801064b0 <memmove>
...
80104d6e:	68 18 9a 10 80       	push   $0x80109a18
80104d73:	56                   	push   %esi
80104d74:	e8 e7 16 00 00       	call   80106460 <memcmp>
...
80104db2:	5d                   	pop    %ebp
80104db3:	c3                   	ret    
80104db4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80104e29:	68 1d 9a 10 80       	push   $0x80109a1d
80104e2e:	50                   	push   %eax
80104e2f:	e8 2c 16 00 00       	call   80106460 <memcmp>
...
80104f5b:	68 22 9a 10 80       	push   $0x80109a22
...
80104f82:	68 18 9a 10 80       	push   $0x80109a18
80104f87:	53                   	push   %ebx
80104f88:	e8 d3 14 00 00       	call   80106460 <memcmp>
...
80104fb8:	68 3c 9a 10 80       	push   $0x80109a3c
...
80105060:	00 00 00 
  initlock(&p->lock, "pipe");
80105063:	68 5b 9a 10 80       	push   $0x80109a5b
80105068:	50                   	push   %eax
80105069:	e8 c2 10 00 00       	call   80106130 <initlock>
  (*f0)->type = FD_PIPE;
...
801050ef:	e8 2c 12 00 00       	call   80106320 <acquire>
  if(writable){
...
80105190:	e8 8b 11 00 00       	call   80106320 <acquire>
  for(i = 0; i < n; i++){
...
80105224:	e8 97 10 00 00       	call   801062c0 <release>
        return -1;
...
80105280:	e8 3b 10 00 00       	call   801062c0 <release>
  return n;
...
801052b6:	e8 65 10 00 00       	call   80106320 <acquire>
...
8010534e:	e8 6d 0f 00 00       	call   801062c0 <release>
  return i;
...
80105369:	e8 52 0f 00 00       	call   801062c0 <release>
      return -1;
...
80105391:	e8 8a 0f 00 00       	call   80106320 <acquire>
...
801053cc:	89 15 04 c0 10 80    	mov    %edx,0x8010c004
  release(&ptable.lock);
801053d2:	e8 e9 0e 00 00       	call   801062c0 <release>
...
801053f4:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint *)sp = (uint)trapret;
801053f7:	c7 40 14 1f 7b 10 80 	movl   $0x80107b1f,0x14(%eax)
  p->context = (struct context *)sp;
...
80105406:	e8 15 10 00 00       	call   80106420 <memset>
...
8010542a:	e8 91 0e 00 00       	call   801062c0 <release>
  return 0;
...
8010545b:	e8 60 0e 00 00       	call   801062c0 <release>
...
801054a6:	68 60 9a 10 80       	push   $0x80109a60
801054ab:	68 c0 45 11 80       	push   $0x801145c0
801054b0:	e8 7b 0c 00 00       	call   80106130 <initlock>
}
...
80105544:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80105547:	e8 84 0c 00 00       	call   801061d0 <pushcli>
  c = mycpu();
8010554c:	e8 6f ff ff ff       	call   801054c0 <mycpu>
  p = c->proc;
80105551:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80105557:	e8 c4 0c 00 00       	call   80106220 <popcli>
}
...
80105583:	e8 68 3b 00 00       	call   801090f0 <setupkvm>
...
801055a1:	e8 2a 38 00 00       	call   80108dd0 <inituvm>
...
801055b3:	ff 73 18             	pushl  0x18(%ebx)
801055b6:	e8 65 0e 00 00       	call   80106420 <memset>
...
8010560f:	68 90 9a 10 80       	push   $0x80109a90
80105614:	50                   	push   %eax
80105615:	e8 b6 0f 00 00       	call   801065d0 <safestrcpy>
  p->cwd = namei("/");
8010561a:	c7 04 24 99 9a 10 80 	movl   $0x80109a99,(%esp)
...
80105653:	68 77 9a 10 80       	push   $0x80109a77
...
80105665:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80105668:	e8 63 0b 00 00       	call   801061d0 <pushcli>
  c = mycpu();
8010566d:	e8 4e fe ff ff       	call   801054c0 <mycpu>
  p = c->proc;
80105672:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80105678:	e8 a3 0b 00 00       	call   80106220 <popcli>
  sz = curproc->sz;
...
8010568b:	e8 30 36 00 00       	call   80108cc0 <switchuvm>
  return 0;
...
801056a7:	ff 73 04             	pushl  0x4(%ebx)
801056aa:	e8 71 38 00 00       	call   80108f20 <allocuvm>
...
801056c7:	ff 73 04             	pushl  0x4(%ebx)
801056ca:	e8 71 39 00 00       	call   80109040 <deallocuvm>
...
801056e6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801056e9:	e8 e2 0a 00 00       	call   801061d0 <pushcli>
  c = mycpu();
801056ee:	e8 cd fd ff ff       	call   801054c0 <mycpu>
  p = c->proc;
801056f3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801056f9:	e8 22 0b 00 00       	call   80106220 <popcli>
  if ((np = allocproc()) == 0)
...
80105711:	ff 33                	pushl  (%ebx)
80105713:	89 c7                	mov    %eax,%edi
80105715:	ff 73 04             	pushl  0x4(%ebx)
80105718:	e8 c3 3a 00 00       	call   801091e0 <copyuvm>
...
80105776:	ff 73 68             	pushl  0x68(%ebx)
...
801057cb:	ff 73 08             	pushl  0x8(%ebx)
...
8010581e:	e8 fd 0a 00 00       	call   80106320 <acquire>
...
80105840:	e8 7b 34 00 00       	call   80108cc0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80105845:	58                   	pop    %eax
80105846:	5a                   	pop    %edx
80105847:	ff 73 1c             	pushl  0x1c(%ebx)
8010584a:	57                   	push   %edi
      p->state = RUNNING;
8010584b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80105852:	e8 d4 0d 00 00       	call   8010662b <swtch>
      switchkvm();
80105857:	e8 54 34 00 00       	call   80108cb0 <switchkvm>
      c->proc = 0;
...
8010587c:	e8 3f 0a 00 00       	call   801062c0 <release>
    sti();
...
801058ef:	ff 70 04             	pushl  0x4(%eax)
801058f2:	53                   	push   %ebx
801058f3:	e8 33 0d 00 00       	call   8010662b <swtch>
  mycpu()->intena = intena;
...
8010599f:	ff 73 68             	pushl  0x68(%ebx)
...
801059ba:	e8 61 09 00 00       	call   80106320 <acquire>
...
80105a5d:	68 e8 9a 10 80       	push   $0x80109ae8
80105a62:	e8 19 a9 ff ff       	call   80100380 <panic>
    panic("init exiting");
80105a67:	83 ec 0c             	sub    $0xc,%esp
80105a6a:	68 db 9a 10 80       	push   $0x80109adb
...
80105aeb:	0f 85 95 00 00 00    	jne    80105b86 <wait+0x106>
  pushcli();
80105af1:	e8 da 06 00 00       	call   801061d0 <pushcli>
  c = mycpu();
80105af6:	e8 c5 f9 ff ff       	call   801054c0 <mycpu>
  p = c->proc;
80105afb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80105b01:	e8 1a 07 00 00       	call   80106220 <popcli>
  if (p == 0)
...
80105b33:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80105b36:	ff 73 08             	pushl  0x8(%ebx)
80105b39:	e8 42 e5 ff ff       	call   80104080 <kfree>
        p->kstack = 0;
80105b3e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80105b45:	5a                   	pop    %edx
80105b46:	ff 73 04             	pushl  0x4(%ebx)
80105b49:	e8 22 35 00 00       	call   80109070 <freevm>
        p->pid = 0;
...
80105b75:	e8 46 07 00 00       	call   801062c0 <release>
        return pid;
...
80105bbc:	e8 5f 07 00 00       	call   80106320 <acquire>
  pushcli();
80105bc1:	e8 0a 06 00 00       	call   801061d0 <pushcli>
  c = mycpu();
80105bc6:	e8 f5 f8 ff ff       	call   801054c0 <mycpu>
  p = c->proc;
80105bcb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80105bd1:	e8 4a 06 00 00       	call   80106220 <popcli>
...
80105be9:	e8 d2 06 00 00       	call   801062c0 <release>
}
...
80105c0c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80105c0f:	e8 bc 05 00 00       	call   801061d0 <pushcli>
  c = mycpu();
80105c14:	e8 a7 f8 ff ff       	call   801054c0 <mycpu>
  p = c->proc;
80105c19:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80105c1f:	e8 fc 05 00 00       	call   80106220 <popcli>
  if (p == 0)
...
80105c40:	e8 db 06 00 00       	call   80106320 <acquire>
    release(lk);
80105c45:	89 34 24             	mov    %esi,(%esp)
80105c48:	e8 73 06 00 00       	call   801062c0 <release>
  p->chan = chan;
...
80105c6a:	e8 51 06 00 00       	call   801062c0 <release>
    acquire(lk);
80105c6f:	89 75 08             	mov    %esi,0x8(%ebp)
...
80105c7b:	5d                   	pop    %ebp
    acquire(lk);
80105c7c:	e9 9f 06 00 00       	jmp    80106320 <acquire>
...
80105ca9:	68 fa 9a 10 80       	push   $0x80109afa
80105cae:	e8 cd a6 ff ff       	call   80100380 <panic>
    panic("sleep");
80105cb3:	83 ec 0c             	sub    $0xc,%esp
80105cb6:	68 f4 9a 10 80       	push   $0x80109af4
...
80105ccf:	e8 4c 06 00 00       	call   80106320 <acquire>
...
80105d10:	c9                   	leave  
  release(&ptable.lock);
80105d11:	e9 aa 05 00 00       	jmp    801062c0 <release>
...
80105d2f:	e8 ec 05 00 00       	call   80106320 <acquire>
...
80105d6b:	e8 50 05 00 00       	call   801062c0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80105d88:	e8 33 05 00 00       	call   801062c0 <release>
}
...
80105dbb:	68 83 9f 10 80       	push   $0x80109f83
...
80105ddc:	74 ea                	je     80105dc8 <procdump+0x28>
      state = "???";
80105dde:	ba 0b 9b 10 80       	mov    $0x80109b0b,%edx
    if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
80105de3:	83 f8 05             	cmp    $0x5,%eax
80105de6:	77 11                	ja     80105df9 <procdump+0x59>
80105de8:	8b 14 85 28 9c 10 80 	mov    -0x7fef63d8(,%eax,4),%edx
      state = "???";
80105def:	b8 0b 9b 10 80       	mov    $0x80109b0b,%eax
80105df4:	85 d2                	test   %edx,%edx
80105df6:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80105df9:	53                   	push   %ebx
80105dfa:	52                   	push   %edx
80105dfb:	ff 73 a4             	pushl  -0x5c(%ebx)
80105dfe:	68 0f 9b 10 80       	push   $0x80109b0f
...
80105e25:	e8 26 03 00 00       	call   80106150 <getcallerpcs>
      for (i = 0; i < 10 && pc[i] != 0; i++)
...
80105e3d:	68 81 94 10 80       	push   $0x80109481
...
80105e53:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105e57:	90                   	nop
  }
}
...
80105e60:	55                   	push   %ebp
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105e61:	b8 f4 45 11 80       	mov    $0x801145f4,%eax
{
...
80105e6e:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105e71:	eb 13                	jmp    80105e86 <show_process_family+0x26>
80105e73:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105e77:	90                   	nop
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105e78:	83 c0 7c             	add    $0x7c,%eax
80105e7b:	3d f4 64 11 80       	cmp    $0x801164f4,%eax
80105e80:	0f 84 62 01 00 00    	je     80105fe8 <show_process_family+0x188>
  {

    if (pid == p->pid && p->pid != 0)
80105e86:	8b 50 10             	mov    0x10(%eax),%edx
80105e89:	39 da                	cmp    %ebx,%edx
80105e8b:	75 eb                	jne    80105e78 <show_process_family+0x18>
80105e8d:	85 d2                	test   %edx,%edx
80105e8f:	74 e7                	je     80105e78 <show_process_family+0x18>
  if (found == 0)
  {
...
80105e91:	8b 40 14             	mov    0x14(%eax),%eax
  cprintf("My id: %d,My parent id:%d\n", pid, parent_id);
80105e94:	83 ec 04             	sub    $0x4,%esp
  int parent_id = target_p->parent->pid;
80105e97:	8b 70 10             	mov    0x10(%eax),%esi
  cprintf("My id: %d,My parent id:%d\n", pid, parent_id);
80105e9a:	56                   	push   %esi
80105e9b:	53                   	push   %ebx
80105e9c:	68 18 9b 10 80       	push   $0x80109b18
80105ea1:	e8 2a a9 ff ff       	call   801007d0 <cprintf>
80105ea6:	83 c4 10             	add    $0x10,%esp
  int number_of_children = 0;
80105ea9:	31 c9                	xor    %ecx,%ecx

  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105eab:	b8 f4 45 11 80       	mov    $0x801145f4,%eax
  {

    if (pid == p->parent->pid && p->pid != 0)
80105eb0:	8b 50 14             	mov    0x14(%eax),%edx
80105eb3:	3b 5a 10             	cmp    0x10(%edx),%ebx
80105eb6:	75 07                	jne    80105ebf <show_process_family+0x5f>
    {
      number_of_children += 1;
80105eb8:	83 78 10 01          	cmpl   $0x1,0x10(%eax)
80105ebc:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105ebf:	83 c0 7c             	add    $0x7c,%eax
80105ec2:	3d f4 64 11 80       	cmp    $0x801164f4,%eax
80105ec7:	75 e7                	jne    80105eb0 <show_process_family+0x50>
    }
  }

  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105ec9:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
  int number_of_siblings = 0;
80105ecc:	31 ff                	xor    %edi,%edi
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105ece:	b8 f4 45 11 80       	mov    $0x801145f4,%eax
80105ed3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105ed7:	90                   	nop
  {

    if (p->pid != 0)
80105ed8:	8b 50 10             	mov    0x10(%eax),%edx
80105edb:	85 d2                	test   %edx,%edx
80105edd:	74 13                	je     80105ef2 <show_process_family+0x92>
    {
      ...
      if (parent_id == p->parent->pid)
      {
        ...
        if (pid != p->pid)
80105edf:	8b 48 14             	mov    0x14(%eax),%ecx
80105ee2:	39 71 10             	cmp    %esi,0x10(%ecx)
80105ee5:	75 0b                	jne    80105ef2 <show_process_family+0x92>
80105ee7:	39 da                	cmp    %ebx,%edx
80105ee9:	0f 95 c2             	setne  %dl
        {
          number_of_siblings += 1;
80105eec:	80 fa 01             	cmp    $0x1,%dl
80105eef:	83 df ff             	sbb    $0xffffffff,%edi
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105ef2:	83 c0 7c             	add    $0x7c,%eax
80105ef5:	3d f4 64 11 80       	cmp    $0x801164f4,%eax
80105efa:	75 dc                	jne    80105ed8 <show_process_family+0x78>
        }
      }
    }
  }
...
80105efc:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105eff:	85 c9                	test   %ecx,%ecx
80105f01:	7e 7e                	jle    80105f81 <show_process_family+0x121>
  {

    cprintf("Children of process %d:\n", pid);
80105f03:	83 ec 08             	sub    $0x8,%esp
80105f06:	53                   	push   %ebx
80105f07:	68 33 9b 10 80       	push   $0x80109b33
80105f0c:	e8 bf a8 ff ff       	call   801007d0 <cprintf>
    // cprintf("%s", target_p->name);

    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105f11:	b8 f4 45 11 80       	mov    $0x801145f4,%eax
80105f16:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    cprintf("Children of process %d:\n", pid);
80105f19:	83 c4 10             	add    $0x10,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105f1c:	89 de                	mov    %ebx,%esi
80105f1e:	89 c3                	mov    %eax,%ebx
80105f20:	eb 11                	jmp    80105f33 <show_process_family+0xd3>
80105f22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105f28:	83 c3 7c             	add    $0x7c,%ebx
80105f2b:	81 fb f4 64 11 80    	cmp    $0x801164f4,%ebx
80105f31:	74 2b                	je     80105f5e <show_process_family+0xfe>
    {

      if (pid == p->parent->pid && p->pid != 0)
80105f33:	8b 43 14             	mov    0x14(%ebx),%eax
80105f36:	39 70 10             	cmp    %esi,0x10(%eax)
80105f39:	75 ed                	jne    80105f28 <show_process_family+0xc8>
80105f3b:	8b 43 10             	mov    0x10(%ebx),%eax
80105f3e:	85 c0                	test   %eax,%eax
80105f40:	74 e6                	je     80105f28 <show_process_family+0xc8>
      {
        cprintf("Child pid: %d\n", p->pid);
80105f42:	83 ec 08             	sub    $0x8,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105f45:	83 c3 7c             	add    $0x7c,%ebx
        cprintf("Child pid: %d\n", p->pid);
80105f48:	50                   	push   %eax
80105f49:	68 4c 9b 10 80       	push   $0x80109b4c
80105f4e:	e8 7d a8 ff ff       	call   801007d0 <cprintf>
80105f53:	83 c4 10             	add    $0x10,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105f56:	81 fb f4 64 11 80    	cmp    $0x801164f4,%ebx
80105f5c:	75 d5                	jne    80105f33 <show_process_family+0xd3>
80105f5e:	89 f3                	mov    %esi,%ebx
80105f60:	8b 75 e4             	mov    -0x1c(%ebp),%esi
  else
  {
...
80105f63:	85 ff                	test   %edi,%edi
80105f65:	7f 2e                	jg     80105f95 <show_process_family+0x135>
    }
  }
  else
  {
...
80105f6a:	68 fc 9b 10 80       	push   $0x80109bfc
80105f6f:	e8 5c a8 ff ff       	call   801007d0 <cprintf>
...
80105f77:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
80105f7a:	31 c0                	xor    %eax,%eax
}
80105f7c:	5b                   	pop    %ebx
80105f7d:	5e                   	pop    %esi
80105f7e:	5f                   	pop    %edi
...
80105f84:	68 d0 9b 10 80       	push   $0x80109bd0
80105f89:	e8 42 a8 ff ff       	call   801007d0 <cprintf>
80105f8e:	83 c4 10             	add    $0x10,%esp
  if (number_of_siblings > 0)
80105f91:	85 ff                	test   %edi,%edi
80105f93:	7e d2                	jle    80105f67 <show_process_family+0x107>
    cprintf("Siblings of process %d:\n", pid);
80105f95:	83 ec 08             	sub    $0x8,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105f98:	bf f4 45 11 80       	mov    $0x801145f4,%edi
    cprintf("Siblings of process %d:\n", pid);
80105f9d:	53                   	push   %ebx
80105f9e:	68 5b 9b 10 80       	push   $0x80109b5b
80105fa3:	e8 28 a8 ff ff       	call   801007d0 <cprintf>
80105fa8:	83 c4 10             	add    $0x10,%esp
80105fab:	eb 0e                	jmp    80105fbb <show_process_family+0x15b>
80105fad:	8d 76 00             	lea    0x0(%esi),%esi
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105fb0:	83 c7 7c             	add    $0x7c,%edi
80105fb3:	81 ff f4 64 11 80    	cmp    $0x801164f4,%edi
80105fb9:	74 bc                	je     80105f77 <show_process_family+0x117>
      if (p->pid != 0)
80105fbb:	8b 47 10             	mov    0x10(%edi),%eax
80105fbe:	85 c0                	test   %eax,%eax
80105fc0:	74 ee                	je     80105fb0 <show_process_family+0x150>
        if (parent_id == p->parent->pid)
80105fc2:	8b 57 14             	mov    0x14(%edi),%edx
          if (pid != p->pid)
80105fc5:	39 72 10             	cmp    %esi,0x10(%edx)
80105fc8:	75 e6                	jne    80105fb0 <show_process_family+0x150>
80105fca:	39 d8                	cmp    %ebx,%eax
80105fcc:	74 e2                	je     80105fb0 <show_process_family+0x150>
            cprintf("Sibling pid: %d\n", p->pid);
80105fce:	83 ec 08             	sub    $0x8,%esp
80105fd1:	50                   	push   %eax
80105fd2:	68 74 9b 10 80       	push   $0x80109b74
80105fd7:	e8 f4 a7 ff ff       	call   801007d0 <cprintf>
80105fdc:	83 c4 10             	add    $0x10,%esp
80105fdf:	eb cf                	jmp    80105fb0 <show_process_family+0x150>
80105fe1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
}
80105fe8:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return -1;
...
80106007:	8b 5d 08             	mov    0x8(%ebp),%ebx
  initlock(&lk->lk, "sleep lock");
8010600a:	68 40 9c 10 80       	push   $0x80109c40
8010600f:	8d 43 04             	lea    0x4(%ebx),%eax
80106012:	50                   	push   %eax
80106013:	e8 18 01 00 00       	call   80106130 <initlock>
  lk->name = name;
80106018:	8b 45 0c             	mov    0xc(%ebp),%eax
  lk->locked = 0;
8010601b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
}
80106021:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80106024:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
8010602b:	89 43 38             	mov    %eax,0x38(%ebx)
}
8010602e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106031:	c9                   	leave  
80106032:	c3                   	ret    
80106033:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010603a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80106040 <acquiresleep>:
...
80106045:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80106048:	8d 73 04             	lea    0x4(%ebx),%esi
8010604b:	83 ec 0c             	sub    $0xc,%esp
8010604e:	56                   	push   %esi
8010604f:	e8 cc 02 00 00       	call   80106320 <acquire>
  while (lk->locked) {
80106054:	8b 13                	mov    (%ebx),%edx
80106056:	83 c4 10             	add    $0x10,%esp
80106059:	85 d2                	test   %edx,%edx
8010605b:	74 16                	je     80106073 <acquiresleep+0x33>
8010605d:	8d 76 00             	lea    0x0(%esi),%esi
    sleep(lk, &lk->lk);
80106060:	83 ec 08             	sub    $0x8,%esp
80106063:	56                   	push   %esi
80106064:	53                   	push   %ebx
80106065:	e8 96 fb ff ff       	call   80105c00 <sleep>
  while (lk->locked) {
8010606a:	8b 03                	mov    (%ebx),%eax
8010606c:	83 c4 10             	add    $0x10,%esp
8010606f:	85 c0                	test   %eax,%eax
80106071:	75 ed                	jne    80106060 <acquiresleep+0x20>
  }
  lk->locked = 1;
80106073:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80106079:	e8 c2 f4 ff ff       	call   80105540 <myproc>
8010607e:	8b 40 10             	mov    0x10(%eax),%eax
80106081:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80106084:	89 75 08             	mov    %esi,0x8(%ebp)
}
80106087:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010608a:	5b                   	pop    %ebx
8010608b:	5e                   	pop    %esi
8010608c:	5d                   	pop    %ebp
  release(&lk->lk);
8010608d:	e9 2e 02 00 00       	jmp    801062c0 <release>
80106092:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106099:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801060a0 <releasesleep>:
...
801060a5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
801060a8:	8d 73 04             	lea    0x4(%ebx),%esi
801060ab:	83 ec 0c             	sub    $0xc,%esp
801060ae:	56                   	push   %esi
801060af:	e8 6c 02 00 00       	call   80106320 <acquire>
  lk->locked = 0;
801060b4:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801060ba:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
801060c1:	89 1c 24             	mov    %ebx,(%esp)
801060c4:	e8 f7 fb ff ff       	call   80105cc0 <wakeup>
  release(&lk->lk);
801060c9:	89 75 08             	mov    %esi,0x8(%ebp)
801060cc:	83 c4 10             	add    $0x10,%esp
}
801060cf:	8d 65 f8             	lea    -0x8(%ebp),%esp
801060d2:	5b                   	pop    %ebx
801060d3:	5e                   	pop    %esi
801060d4:	5d                   	pop    %ebp
  release(&lk->lk);
801060d5:	e9 e6 01 00 00       	jmp    801062c0 <release>
801060da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

801060e0 <holdingsleep>:
...
801060e4:	31 ff                	xor    %edi,%edi
801060e6:	56                   	push   %esi
801060e7:	53                   	push   %ebx
801060e8:	83 ec 18             	sub    $0x18,%esp
801060eb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
801060ee:	8d 73 04             	lea    0x4(%ebx),%esi
801060f1:	56                   	push   %esi
801060f2:	e8 29 02 00 00       	call   80106320 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
801060f7:	8b 03                	mov    (%ebx),%eax
801060f9:	83 c4 10             	add    $0x10,%esp
801060fc:	85 c0                	test   %eax,%eax
801060fe:	75 18                	jne    80106118 <holdingsleep+0x38>
  release(&lk->lk);
80106100:	83 ec 0c             	sub    $0xc,%esp
80106103:	56                   	push   %esi
80106104:	e8 b7 01 00 00       	call   801062c0 <release>
  return r;
}
80106109:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010610c:	89 f8                	mov    %edi,%eax
8010610e:	5b                   	pop    %ebx
8010610f:	5e                   	pop    %esi
80106110:	5f                   	pop    %edi
80106111:	5d                   	pop    %ebp
...
80106117:	90                   	nop
  r = lk->locked && (lk->pid == myproc()->pid);
80106118:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
8010611b:	e8 20 f4 ff ff       	call   80105540 <myproc>
80106120:	39 58 10             	cmp    %ebx,0x10(%eax)
80106123:	0f 94 c0             	sete   %al
80106126:	0f b6 c0             	movzbl %al,%eax
80106129:	89 c7                	mov    %eax,%edi
8010612b:	eb d3                	jmp    80106100 <holdingsleep+0x20>
...
8010615d:	05 f8 ff ff 7f       	add    $0x7ffffff8,%eax
80106162:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
  for(i = 0; i < 10; i++){
80106167:	b8 00 00 00 00       	mov    $0x0,%eax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
8010616c:	76 10                	jbe    8010617e <getcallerpcs+0x2e>
8010616e:	eb 28                	jmp    80106198 <getcallerpcs+0x48>
80106170:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80106176:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
8010617c:	77 1a                	ja     80106198 <getcallerpcs+0x48>
      break;
    pcs[i] = ebp[1];     // saved %eip
8010617e:	8b 5a 04             	mov    0x4(%edx),%ebx
80106181:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
80106184:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
80106187:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80106189:	83 f8 0a             	cmp    $0xa,%eax
8010618c:	75 e2                	jne    80106170 <getcallerpcs+0x20>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
80106191:	c9                   	leave  
80106192:	c3                   	ret    
80106193:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106197:	90                   	nop
80106198:	8d 04 81             	lea    (%ecx,%eax,4),%eax
8010619b:	83 c1 28             	add    $0x28,%ecx
8010619e:	89 ca                	mov    %ecx,%edx
801061a0:	29 c2                	sub    %eax,%edx
801061a2:	83 e2 04             	and    $0x4,%edx
801061a5:	74 11                	je     801061b8 <getcallerpcs+0x68>
    pcs[i] = 0;
801061a7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801061ad:	83 c0 04             	add    $0x4,%eax
801061b0:	39 c1                	cmp    %eax,%ecx
801061b2:	74 da                	je     8010618e <getcallerpcs+0x3e>
801061b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pcs[i] = 0;
801061b8:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801061be:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
801061c1:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
801061c8:	39 c1                	cmp    %eax,%ecx
801061ca:	75 ec                	jne    801061b8 <getcallerpcs+0x68>
801061cc:	eb c0                	jmp    8010618e <getcallerpcs+0x3e>
...
801061d9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801061da:	e8 e1 f2 ff ff       	call   801054c0 <mycpu>
801061df:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801061e5:	85 c0                	test   %eax,%eax
801061e7:	74 17                	je     80106200 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
801061e9:	e8 d2 f2 ff ff       	call   801054c0 <mycpu>
801061ee:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
801061f5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801061f8:	c9                   	leave  
801061f9:	c3                   	ret    
801061fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80106200:	e8 bb f2 ff ff       	call   801054c0 <mycpu>
80106205:	81 e3 00 02 00 00    	and    $0x200,%ebx
8010620b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80106211:	eb d6                	jmp    801061e9 <pushcli+0x19>
...
80106227:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80106228:	f6 c4 02             	test   $0x2,%ah
8010622b:	75 35                	jne    80106262 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
8010622d:	e8 8e f2 ff ff       	call   801054c0 <mycpu>
80106232:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
80106239:	78 34                	js     8010626f <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010623b:	e8 80 f2 ff ff       	call   801054c0 <mycpu>
80106240:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80106246:	85 d2                	test   %edx,%edx
80106248:	74 06                	je     80106250 <popcli+0x30>
    sti();
}
8010624a:	c9                   	leave  
8010624b:	c3                   	ret    
8010624c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80106250:	e8 6b f2 ff ff       	call   801054c0 <mycpu>
80106255:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
8010625b:	85 c0                	test   %eax,%eax
8010625d:	74 eb                	je     8010624a <popcli+0x2a>
  asm volatile("sti");
8010625f:	fb                   	sti    
}
80106260:	c9                   	leave  
...
80106265:	68 4b 9c 10 80       	push   $0x80109c4b
8010626a:	e8 11 a1 ff ff       	call   80100380 <panic>
    panic("popcli");
8010626f:	83 ec 0c             	sub    $0xc,%esp
80106272:	68 62 9c 10 80       	push   $0x80109c62
80106277:	e8 04 a1 ff ff       	call   80100380 <panic>
...
80106285:	8b 75 08             	mov    0x8(%ebp),%esi
80106288:	31 db                	xor    %ebx,%ebx
  pushcli();
8010628a:	e8 41 ff ff ff       	call   801061d0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
8010628f:	8b 06                	mov    (%esi),%eax
80106291:	85 c0                	test   %eax,%eax
80106293:	75 0b                	jne    801062a0 <holding+0x20>
  popcli();
80106295:	e8 86 ff ff ff       	call   80106220 <popcli>
}
8010629a:	89 d8                	mov    %ebx,%eax
8010629c:	5b                   	pop    %ebx
8010629d:	5e                   	pop    %esi
8010629e:	5d                   	pop    %ebp
8010629f:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
801062a0:	8b 5e 08             	mov    0x8(%esi),%ebx
801062a3:	e8 18 f2 ff ff       	call   801054c0 <mycpu>
801062a8:	39 c3                	cmp    %eax,%ebx
801062aa:	0f 94 c3             	sete   %bl
  popcli();
801062ad:	e8 6e ff ff ff       	call   80106220 <popcli>
  r = lock->locked && lock->cpu == mycpu();
801062b2:	0f b6 db             	movzbl %bl,%ebx
}
801062b5:	89 d8                	mov    %ebx,%eax
801062b7:	5b                   	pop    %ebx
801062b8:	5e                   	pop    %esi
801062b9:	5d                   	pop    %ebp
801062ba:	c3                   	ret    
...
801062c5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801062c8:	e8 03 ff ff ff       	call   801061d0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801062cd:	8b 03                	mov    (%ebx),%eax
801062cf:	85 c0                	test   %eax,%eax
801062d1:	75 15                	jne    801062e8 <release+0x28>
  popcli();
801062d3:	e8 48 ff ff ff       	call   80106220 <popcli>
    panic("release");
801062d8:	83 ec 0c             	sub    $0xc,%esp
801062db:	68 69 9c 10 80       	push   $0x80109c69
801062e0:	e8 9b a0 ff ff       	call   80100380 <panic>
801062e5:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
801062e8:	8b 73 08             	mov    0x8(%ebx),%esi
801062eb:	e8 d0 f1 ff ff       	call   801054c0 <mycpu>
801062f0:	39 c6                	cmp    %eax,%esi
801062f2:	75 df                	jne    801062d3 <release+0x13>
  popcli();
801062f4:	e8 27 ff ff ff       	call   80106220 <popcli>
  lk->pcs[0] = 0;
801062f9:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80106300:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80106307:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010630c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
...
80106317:	5d                   	pop    %ebp
  popcli();
80106318:	e9 03 ff ff ff       	jmp    80106220 <popcli>
...
80106327:	e8 a4 fe ff ff       	call   801061d0 <pushcli>
  if(holding(lk))
8010632c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010632f:	e8 9c fe ff ff       	call   801061d0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80106334:	8b 03                	mov    (%ebx),%eax
80106336:	85 c0                	test   %eax,%eax
80106338:	0f 85 b2 00 00 00    	jne    801063f0 <acquire+0xd0>
  popcli();
8010633e:	e8 dd fe ff ff       	call   80106220 <popcli>
  asm volatile("lock; xchgl %0, %1" :
80106343:	b9 01 00 00 00       	mov    $0x1,%ecx
80106348:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010634f:	90                   	nop
  while(xchg(&lk->locked, 1) != 0)
80106350:	8b 55 08             	mov    0x8(%ebp),%edx
80106353:	89 c8                	mov    %ecx,%eax
80106355:	f0 87 02             	lock xchg %eax,(%edx)
80106358:	85 c0                	test   %eax,%eax
8010635a:	75 f4                	jne    80106350 <acquire+0x30>
  __sync_synchronize();
8010635c:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80106361:	8b 5d 08             	mov    0x8(%ebp),%ebx
80106364:	e8 57 f1 ff ff       	call   801054c0 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80106369:	8b 4d 08             	mov    0x8(%ebp),%ecx
  for(i = 0; i < 10; i++){
8010636c:	31 d2                	xor    %edx,%edx
  lk->cpu = mycpu();
8010636e:	89 43 08             	mov    %eax,0x8(%ebx)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80106371:	8d 85 00 00 00 80    	lea    -0x80000000(%ebp),%eax
80106377:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
8010637c:	77 32                	ja     801063b0 <acquire+0x90>
  ebp = (uint*)v - 2;
8010637e:	89 e8                	mov    %ebp,%eax
80106380:	eb 14                	jmp    80106396 <acquire+0x76>
80106382:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80106388:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
8010638e:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80106394:	77 1a                	ja     801063b0 <acquire+0x90>
    pcs[i] = ebp[1];     // saved %eip
80106396:	8b 58 04             	mov    0x4(%eax),%ebx
80106399:	89 5c 91 0c          	mov    %ebx,0xc(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
8010639d:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
801063a0:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801063a2:	83 fa 0a             	cmp    $0xa,%edx
801063a5:	75 e1                	jne    80106388 <acquire+0x68>
}
801063a7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801063aa:	c9                   	leave  
801063ab:	c3                   	ret    
801063ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801063b0:	8d 44 91 0c          	lea    0xc(%ecx,%edx,4),%eax
801063b4:	83 c1 34             	add    $0x34,%ecx
801063b7:	89 ca                	mov    %ecx,%edx
801063b9:	29 c2                	sub    %eax,%edx
801063bb:	83 e2 04             	and    $0x4,%edx
801063be:	74 10                	je     801063d0 <acquire+0xb0>
    pcs[i] = 0;
801063c0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801063c6:	83 c0 04             	add    $0x4,%eax
801063c9:	39 c1                	cmp    %eax,%ecx
801063cb:	74 da                	je     801063a7 <acquire+0x87>
801063cd:	8d 76 00             	lea    0x0(%esi),%esi
    pcs[i] = 0;
801063d0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801063d6:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
801063d9:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
801063e0:	39 c1                	cmp    %eax,%ecx
801063e2:	75 ec                	jne    801063d0 <acquire+0xb0>
801063e4:	eb c1                	jmp    801063a7 <acquire+0x87>
801063e6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801063ed:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
801063f0:	8b 5b 08             	mov    0x8(%ebx),%ebx
801063f3:	e8 c8 f0 ff ff       	call   801054c0 <mycpu>
801063f8:	39 c3                	cmp    %eax,%ebx
801063fa:	0f 85 3e ff ff ff    	jne    8010633e <acquire+0x1e>
  popcli();
80106400:	e8 1b fe ff ff       	call   80106220 <popcli>
    panic("acquire");
80106405:	83 ec 0c             	sub    $0xc,%esp
80106408:	68 71 9c 10 80       	push   $0x80109c71
...
80106424:	8b 55 08             	mov    0x8(%ebp),%edx
80106427:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
8010642a:	89 d0                	mov    %edx,%eax
8010642c:	09 c8                	or     %ecx,%eax
8010642e:	a8 03                	test   $0x3,%al
80106430:	75 1e                	jne    80106450 <memset+0x30>
    c &= 0xFF;
80106432:	0f b6 45 0c          	movzbl 0xc(%ebp),%eax
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80106436:	c1 e9 02             	shr    $0x2,%ecx
  asm volatile("cld; rep stosl" :
80106439:	89 d7                	mov    %edx,%edi
8010643b:	69 c0 01 01 01 01    	imul   $0x1010101,%eax,%eax
80106441:	fc                   	cld    
80106442:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80106444:	8b 7d fc             	mov    -0x4(%ebp),%edi
80106447:	89 d0                	mov    %edx,%eax
80106449:	c9                   	leave  
8010644a:	c3                   	ret    
...
80106453:	89 d7                	mov    %edx,%edi
80106455:	fc                   	cld    
80106456:	f3 aa                	rep stos %al,%es:(%edi)
80106458:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
80106464:	8b 75 10             	mov    0x10(%ebp),%esi
80106467:	8b 45 08             	mov    0x8(%ebp),%eax
8010646a:	53                   	push   %ebx
8010646b:	8b 55 0c             	mov    0xc(%ebp),%edx
  const uchar *s1, *s2;
...
80106470:	74 2e                	je     801064a0 <memcmp+0x40>
80106472:	01 c6                	add    %eax,%esi
80106474:	eb 14                	jmp    8010648a <memcmp+0x2a>
...
80106483:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80106486:	39 f0                	cmp    %esi,%eax
80106488:	74 16                	je     801064a0 <memcmp+0x40>
    if(*s1 != *s2)
8010648a:	0f b6 08             	movzbl (%eax),%ecx
8010648d:	0f b6 1a             	movzbl (%edx),%ebx
80106490:	38 d9                	cmp    %bl,%cl
80106492:	74 ec                	je     80106480 <memcmp+0x20>
      return *s1 - *s2;
80106494:	0f b6 c1             	movzbl %cl,%eax
80106497:	29 d8                	sub    %ebx,%eax
  }
...
801064b4:	8b 55 08             	mov    0x8(%ebp),%edx
801064b7:	8b 45 10             	mov    0x10(%ebp),%eax
801064ba:	56                   	push   %esi
801064bb:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801064be:	39 d6                	cmp    %edx,%esi
801064c0:	73 26                	jae    801064e8 <memmove+0x38>
801064c2:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
801064c5:	39 ca                	cmp    %ecx,%edx
801064c7:	73 1f                	jae    801064e8 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
801064c9:	85 c0                	test   %eax,%eax
801064cb:	74 0f                	je     801064dc <memmove+0x2c>
801064cd:	83 e8 01             	sub    $0x1,%eax
      *--d = *--s;
801064d0:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
801064d4:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
801064d7:	83 e8 01             	sub    $0x1,%eax
801064da:	73 f4                	jae    801064d0 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
801064dc:	5e                   	pop    %esi
801064dd:	89 d0                	mov    %edx,%eax
801064df:	5f                   	pop    %edi
801064e0:	5d                   	pop    %ebp
801064e1:	c3                   	ret    
801064e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
801064e8:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
801064eb:	89 d7                	mov    %edx,%edi
801064ed:	85 c0                	test   %eax,%eax
801064ef:	74 eb                	je     801064dc <memmove+0x2c>
801064f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
801064f8:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
801064f9:	39 ce                	cmp    %ecx,%esi
801064fb:	75 fb                	jne    801064f8 <memmove+0x48>
}
801064fd:	5e                   	pop    %esi
801064fe:	89 d0                	mov    %edx,%eax
80106500:	5f                   	pop    %edi
80106501:	5d                   	pop    %ebp
80106502:	c3                   	ret    
...
80106510:	eb 9e                	jmp    801064b0 <memmove>
...
8010652a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  while(n > 0 && *p && *p == *q)
8010652d:	85 d2                	test   %edx,%edx
8010652f:	75 16                	jne    80106547 <strncmp+0x27>
80106531:	eb 2d                	jmp    80106560 <strncmp+0x40>
80106533:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106537:	90                   	nop
80106538:	3a 19                	cmp    (%ecx),%bl
8010653a:	75 12                	jne    8010654e <strncmp+0x2e>
    n--, p++, q++;
8010653c:	83 c0 01             	add    $0x1,%eax
8010653f:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80106542:	83 ea 01             	sub    $0x1,%edx
80106545:	74 19                	je     80106560 <strncmp+0x40>
80106547:	0f b6 18             	movzbl (%eax),%ebx
8010654a:	84 db                	test   %bl,%bl
8010654c:	75 ea                	jne    80106538 <strncmp+0x18>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
8010654e:	0f b6 00             	movzbl (%eax),%eax
80106551:	0f b6 11             	movzbl (%ecx),%edx
}
80106554:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106557:	c9                   	leave  
  return (uchar)*p - (uchar)*q;
80106558:	29 d0                	sub    %edx,%eax
}
8010655a:	c3                   	ret    
...
80106579:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
8010657c:	89 f0                	mov    %esi,%eax
8010657e:	eb 15                	jmp    80106595 <strncpy+0x25>
80106580:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80106584:	8b 7d 0c             	mov    0xc(%ebp),%edi
80106587:	83 c0 01             	add    $0x1,%eax
8010658a:	0f b6 4f ff          	movzbl -0x1(%edi),%ecx
8010658e:	88 48 ff             	mov    %cl,-0x1(%eax)
80106591:	84 c9                	test   %cl,%cl
80106593:	74 13                	je     801065a8 <strncpy+0x38>
80106595:	89 d3                	mov    %edx,%ebx
80106597:	83 ea 01             	sub    $0x1,%edx
8010659a:	85 db                	test   %ebx,%ebx
8010659c:	7f e2                	jg     80106580 <strncpy+0x10>
    ;
  while(n-- > 0)
    *s++ = 0;
  return os;
...
801065a5:	8d 76 00             	lea    0x0(%esi),%esi
  while(n-- > 0)
801065a8:	8d 0c 18             	lea    (%eax,%ebx,1),%ecx
801065ab:	83 e9 01             	sub    $0x1,%ecx
801065ae:	85 d2                	test   %edx,%edx
801065b0:	74 ec                	je     8010659e <strncpy+0x2e>
801065b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    *s++ = 0;
801065b8:	83 c0 01             	add    $0x1,%eax
801065bb:	89 ca                	mov    %ecx,%edx
801065bd:	c6 40 ff 00          	movb   $0x0,-0x1(%eax)
  while(n-- > 0)
801065c1:	29 c2                	sub    %eax,%edx
801065c3:	85 d2                	test   %edx,%edx
801065c5:	7f f1                	jg     801065b8 <strncpy+0x48>
}
801065c7:	5b                   	pop    %ebx
801065c8:	89 f0                	mov    %esi,%eax
801065ca:	5e                   	pop    %esi
801065cb:	5f                   	pop    %edi
801065cc:	5d                   	pop    %ebp
801065cd:	c3                   	ret    
...
801065d4:	8b 55 10             	mov    0x10(%ebp),%edx
801065d7:	8b 75 08             	mov    0x8(%ebp),%esi
...
801065db:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  os = s;
  if(n <= 0)
801065de:	85 d2                	test   %edx,%edx
801065e0:	7e 25                	jle    80106607 <safestrcpy+0x37>
801065e2:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
801065e6:	89 f2                	mov    %esi,%edx
801065e8:	eb 16                	jmp    80106600 <safestrcpy+0x30>
801065ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
801065f0:	0f b6 08             	movzbl (%eax),%ecx
801065f3:	83 c0 01             	add    $0x1,%eax
801065f6:	83 c2 01             	add    $0x1,%edx
801065f9:	88 4a ff             	mov    %cl,-0x1(%edx)
801065fc:	84 c9                	test   %cl,%cl
801065fe:	74 04                	je     80106604 <safestrcpy+0x34>
80106600:	39 d8                	cmp    %ebx,%eax
80106602:	75 ec                	jne    801065f0 <safestrcpy+0x20>
    ;
  *s = 0;
80106604:	c6 02 00             	movb   $0x0,(%edx)
  return os;
}
...
80106615:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
80106618:	80 3a 00             	cmpb   $0x0,(%edx)
8010661b:	74 0c                	je     80106629 <strlen+0x19>
8010661d:	8d 76 00             	lea    0x0(%esi),%esi
80106620:	83 c0 01             	add    $0x1,%eax
80106623:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80106627:	75 f7                	jne    80106620 <strlen+0x10>
    ;
  return n;
}
80106629:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
8010662b:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
8010662f:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80106636:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80106637:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80106639:	89 d4                	mov    %edx,%esp
...
80106644:	83 ec 04             	sub    $0x4,%esp
80106647:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010664a:	e8 f1 ee ff ff       	call   80105540 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
8010664f:	8b 00                	mov    (%eax),%eax
80106651:	39 c3                	cmp    %eax,%ebx
80106653:	73 1b                	jae    80106670 <fetchint+0x30>
80106655:	8d 53 04             	lea    0x4(%ebx),%edx
80106658:	39 d0                	cmp    %edx,%eax
8010665a:	72 14                	jb     80106670 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
8010665c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010665f:	8b 13                	mov    (%ebx),%edx
80106661:	89 10                	mov    %edx,(%eax)
  return 0;
80106663:	31 c0                	xor    %eax,%eax
}
80106665:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106668:	c9                   	leave  
80106669:	c3                   	ret    
8010666a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return -1;
80106670:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106675:	eb ee                	jmp    80106665 <fetchint+0x25>
...
80106687:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010668a:	e8 b1 ee ff ff       	call   80105540 <myproc>

  if(addr >= curproc->sz)
8010668f:	3b 18                	cmp    (%eax),%ebx
80106691:	73 2d                	jae    801066c0 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
80106693:	8b 55 0c             	mov    0xc(%ebp),%edx
80106696:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80106698:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
8010669a:	39 d3                	cmp    %edx,%ebx
8010669c:	73 22                	jae    801066c0 <fetchstr+0x40>
8010669e:	89 d8                	mov    %ebx,%eax
801066a0:	eb 0d                	jmp    801066af <fetchstr+0x2f>
801066a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801066a8:	83 c0 01             	add    $0x1,%eax
801066ab:	39 d0                	cmp    %edx,%eax
801066ad:	73 11                	jae    801066c0 <fetchstr+0x40>
    if(*s == 0)
801066af:	80 38 00             	cmpb   $0x0,(%eax)
801066b2:	75 f4                	jne    801066a8 <fetchstr+0x28>
      return s - *pp;
801066b4:	29 d8                	sub    %ebx,%eax
  }
  return -1;
}
801066b6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801066b9:	c9                   	leave  
801066ba:	c3                   	ret    
801066bb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801066bf:	90                   	nop
801066c0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    return -1;
...
801066d5:	e8 66 ee ff ff       	call   80105540 <myproc>
...
801066e3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801066e6:	e8 55 ee ff ff       	call   80105540 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801066eb:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
801066ee:	8b 00                	mov    (%eax),%eax
801066f0:	39 c6                	cmp    %eax,%esi
801066f2:	73 1c                	jae    80106710 <argint+0x40>
801066f4:	8d 53 08             	lea    0x8(%ebx),%edx
801066f7:	39 d0                	cmp    %edx,%eax
801066f9:	72 15                	jb     80106710 <argint+0x40>
  *ip = *(int*)(addr);
801066fb:	8b 45 0c             	mov    0xc(%ebp),%eax
801066fe:	8b 53 04             	mov    0x4(%ebx),%edx
80106701:	89 10                	mov    %edx,(%eax)
  return 0;
...
80106710:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80106715:	eb ee                	jmp    80106705 <argint+0x35>
...
80106726:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80106729:	e8 12 ee ff ff       	call   80105540 <myproc>
8010672e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80106730:	e8 0b ee ff ff       	call   80105540 <myproc>
80106735:	8b 55 08             	mov    0x8(%ebp),%edx
80106738:	8b 40 18             	mov    0x18(%eax),%eax
8010673b:	8b 40 44             	mov    0x44(%eax),%eax
8010673e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80106741:	e8 fa ed ff ff       	call   80105540 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80106746:	8d 7b 04             	lea    0x4(%ebx),%edi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80106749:	8b 00                	mov    (%eax),%eax
8010674b:	39 c7                	cmp    %eax,%edi
8010674d:	73 31                	jae    80106780 <argptr+0x60>
8010674f:	8d 4b 08             	lea    0x8(%ebx),%ecx
80106752:	39 c8                	cmp    %ecx,%eax
80106754:	72 2a                	jb     80106780 <argptr+0x60>
 
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80106756:	8b 55 10             	mov    0x10(%ebp),%edx
  *ip = *(int*)(addr);
80106759:	8b 43 04             	mov    0x4(%ebx),%eax
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
8010675c:	85 d2                	test   %edx,%edx
8010675e:	78 20                	js     80106780 <argptr+0x60>
80106760:	8b 16                	mov    (%esi),%edx
80106762:	39 d0                	cmp    %edx,%eax
80106764:	73 1a                	jae    80106780 <argptr+0x60>
80106766:	8b 5d 10             	mov    0x10(%ebp),%ebx
80106769:	01 c3                	add    %eax,%ebx
8010676b:	39 da                	cmp    %ebx,%edx
8010676d:	72 11                	jb     80106780 <argptr+0x60>
    return -1;
  *pp = (char*)i;
8010676f:	8b 55 0c             	mov    0xc(%ebp),%edx
80106772:	89 02                	mov    %eax,(%edx)
  return 0;
80106774:	31 c0                	xor    %eax,%eax
}
80106776:	83 c4 0c             	add    $0xc,%esp
80106779:	5b                   	pop    %ebx
8010677a:	5e                   	pop    %esi
8010677b:	5f                   	pop    %edi
8010677c:	5d                   	pop    %ebp
...
80106785:	eb ef                	jmp    80106776 <argptr+0x56>
...
80106794:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80106795:	e8 a6 ed ff ff       	call   80105540 <myproc>
8010679a:	8b 55 08             	mov    0x8(%ebp),%edx
8010679d:	8b 40 18             	mov    0x18(%eax),%eax
801067a0:	8b 40 44             	mov    0x44(%eax),%eax
801067a3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801067a6:	e8 95 ed ff ff       	call   80105540 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801067ab:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
801067ae:	8b 00                	mov    (%eax),%eax
801067b0:	39 c6                	cmp    %eax,%esi
801067b2:	73 44                	jae    801067f8 <argstr+0x68>
801067b4:	8d 53 08             	lea    0x8(%ebx),%edx
801067b7:	39 d0                	cmp    %edx,%eax
801067b9:	72 3d                	jb     801067f8 <argstr+0x68>
  *ip = *(int*)(addr);
801067bb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
801067be:	e8 7d ed ff ff       	call   80105540 <myproc>
  if(addr >= curproc->sz)
801067c3:	3b 18                	cmp    (%eax),%ebx
801067c5:	73 31                	jae    801067f8 <argstr+0x68>
  *pp = (char*)addr;
801067c7:	8b 55 0c             	mov    0xc(%ebp),%edx
801067ca:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
801067cc:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
801067ce:	39 d3                	cmp    %edx,%ebx
801067d0:	73 26                	jae    801067f8 <argstr+0x68>
801067d2:	89 d8                	mov    %ebx,%eax
801067d4:	eb 11                	jmp    801067e7 <argstr+0x57>
801067d6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801067dd:	8d 76 00             	lea    0x0(%esi),%esi
801067e0:	83 c0 01             	add    $0x1,%eax
801067e3:	39 d0                	cmp    %edx,%eax
801067e5:	73 11                	jae    801067f8 <argstr+0x68>
    if(*s == 0)
801067e7:	80 38 00             	cmpb   $0x0,(%eax)
801067ea:	75 f4                	jne    801067e0 <argstr+0x50>
      return s - *pp;
801067ec:	29 d8                	sub    %ebx,%eax
  int addr;
  if(argint(n, &addr) < 0)
    return -1;
...
80106814:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80106817:	e8 24 ed ff ff       	call   80105540 <myproc>
8010681c:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
8010681e:	8b 40 18             	mov    0x18(%eax),%eax
80106821:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80106824:	8d 50 ff             	lea    -0x1(%eax),%edx
80106827:	83 fa 18             	cmp    $0x18,%edx
8010682a:	77 24                	ja     80106850 <syscall+0x40>
8010682c:	8b 14 85 a0 9c 10 80 	mov    -0x7fef6360(,%eax,4),%edx
80106833:	85 d2                	test   %edx,%edx
80106835:	74 19                	je     80106850 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80106837:	ff d2                	call   *%edx
80106839:	89 c2                	mov    %eax,%edx
8010683b:	8b 43 18             	mov    0x18(%ebx),%eax
8010683e:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80106841:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106844:	c9                   	leave  
80106845:	c3                   	ret    
...
80106850:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80106851:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80106854:	50                   	push   %eax
80106855:	ff 73 10             	pushl  0x10(%ebx)
80106858:	68 79 9c 10 80       	push   $0x80109c79
8010685d:	e8 6e 9f ff ff       	call   801007d0 <cprintf>
    curproc->tf->eax = -1;
80106862:	8b 43 18             	mov    0x18(%ebx),%eax
80106865:	83 c4 10             	add    $0x10,%esp
80106868:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
8010686f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106872:	c9                   	leave  
80106873:	c3                   	ret    
80106874:	66 90                	xchg   %ax,%ax
80106876:	66 90                	xchg   %ax,%ax
80106878:	66 90                	xchg   %ax,%ax
8010687a:	66 90                	xchg   %ax,%ax
8010687c:	66 90                	xchg   %ax,%ax
...
80106885:	8d 7d da             	lea    -0x26(%ebp),%edi
{
80106888:	53                   	push   %ebx
80106889:	83 ec 34             	sub    $0x34,%esp
8010688c:	89 4d d0             	mov    %ecx,-0x30(%ebp)
8010688f:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106892:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80106895:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if ((dp = nameiparent(path, name)) == 0)
80106898:	57                   	push   %edi
80106899:	50                   	push   %eax
8010689a:	e8 e1 d3 ff ff       	call   80103c80 <nameiparent>
8010689f:	83 c4 10             	add    $0x10,%esp
801068a2:	85 c0                	test   %eax,%eax
801068a4:	74 5e                	je     80106904 <create+0x84>
    return 0;
  ilock(dp);
801068a6:	83 ec 0c             	sub    $0xc,%esp
801068a9:	89 c3                	mov    %eax,%ebx
801068ab:	50                   	push   %eax
801068ac:	e8 cf ca ff ff       	call   80103380 <ilock>

  if ((ip = dirlookup(dp, name, 0)) != 0)
801068b1:	83 c4 0c             	add    $0xc,%esp
801068b4:	6a 00                	push   $0x0
801068b6:	57                   	push   %edi
801068b7:	53                   	push   %ebx
801068b8:	e8 13 d0 ff ff       	call   801038d0 <dirlookup>
801068bd:	83 c4 10             	add    $0x10,%esp
801068c0:	89 c6                	mov    %eax,%esi
801068c2:	85 c0                	test   %eax,%eax
801068c4:	74 4a                	je     80106910 <create+0x90>
  {
    iunlockput(dp);
801068c6:	83 ec 0c             	sub    $0xc,%esp
801068c9:	53                   	push   %ebx
801068ca:	e8 41 cd ff ff       	call   80103610 <iunlockput>
    ilock(ip);
801068cf:	89 34 24             	mov    %esi,(%esp)
801068d2:	e8 a9 ca ff ff       	call   80103380 <ilock>
    if (type == T_FILE && ip->type == T_FILE)
801068d7:	83 c4 10             	add    $0x10,%esp
801068da:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801068df:	75 17                	jne    801068f8 <create+0x78>
801068e1:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
801068e6:	75 10                	jne    801068f8 <create+0x78>
...
801068fc:	e8 0f cd ff ff       	call   80103610 <iunlockput>
    return 0;
80106901:	83 c4 10             	add    $0x10,%esp
}
80106904:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80106907:	31 f6                	xor    %esi,%esi
}
80106909:	5b                   	pop    %ebx
8010690a:	89 f0                	mov    %esi,%eax
8010690c:	5e                   	pop    %esi
8010690d:	5f                   	pop    %edi
8010690e:	5d                   	pop    %ebp
8010690f:	c3                   	ret    
  if ((ip = ialloc(dp->dev, type)) == 0)
80106910:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
80106914:	83 ec 08             	sub    $0x8,%esp
80106917:	50                   	push   %eax
80106918:	ff 33                	pushl  (%ebx)
8010691a:	e8 f1 c8 ff ff       	call   80103210 <ialloc>
8010691f:	83 c4 10             	add    $0x10,%esp
80106922:	89 c6                	mov    %eax,%esi
80106924:	85 c0                	test   %eax,%eax
80106926:	0f 84 bc 00 00 00    	je     801069e8 <create+0x168>
  ilock(ip);
8010692c:	83 ec 0c             	sub    $0xc,%esp
8010692f:	50                   	push   %eax
80106930:	e8 4b ca ff ff       	call   80103380 <ilock>
  ip->major = major;
80106935:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80106939:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
8010693d:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80106941:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80106945:	b8 01 00 00 00       	mov    $0x1,%eax
8010694a:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
8010694e:	89 34 24             	mov    %esi,(%esp)
80106951:	e8 7a c9 ff ff       	call   801032d0 <iupdate>
  if (type == T_DIR)
80106956:	83 c4 10             	add    $0x10,%esp
80106959:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010695e:	74 30                	je     80106990 <create+0x110>
  if (dirlink(dp, name, ip->inum) < 0)
80106960:	83 ec 04             	sub    $0x4,%esp
80106963:	ff 76 04             	pushl  0x4(%esi)
80106966:	57                   	push   %edi
80106967:	53                   	push   %ebx
80106968:	e8 33 d2 ff ff       	call   80103ba0 <dirlink>
8010696d:	83 c4 10             	add    $0x10,%esp
80106970:	85 c0                	test   %eax,%eax
80106972:	78 67                	js     801069db <create+0x15b>
  iunlockput(dp);
80106974:	83 ec 0c             	sub    $0xc,%esp
80106977:	53                   	push   %ebx
80106978:	e8 93 cc ff ff       	call   80103610 <iunlockput>
  return ip;
8010697d:	83 c4 10             	add    $0x10,%esp
}
80106980:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106983:	89 f0                	mov    %esi,%eax
80106985:	5b                   	pop    %ebx
80106986:	5e                   	pop    %esi
80106987:	5f                   	pop    %edi
80106988:	5d                   	pop    %ebp
...
80106990:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink++; // for ".."
80106993:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    iupdate(dp);
80106998:	53                   	push   %ebx
80106999:	e8 32 c9 ff ff       	call   801032d0 <iupdate>
    if (dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010699e:	83 c4 0c             	add    $0xc,%esp
801069a1:	ff 76 04             	pushl  0x4(%esi)
801069a4:	68 24 9d 10 80       	push   $0x80109d24
801069a9:	56                   	push   %esi
801069aa:	e8 f1 d1 ff ff       	call   80103ba0 <dirlink>
801069af:	83 c4 10             	add    $0x10,%esp
801069b2:	85 c0                	test   %eax,%eax
801069b4:	78 18                	js     801069ce <create+0x14e>
801069b6:	83 ec 04             	sub    $0x4,%esp
801069b9:	ff 73 04             	pushl  0x4(%ebx)
801069bc:	68 23 9d 10 80       	push   $0x80109d23
801069c1:	56                   	push   %esi
801069c2:	e8 d9 d1 ff ff       	call   80103ba0 <dirlink>
801069c7:	83 c4 10             	add    $0x10,%esp
801069ca:	85 c0                	test   %eax,%eax
801069cc:	79 92                	jns    80106960 <create+0xe0>
      panic("create dots");
801069ce:	83 ec 0c             	sub    $0xc,%esp
801069d1:	68 17 9d 10 80       	push   $0x80109d17
801069d6:	e8 a5 99 ff ff       	call   80100380 <panic>
    panic("create: dirlink");
801069db:	83 ec 0c             	sub    $0xc,%esp
801069de:	68 26 9d 10 80       	push   $0x80109d26
801069e3:	e8 98 99 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
801069e8:	83 ec 0c             	sub    $0xc,%esp
801069eb:	68 08 9d 10 80       	push   $0x80109d08
801069f0:	e8 8b 99 ff ff       	call   80100380 <panic>
...
80106a04:	53                   	push   %ebx
  if (argint(n, &fd) < 0)
80106a05:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
80106a08:	83 ec 18             	sub    $0x18,%esp
  if (argint(n, &fd) < 0)
80106a0b:	50                   	push   %eax
80106a0c:	6a 00                	push   $0x0
80106a0e:	e8 bd fc ff ff       	call   801066d0 <argint>
80106a13:	83 c4 10             	add    $0x10,%esp
80106a16:	85 c0                	test   %eax,%eax
80106a18:	78 36                	js     80106a50 <sys_dup+0x50>
  if (fd < 0 || fd >= NOFILE || (f = myproc()->ofile[fd]) == 0)
80106a1a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106a1e:	77 30                	ja     80106a50 <sys_dup+0x50>
80106a20:	e8 1b eb ff ff       	call   80105540 <myproc>
80106a25:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106a28:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80106a2c:	85 f6                	test   %esi,%esi
80106a2e:	74 20                	je     80106a50 <sys_dup+0x50>
  struct proc *curproc = myproc();
80106a30:	e8 0b eb ff ff       	call   80105540 <myproc>
  for (fd = 0; fd < NOFILE; fd++)
80106a35:	31 db                	xor    %ebx,%ebx
...
80106a46:	74 18                	je     80106a60 <sys_dup+0x60>
  for (fd = 0; fd < NOFILE; fd++)
80106a48:	83 c3 01             	add    $0x1,%ebx
80106a4b:	83 fb 10             	cmp    $0x10,%ebx
80106a4e:	75 f0                	jne    80106a40 <sys_dup+0x40>
}
80106a50:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
80106a53:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
80106a60:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80106a63:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80106a67:	56                   	push   %esi
80106a68:	e8 33 c0 ff ff       	call   80102aa0 <filedup>
  return fd;
80106a6d:	83 c4 10             	add    $0x10,%esp
}
80106a70:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106a73:	89 d8                	mov    %ebx,%eax
80106a75:	5b                   	pop    %ebx
80106a76:	5e                   	pop    %esi
80106a77:	5d                   	pop    %ebp
80106a78:	c3                   	ret    
...
80106b04:	53                   	push   %ebx
  if (argint(n, &fd) < 0)
80106b05:	8d 5d f4             	lea    -0xc(%ebp),%ebx
{
80106b08:	83 ec 18             	sub    $0x18,%esp
  if (argint(n, &fd) < 0)
80106b0b:	53                   	push   %ebx
80106b0c:	6a 00                	push   $0x0
80106b0e:	e8 bd fb ff ff       	call   801066d0 <argint>
80106b13:	83 c4 10             	add    $0x10,%esp
80106b16:	85 c0                	test   %eax,%eax
80106b18:	78 5e                	js     80106b78 <sys_write+0x78>
  if (fd < 0 || fd >= NOFILE || (f = myproc()->ofile[fd]) == 0)
80106b1a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106b1e:	77 58                	ja     80106b78 <sys_write+0x78>
80106b20:	e8 1b ea ff ff       	call   80105540 <myproc>
80106b25:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106b28:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80106b2c:	85 f6                	test   %esi,%esi
80106b2e:	74 48                	je     80106b78 <sys_write+0x78>
  if (argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80106b30:	83 ec 08             	sub    $0x8,%esp
80106b33:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106b36:	50                   	push   %eax
80106b37:	6a 02                	push   $0x2
80106b39:	e8 92 fb ff ff       	call   801066d0 <argint>
80106b3e:	83 c4 10             	add    $0x10,%esp
80106b41:	85 c0                	test   %eax,%eax
80106b43:	78 33                	js     80106b78 <sys_write+0x78>
80106b45:	83 ec 04             	sub    $0x4,%esp
80106b48:	ff 75 f0             	pushl  -0x10(%ebp)
80106b4b:	53                   	push   %ebx
80106b4c:	6a 01                	push   $0x1
80106b4e:	e8 cd fb ff ff       	call   80106720 <argptr>
80106b53:	83 c4 10             	add    $0x10,%esp
80106b56:	85 c0                	test   %eax,%eax
80106b58:	78 1e                	js     80106b78 <sys_write+0x78>
  return filewrite(f, p, n);
80106b5a:	83 ec 04             	sub    $0x4,%esp
80106b5d:	ff 75 f0             	pushl  -0x10(%ebp)
80106b60:	ff 75 f4             	pushl  -0xc(%ebp)
80106b63:	56                   	push   %esi
80106b64:	e8 47 c1 ff ff       	call   80102cb0 <filewrite>
80106b69:	83 c4 10             	add    $0x10,%esp
}
80106b6c:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106b6f:	5b                   	pop    %ebx
80106b70:	5e                   	pop    %esi
80106b71:	5d                   	pop    %ebp
80106b72:	c3                   	ret    
...
80106b7d:	eb ed                	jmp    80106b6c <sys_write+0x6c>
80106b7f:	90                   	nop
...
80106b84:	53                   	push   %ebx
  if (argint(n, &fd) < 0)
80106b85:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
80106b88:	83 ec 18             	sub    $0x18,%esp
  if (argint(n, &fd) < 0)
80106b8b:	50                   	push   %eax
80106b8c:	6a 00                	push   $0x0
80106b8e:	e8 3d fb ff ff       	call   801066d0 <argint>
80106b93:	83 c4 10             	add    $0x10,%esp
80106b96:	85 c0                	test   %eax,%eax
80106b98:	78 3e                	js     80106bd8 <sys_close+0x58>
  if (fd < 0 || fd >= NOFILE || (f = myproc()->ofile[fd]) == 0)
80106b9a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106b9e:	77 38                	ja     80106bd8 <sys_close+0x58>
80106ba0:	e8 9b e9 ff ff       	call   80105540 <myproc>
80106ba5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106ba8:	8d 5a 08             	lea    0x8(%edx),%ebx
80106bab:	8b 74 98 08          	mov    0x8(%eax,%ebx,4),%esi
80106baf:	85 f6                	test   %esi,%esi
80106bb1:	74 25                	je     80106bd8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80106bb3:	e8 88 e9 ff ff       	call   80105540 <myproc>
  fileclose(f);
80106bb8:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80106bbb:	c7 44 98 08 00 00 00 	movl   $0x0,0x8(%eax,%ebx,4)
80106bc2:	00 
  fileclose(f);
80106bc3:	56                   	push   %esi
80106bc4:	e8 27 bf ff ff       	call   80102af0 <fileclose>
  return 0;
80106bc9:	83 c4 10             	add    $0x10,%esp
80106bcc:	31 c0                	xor    %eax,%eax
}
80106bce:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106bd1:	5b                   	pop    %ebx
80106bd2:	5e                   	pop    %esi
80106bd3:	5d                   	pop    %ebp
80106bd4:	c3                   	ret    
...
80106bdd:	eb ef                	jmp    80106bce <sys_close+0x4e>
80106bdf:	90                   	nop
...
80106be4:	53                   	push   %ebx
  if (argint(n, &fd) < 0)
80106be5:	8d 5d f4             	lea    -0xc(%ebp),%ebx
{
80106be8:	83 ec 18             	sub    $0x18,%esp
  if (argint(n, &fd) < 0)
80106beb:	53                   	push   %ebx
80106bec:	6a 00                	push   $0x0
80106bee:	e8 dd fa ff ff       	call   801066d0 <argint>
80106bf3:	83 c4 10             	add    $0x10,%esp
80106bf6:	85 c0                	test   %eax,%eax
80106bf8:	78 46                	js     80106c40 <sys_fstat+0x60>
  if (fd < 0 || fd >= NOFILE || (f = myproc()->ofile[fd]) == 0)
80106bfa:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106bfe:	77 40                	ja     80106c40 <sys_fstat+0x60>
80106c00:	e8 3b e9 ff ff       	call   80105540 <myproc>
80106c05:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106c08:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80106c0c:	85 f6                	test   %esi,%esi
80106c0e:	74 30                	je     80106c40 <sys_fstat+0x60>
  if (argfd(0, 0, &f) < 0 || argptr(1, (void *)&st, sizeof(*st)) < 0)
80106c10:	83 ec 04             	sub    $0x4,%esp
80106c13:	6a 14                	push   $0x14
80106c15:	53                   	push   %ebx
80106c16:	6a 01                	push   $0x1
80106c18:	e8 03 fb ff ff       	call   80106720 <argptr>
80106c1d:	83 c4 10             	add    $0x10,%esp
80106c20:	85 c0                	test   %eax,%eax
80106c22:	78 1c                	js     80106c40 <sys_fstat+0x60>
  return filestat(f, st);
80106c24:	83 ec 08             	sub    $0x8,%esp
80106c27:	ff 75 f4             	pushl  -0xc(%ebp)
80106c2a:	56                   	push   %esi
80106c2b:	e8 a0 bf ff ff       	call   80102bd0 <filestat>
80106c30:	83 c4 10             	add    $0x10,%esp
}
80106c33:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106c36:	5b                   	pop    %ebx
80106c37:	5e                   	pop    %esi
80106c38:	5d                   	pop    %ebp
80106c39:	c3                   	ret    
...
80106c45:	eb ec                	jmp    80106c33 <sys_fstat+0x53>
...
80106c55:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
80106c58:	53                   	push   %ebx
80106c59:	83 ec 34             	sub    $0x34,%esp
  if (argstr(0, &old) < 0 || argstr(1, &new) < 0)
80106c5c:	50                   	push   %eax
80106c5d:	6a 00                	push   $0x0
80106c5f:	e8 2c fb ff ff       	call   80106790 <argstr>
80106c64:	83 c4 10             	add    $0x10,%esp
80106c67:	85 c0                	test   %eax,%eax
80106c69:	0f 88 fb 00 00 00    	js     80106d6a <sys_link+0x11a>
80106c6f:	83 ec 08             	sub    $0x8,%esp
80106c72:	8d 45 d0             	lea    -0x30(%ebp),%eax
80106c75:	50                   	push   %eax
80106c76:	6a 01                	push   $0x1
80106c78:	e8 13 fb ff ff       	call   80106790 <argstr>
80106c7d:	83 c4 10             	add    $0x10,%esp
80106c80:	85 c0                	test   %eax,%eax
80106c82:	0f 88 e2 00 00 00    	js     80106d6a <sys_link+0x11a>
  begin_op();
80106c88:	e8 93 dc ff ff       	call   80104920 <begin_op>
  if ((ip = namei(old)) == 0)
80106c8d:	83 ec 0c             	sub    $0xc,%esp
80106c90:	ff 75 d4             	pushl  -0x2c(%ebp)
80106c93:	e8 c8 cf ff ff       	call   80103c60 <namei>
80106c98:	83 c4 10             	add    $0x10,%esp
80106c9b:	89 c3                	mov    %eax,%ebx
80106c9d:	85 c0                	test   %eax,%eax
80106c9f:	0f 84 df 00 00 00    	je     80106d84 <sys_link+0x134>
  ilock(ip);
80106ca5:	83 ec 0c             	sub    $0xc,%esp
80106ca8:	50                   	push   %eax
80106ca9:	e8 d2 c6 ff ff       	call   80103380 <ilock>
  if (ip->type == T_DIR)
80106cae:	83 c4 10             	add    $0x10,%esp
80106cb1:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80106cb6:	0f 84 b5 00 00 00    	je     80106d71 <sys_link+0x121>
  iupdate(ip);
80106cbc:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
80106cbf:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if ((dp = nameiparent(new, name)) == 0)
80106cc4:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80106cc7:	53                   	push   %ebx
80106cc8:	e8 03 c6 ff ff       	call   801032d0 <iupdate>
  iunlock(ip);
80106ccd:	89 1c 24             	mov    %ebx,(%esp)
80106cd0:	e8 8b c7 ff ff       	call   80103460 <iunlock>
  if ((dp = nameiparent(new, name)) == 0)
80106cd5:	58                   	pop    %eax
80106cd6:	5a                   	pop    %edx
80106cd7:	57                   	push   %edi
80106cd8:	ff 75 d0             	pushl  -0x30(%ebp)
80106cdb:	e8 a0 cf ff ff       	call   80103c80 <nameiparent>
80106ce0:	83 c4 10             	add    $0x10,%esp
80106ce3:	89 c6                	mov    %eax,%esi
80106ce5:	85 c0                	test   %eax,%eax
80106ce7:	74 5b                	je     80106d44 <sys_link+0xf4>
  ilock(dp);
80106ce9:	83 ec 0c             	sub    $0xc,%esp
80106cec:	50                   	push   %eax
80106ced:	e8 8e c6 ff ff       	call   80103380 <ilock>
  if (dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0)
80106cf2:	8b 03                	mov    (%ebx),%eax
80106cf4:	83 c4 10             	add    $0x10,%esp
80106cf7:	39 06                	cmp    %eax,(%esi)
80106cf9:	75 3d                	jne    80106d38 <sys_link+0xe8>
80106cfb:	83 ec 04             	sub    $0x4,%esp
80106cfe:	ff 73 04             	pushl  0x4(%ebx)
80106d01:	57                   	push   %edi
80106d02:	56                   	push   %esi
80106d03:	e8 98 ce ff ff       	call   80103ba0 <dirlink>
80106d08:	83 c4 10             	add    $0x10,%esp
80106d0b:	85 c0                	test   %eax,%eax
80106d0d:	78 29                	js     80106d38 <sys_link+0xe8>
  iunlockput(dp);
80106d0f:	83 ec 0c             	sub    $0xc,%esp
80106d12:	56                   	push   %esi
80106d13:	e8 f8 c8 ff ff       	call   80103610 <iunlockput>
  iput(ip);
80106d18:	89 1c 24             	mov    %ebx,(%esp)
80106d1b:	e8 90 c7 ff ff       	call   801034b0 <iput>
  end_op();
80106d20:	e8 6b dc ff ff       	call   80104990 <end_op>
  return 0;
...
80106d3b:	56                   	push   %esi
80106d3c:	e8 cf c8 ff ff       	call   80103610 <iunlockput>
    goto bad;
80106d41:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80106d44:	83 ec 0c             	sub    $0xc,%esp
80106d47:	53                   	push   %ebx
80106d48:	e8 33 c6 ff ff       	call   80103380 <ilock>
  ip->nlink--;
80106d4d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80106d52:	89 1c 24             	mov    %ebx,(%esp)
80106d55:	e8 76 c5 ff ff       	call   801032d0 <iupdate>
  iunlockput(ip);
80106d5a:	89 1c 24             	mov    %ebx,(%esp)
80106d5d:	e8 ae c8 ff ff       	call   80103610 <iunlockput>
  end_op();
80106d62:	e8 29 dc ff ff       	call   80104990 <end_op>
  return -1;
80106d67:	83 c4 10             	add    $0x10,%esp
    return -1;
80106d6a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d6f:	eb b9                	jmp    80106d2a <sys_link+0xda>
    iunlockput(ip);
80106d71:	83 ec 0c             	sub    $0xc,%esp
80106d74:	53                   	push   %ebx
80106d75:	e8 96 c8 ff ff       	call   80103610 <iunlockput>
    end_op();
80106d7a:	e8 11 dc ff ff       	call   80104990 <end_op>
    return -1;
80106d7f:	83 c4 10             	add    $0x10,%esp
80106d82:	eb e6                	jmp    80106d6a <sys_link+0x11a>
    end_op();
80106d84:	e8 07 dc ff ff       	call   80104990 <end_op>
    return -1;
80106d89:	eb df                	jmp    80106d6a <sys_link+0x11a>
...
80106d94:	56                   	push   %esi
  if (argstr(0, &path) < 0)
80106d95:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
...
80106d9f:	e8 ec f9 ff ff       	call   80106790 <argstr>
80106da4:	83 c4 10             	add    $0x10,%esp
80106da7:	85 c0                	test   %eax,%eax
80106da9:	0f 88 54 01 00 00    	js     80106f03 <sys_unlink+0x173>
  begin_op();
80106daf:	e8 6c db ff ff       	call   80104920 <begin_op>
  if ((dp = nameiparent(path, name)) == 0)
80106db4:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80106db7:	83 ec 08             	sub    $0x8,%esp
80106dba:	53                   	push   %ebx
80106dbb:	ff 75 c0             	pushl  -0x40(%ebp)
80106dbe:	e8 bd ce ff ff       	call   80103c80 <nameiparent>
80106dc3:	83 c4 10             	add    $0x10,%esp
80106dc6:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80106dc9:	85 c0                	test   %eax,%eax
80106dcb:	0f 84 58 01 00 00    	je     80106f29 <sys_unlink+0x199>
  ilock(dp);
80106dd1:	8b 7d b4             	mov    -0x4c(%ebp),%edi
80106dd4:	83 ec 0c             	sub    $0xc,%esp
80106dd7:	57                   	push   %edi
80106dd8:	e8 a3 c5 ff ff       	call   80103380 <ilock>
  if (namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80106ddd:	58                   	pop    %eax
80106dde:	5a                   	pop    %edx
80106ddf:	68 24 9d 10 80       	push   $0x80109d24
80106de4:	53                   	push   %ebx
80106de5:	e8 c6 ca ff ff       	call   801038b0 <namecmp>
80106dea:	83 c4 10             	add    $0x10,%esp
80106ded:	85 c0                	test   %eax,%eax
80106def:	0f 84 fb 00 00 00    	je     80106ef0 <sys_unlink+0x160>
80106df5:	83 ec 08             	sub    $0x8,%esp
80106df8:	68 23 9d 10 80       	push   $0x80109d23
80106dfd:	53                   	push   %ebx
80106dfe:	e8 ad ca ff ff       	call   801038b0 <namecmp>
80106e03:	83 c4 10             	add    $0x10,%esp
80106e06:	85 c0                	test   %eax,%eax
80106e08:	0f 84 e2 00 00 00    	je     80106ef0 <sys_unlink+0x160>
  if ((ip = dirlookup(dp, name, &off)) == 0)
80106e0e:	83 ec 04             	sub    $0x4,%esp
80106e11:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80106e14:	50                   	push   %eax
80106e15:	53                   	push   %ebx
80106e16:	57                   	push   %edi
80106e17:	e8 b4 ca ff ff       	call   801038d0 <dirlookup>
80106e1c:	83 c4 10             	add    $0x10,%esp
80106e1f:	89 c3                	mov    %eax,%ebx
80106e21:	85 c0                	test   %eax,%eax
80106e23:	0f 84 c7 00 00 00    	je     80106ef0 <sys_unlink+0x160>
  ilock(ip);
80106e29:	83 ec 0c             	sub    $0xc,%esp
80106e2c:	50                   	push   %eax
80106e2d:	e8 4e c5 ff ff       	call   80103380 <ilock>
  if (ip->nlink < 1)
80106e32:	83 c4 10             	add    $0x10,%esp
80106e35:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80106e3a:	0f 8e 0a 01 00 00    	jle    80106f4a <sys_unlink+0x1ba>
  if (ip->type == T_DIR && !isdirempty(ip))
80106e40:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80106e45:	8d 7d d8             	lea    -0x28(%ebp),%edi
80106e48:	74 66                	je     80106eb0 <sys_unlink+0x120>
  memset(&de, 0, sizeof(de));
80106e4a:	83 ec 04             	sub    $0x4,%esp
80106e4d:	6a 10                	push   $0x10
80106e4f:	6a 00                	push   $0x0
80106e51:	57                   	push   %edi
80106e52:	e8 c9 f5 ff ff       	call   80106420 <memset>
  if (writei(dp, (char *)&de, off, sizeof(de)) != sizeof(de))
80106e57:	6a 10                	push   $0x10
80106e59:	ff 75 c4             	pushl  -0x3c(%ebp)
80106e5c:	57                   	push   %edi
80106e5d:	ff 75 b4             	pushl  -0x4c(%ebp)
80106e60:	e8 2b c9 ff ff       	call   80103790 <writei>
80106e65:	83 c4 20             	add    $0x20,%esp
80106e68:	83 f8 10             	cmp    $0x10,%eax
80106e6b:	0f 85 cc 00 00 00    	jne    80106f3d <sys_unlink+0x1ad>
  if (ip->type == T_DIR)
80106e71:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80106e76:	0f 84 94 00 00 00    	je     80106f10 <sys_unlink+0x180>
  iunlockput(dp);
80106e7c:	83 ec 0c             	sub    $0xc,%esp
80106e7f:	ff 75 b4             	pushl  -0x4c(%ebp)
80106e82:	e8 89 c7 ff ff       	call   80103610 <iunlockput>
  ip->nlink--;
80106e87:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80106e8c:	89 1c 24             	mov    %ebx,(%esp)
80106e8f:	e8 3c c4 ff ff       	call   801032d0 <iupdate>
  iunlockput(ip);
80106e94:	89 1c 24             	mov    %ebx,(%esp)
80106e97:	e8 74 c7 ff ff       	call   80103610 <iunlockput>
  end_op();
80106e9c:	e8 ef da ff ff       	call   80104990 <end_op>
  return 0;
...
80106eb0:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
80106eb4:	76 94                	jbe    80106e4a <sys_unlink+0xba>
80106eb6:	be 20 00 00 00       	mov    $0x20,%esi
80106ebb:	eb 0b                	jmp    80106ec8 <sys_unlink+0x138>
80106ebd:	8d 76 00             	lea    0x0(%esi),%esi
80106ec0:	83 c6 10             	add    $0x10,%esi
80106ec3:	3b 73 58             	cmp    0x58(%ebx),%esi
80106ec6:	73 82                	jae    80106e4a <sys_unlink+0xba>
    if (readi(dp, (char *)&de, off, sizeof(de)) != sizeof(de))
80106ec8:	6a 10                	push   $0x10
80106eca:	56                   	push   %esi
80106ecb:	57                   	push   %edi
80106ecc:	53                   	push   %ebx
80106ecd:	e8 be c7 ff ff       	call   80103690 <readi>
80106ed2:	83 c4 10             	add    $0x10,%esp
80106ed5:	83 f8 10             	cmp    $0x10,%eax
80106ed8:	75 56                	jne    80106f30 <sys_unlink+0x1a0>
    if (de.inum != 0)
80106eda:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80106edf:	74 df                	je     80106ec0 <sys_unlink+0x130>
    iunlockput(ip);
80106ee1:	83 ec 0c             	sub    $0xc,%esp
80106ee4:	53                   	push   %ebx
80106ee5:	e8 26 c7 ff ff       	call   80103610 <iunlockput>
    goto bad;
80106eea:	83 c4 10             	add    $0x10,%esp
80106eed:	8d 76 00             	lea    0x0(%esi),%esi
  iunlockput(dp);
80106ef0:	83 ec 0c             	sub    $0xc,%esp
80106ef3:	ff 75 b4             	pushl  -0x4c(%ebp)
80106ef6:	e8 15 c7 ff ff       	call   80103610 <iunlockput>
  end_op();
80106efb:	e8 90 da ff ff       	call   80104990 <end_op>
  return -1;
80106f00:	83 c4 10             	add    $0x10,%esp
    return -1;
80106f03:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f08:	eb 9c                	jmp    80106ea6 <sys_unlink+0x116>
80106f0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
80106f10:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
80106f13:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
80106f16:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
80106f1b:	50                   	push   %eax
80106f1c:	e8 af c3 ff ff       	call   801032d0 <iupdate>
80106f21:	83 c4 10             	add    $0x10,%esp
80106f24:	e9 53 ff ff ff       	jmp    80106e7c <sys_unlink+0xec>
    end_op();
80106f29:	e8 62 da ff ff       	call   80104990 <end_op>
    return -1;
80106f2e:	eb d3                	jmp    80106f03 <sys_unlink+0x173>
      panic("isdirempty: readi");
80106f30:	83 ec 0c             	sub    $0xc,%esp
80106f33:	68 48 9d 10 80       	push   $0x80109d48
80106f38:	e8 43 94 ff ff       	call   80100380 <panic>
    panic("unlink: writei");
80106f3d:	83 ec 0c             	sub    $0xc,%esp
80106f40:	68 5a 9d 10 80       	push   $0x80109d5a
80106f45:	e8 36 94 ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
80106f4a:	83 ec 0c             	sub    $0xc,%esp
80106f4d:	68 36 9d 10 80       	push   $0x80109d36
...
80106f65:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
80106f68:	53                   	push   %ebx
80106f69:	83 ec 24             	sub    $0x24,%esp
  if (argstr(0, &path) < 0 || argint(1, &omode) < 0)
80106f6c:	50                   	push   %eax
80106f6d:	6a 00                	push   $0x0
80106f6f:	e8 1c f8 ff ff       	call   80106790 <argstr>
80106f74:	83 c4 10             	add    $0x10,%esp
80106f77:	85 c0                	test   %eax,%eax
80106f79:	0f 88 8e 00 00 00    	js     8010700d <sys_open+0xad>
80106f7f:	83 ec 08             	sub    $0x8,%esp
80106f82:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106f85:	50                   	push   %eax
80106f86:	6a 01                	push   $0x1
80106f88:	e8 43 f7 ff ff       	call   801066d0 <argint>
80106f8d:	83 c4 10             	add    $0x10,%esp
80106f90:	85 c0                	test   %eax,%eax
80106f92:	78 79                	js     8010700d <sys_open+0xad>
    return -1;

  begin_op();
80106f94:	e8 87 d9 ff ff       	call   80104920 <begin_op>

  if (omode & O_CREATE)
80106f99:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80106f9d:	75 79                	jne    80107018 <sys_open+0xb8>
      return -1;
    }
  }
  else
...
80106fa2:	ff 75 e0             	pushl  -0x20(%ebp)
80106fa5:	e8 b6 cc ff ff       	call   80103c60 <namei>
80106faa:	83 c4 10             	add    $0x10,%esp
80106fad:	89 c6                	mov    %eax,%esi
80106faf:	85 c0                	test   %eax,%eax
80106fb1:	0f 84 7e 00 00 00    	je     80107035 <sys_open+0xd5>
    {
      end_op();
      return -1;
    }
...
80106fbb:	e8 c0 c3 ff ff       	call   80103380 <ilock>
    if (ip->type == T_DIR && omode != O_RDONLY)
80106fc0:	83 c4 10             	add    $0x10,%esp
80106fc3:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80106fc8:	0f 84 ba 00 00 00    	je     80107088 <sys_open+0x128>
      end_op();
      return -1;
    }
  }
...
80106fce:	e8 5d ba ff ff       	call   80102a30 <filealloc>
80106fd3:	89 c7                	mov    %eax,%edi
80106fd5:	85 c0                	test   %eax,%eax
80106fd7:	74 23                	je     80106ffc <sys_open+0x9c>
  struct proc *curproc = myproc();
80106fd9:	e8 62 e5 ff ff       	call   80105540 <myproc>
  for (fd = 0; fd < NOFILE; fd++)
80106fde:	31 db                	xor    %ebx,%ebx
    if (curproc->ofile[fd] == 0)
80106fe0:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80106fe4:	85 d2                	test   %edx,%edx
80106fe6:	74 58                	je     80107040 <sys_open+0xe0>
  for (fd = 0; fd < NOFILE; fd++)
80106fe8:	83 c3 01             	add    $0x1,%ebx
80106feb:	83 fb 10             	cmp    $0x10,%ebx
80106fee:	75 f0                	jne    80106fe0 <sys_open+0x80>
  {
    if (f)
      fileclose(f);
80106ff0:	83 ec 0c             	sub    $0xc,%esp
80106ff3:	57                   	push   %edi
80106ff4:	e8 f7 ba ff ff       	call   80102af0 <fileclose>
80106ff9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
80106ffc:	83 ec 0c             	sub    $0xc,%esp
80106fff:	56                   	push   %esi
80107000:	e8 0b c6 ff ff       	call   80103610 <iunlockput>
    end_op();
80107005:	e8 86 d9 ff ff       	call   80104990 <end_op>
    return -1;
8010700a:	83 c4 10             	add    $0x10,%esp
    return -1;
8010700d:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80107012:	eb 65                	jmp    80107079 <sys_open+0x119>
...
80107027:	e8 54 f8 ff ff       	call   80106880 <create>
    if (ip == 0)
...
80107033:	75 99                	jne    80106fce <sys_open+0x6e>
      end_op();
80107035:	e8 56 d9 ff ff       	call   80104990 <end_op>
      return -1;
8010703a:	eb d1                	jmp    8010700d <sys_open+0xad>
8010703c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
80107040:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80107043:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
  iunlock(ip);
80107047:	56                   	push   %esi
80107048:	e8 13 c4 ff ff       	call   80103460 <iunlock>
  end_op();
8010704d:	e8 3e d9 ff ff       	call   80104990 <end_op>

  f->type = FD_INODE;
80107052:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
...
8010705b:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
8010705e:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
80107061:	89 d0                	mov    %edx,%eax
  f->off = 0;
80107063:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
8010706a:	f7 d0                	not    %eax
8010706c:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010706f:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
80107072:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80107075:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
80107079:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010707c:	89 d8                	mov    %ebx,%eax
8010707e:	5b                   	pop    %ebx
8010707f:	5e                   	pop    %esi
80107080:	5f                   	pop    %edi
80107081:	5d                   	pop    %ebp
...
8010708b:	85 c9                	test   %ecx,%ecx
8010708d:	0f 84 3b ff ff ff    	je     80106fce <sys_open+0x6e>
80107093:	e9 64 ff ff ff       	jmp    80106ffc <sys_open+0x9c>
...
801070df:	e8 2c c5 ff ff       	call   80103610 <iunlockput>
  end_op();
801070e4:	e8 a7 d8 ff ff       	call   80104990 <end_op>
  return 0;
...
801070ef:	c3                   	ret    
    end_op();
801070f0:	e8 9b d8 ff ff       	call   80104990 <end_op>
    return -1;
...
80107103:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80107106:	e8 15 d8 ff ff       	call   80104920 <begin_op>
  if ((argstr(0, &path)) < 0 ||
8010710b:	83 ec 08             	sub    $0x8,%esp
8010710e:	8d 45 ec             	lea    -0x14(%ebp),%eax
80107111:	50                   	push   %eax
80107112:	6a 00                	push   $0x0
80107114:	e8 77 f6 ff ff       	call   80106790 <argstr>
80107119:	83 c4 10             	add    $0x10,%esp
8010711c:	85 c0                	test   %eax,%eax
8010711e:	78 60                	js     80107180 <sys_mknod+0x80>
      argint(1, &major) < 0 ||
80107120:	83 ec 08             	sub    $0x8,%esp
80107123:	8d 45 f0             	lea    -0x10(%ebp),%eax
80107126:	50                   	push   %eax
80107127:	6a 01                	push   $0x1
80107129:	e8 a2 f5 ff ff       	call   801066d0 <argint>
  if ((argstr(0, &path)) < 0 ||
8010712e:	83 c4 10             	add    $0x10,%esp
80107131:	85 c0                	test   %eax,%eax
80107133:	78 4b                	js     80107180 <sys_mknod+0x80>
      argint(2, &minor) < 0 ||
80107135:	83 ec 08             	sub    $0x8,%esp
80107138:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010713b:	50                   	push   %eax
8010713c:	6a 02                	push   $0x2
8010713e:	e8 8d f5 ff ff       	call   801066d0 <argint>
      argint(1, &major) < 0 ||
80107143:	83 c4 10             	add    $0x10,%esp
80107146:	85 c0                	test   %eax,%eax
80107148:	78 36                	js     80107180 <sys_mknod+0x80>
      (ip = create(path, T_DEV, major, minor)) == 0)
8010714a:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
8010714e:	83 ec 0c             	sub    $0xc,%esp
80107151:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
80107155:	ba 03 00 00 00       	mov    $0x3,%edx
8010715a:	50                   	push   %eax
8010715b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010715e:	e8 1d f7 ff ff       	call   80106880 <create>
      argint(2, &minor) < 0 ||
80107163:	83 c4 10             	add    $0x10,%esp
80107166:	85 c0                	test   %eax,%eax
80107168:	74 16                	je     80107180 <sys_mknod+0x80>
  {
    end_op();
    return -1;
  }
...
8010716e:	e8 9d c4 ff ff       	call   80103610 <iunlockput>
  end_op();
80107173:	e8 18 d8 ff ff       	call   80104990 <end_op>
  return 0;
...
8010717f:	90                   	nop
    end_op();
80107180:	e8 0b d8 ff ff       	call   80104990 <end_op>
    return -1;
...
80107195:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80107198:	e8 a3 e3 ff ff       	call   80105540 <myproc>
8010719d:	89 c6                	mov    %eax,%esi

  begin_op();
8010719f:	e8 7c d7 ff ff       	call   80104920 <begin_op>
  if (argstr(0, &path) < 0 || (ip = namei(path)) == 0)
801071a4:	83 ec 08             	sub    $0x8,%esp
801071a7:	8d 45 f4             	lea    -0xc(%ebp),%eax
801071aa:	50                   	push   %eax
801071ab:	6a 00                	push   $0x0
801071ad:	e8 de f5 ff ff       	call   80106790 <argstr>
801071b2:	83 c4 10             	add    $0x10,%esp
801071b5:	85 c0                	test   %eax,%eax
801071b7:	78 77                	js     80107230 <sys_chdir+0xa0>
801071b9:	83 ec 0c             	sub    $0xc,%esp
801071bc:	ff 75 f4             	pushl  -0xc(%ebp)
801071bf:	e8 9c ca ff ff       	call   80103c60 <namei>
801071c4:	83 c4 10             	add    $0x10,%esp
801071c7:	89 c3                	mov    %eax,%ebx
801071c9:	85 c0                	test   %eax,%eax
801071cb:	74 63                	je     80107230 <sys_chdir+0xa0>
  {
    end_op();
    return -1;
  }
...
801071d1:	e8 aa c1 ff ff       	call   80103380 <ilock>
  if (ip->type != T_DIR)
801071d6:	83 c4 10             	add    $0x10,%esp
801071d9:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801071de:	75 30                	jne    80107210 <sys_chdir+0x80>
  {
    iunlockput(ip);
    end_op();
    return -1;
...
801071e4:	e8 77 c2 ff ff       	call   80103460 <iunlock>
  iput(curproc->cwd);
801071e9:	58                   	pop    %eax
801071ea:	ff 76 68             	pushl  0x68(%esi)
801071ed:	e8 be c2 ff ff       	call   801034b0 <iput>
  end_op();
801071f2:	e8 99 d7 ff ff       	call   80104990 <end_op>
  curproc->cwd = ip;
801071f7:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
801071fa:	83 c4 10             	add    $0x10,%esp
801071fd:	31 c0                	xor    %eax,%eax
}
801071ff:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107202:	5b                   	pop    %ebx
80107203:	5e                   	pop    %esi
80107204:	5d                   	pop    %ebp
80107205:	c3                   	ret    
...
80107214:	e8 f7 c3 ff ff       	call   80103610 <iunlockput>
    end_op();
80107219:	e8 72 d7 ff ff       	call   80104990 <end_op>
    return -1;
8010721e:	83 c4 10             	add    $0x10,%esp
    return -1;
80107221:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107226:	eb d7                	jmp    801071ff <sys_chdir+0x6f>
80107228:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010722f:	90                   	nop
    end_op();
80107230:	e8 5b d7 ff ff       	call   80104990 <end_op>
    return -1;
80107235:	eb ea                	jmp    80107221 <sys_chdir+0x91>
...
80107245:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
8010724b:	53                   	push   %ebx
8010724c:	81 ec a4 00 00 00    	sub    $0xa4,%esp
  if (argstr(0, &path) < 0 || argint(1, (int *)&uargv) < 0)
80107252:	50                   	push   %eax
80107253:	6a 00                	push   $0x0
80107255:	e8 36 f5 ff ff       	call   80106790 <argstr>
8010725a:	83 c4 10             	add    $0x10,%esp
8010725d:	85 c0                	test   %eax,%eax
8010725f:	0f 88 87 00 00 00    	js     801072ec <sys_exec+0xac>
80107265:	83 ec 08             	sub    $0x8,%esp
80107268:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
8010726e:	50                   	push   %eax
8010726f:	6a 01                	push   $0x1
80107271:	e8 5a f4 ff ff       	call   801066d0 <argint>
80107276:	83 c4 10             	add    $0x10,%esp
80107279:	85 c0                	test   %eax,%eax
8010727b:	78 6f                	js     801072ec <sys_exec+0xac>
  {
    return -1;
  }
  memset(argv, 0, sizeof(argv));
8010727d:	83 ec 04             	sub    $0x4,%esp
80107280:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
  for (i = 0;; i++)
80107286:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
80107288:	68 80 00 00 00       	push   $0x80
8010728d:	6a 00                	push   $0x0
8010728f:	56                   	push   %esi
80107290:	e8 8b f1 ff ff       	call   80106420 <memset>
...
801072a3:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
801072a9:	8d 3c 9d 00 00 00 00 	lea    0x0(,%ebx,4),%edi
801072b0:	50                   	push   %eax
801072b1:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801072b7:	01 f8                	add    %edi,%eax
801072b9:	50                   	push   %eax
801072ba:	e8 81 f3 ff ff       	call   80106640 <fetchint>
801072bf:	83 c4 10             	add    $0x10,%esp
801072c2:	85 c0                	test   %eax,%eax
801072c4:	78 26                	js     801072ec <sys_exec+0xac>
      return -1;
    if (uarg == 0)
801072c6:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801072cc:	85 c0                	test   %eax,%eax
801072ce:	74 30                	je     80107300 <sys_exec+0xc0>
    {
      argv[i] = 0;
      break;
    }
...
801072d3:	8d 14 3e             	lea    (%esi,%edi,1),%edx
801072d6:	52                   	push   %edx
801072d7:	50                   	push   %eax
801072d8:	e8 a3 f3 ff ff       	call   80106680 <fetchstr>
801072dd:	83 c4 10             	add    $0x10,%esp
801072e0:	85 c0                	test   %eax,%eax
801072e2:	78 08                	js     801072ec <sys_exec+0xac>
  for (i = 0;; i++)
801072e4:	83 c3 01             	add    $0x1,%ebx
    if (i >= NELEM(argv))
801072e7:	83 fb 20             	cmp    $0x20,%ebx
801072ea:	75 b4                	jne    801072a0 <sys_exec+0x60>
      return -1;
  }
...
801072f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      argv[i] = 0;
80107300:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80107307:	00 00 00 00 
  return exec(path, argv);
8010730b:	83 ec 08             	sub    $0x8,%esp
8010730e:	56                   	push   %esi
8010730f:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
80107315:	e8 76 b3 ff ff       	call   80102690 <exec>
...
80107335:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
80107338:	53                   	push   %ebx
80107339:	83 ec 20             	sub    $0x20,%esp
  if (argptr(0, (void *)&fd, 2 * sizeof(fd[0])) < 0)
8010733c:	6a 08                	push   $0x8
8010733e:	50                   	push   %eax
8010733f:	6a 00                	push   $0x0
80107341:	e8 da f3 ff ff       	call   80106720 <argptr>
80107346:	83 c4 10             	add    $0x10,%esp
80107349:	85 c0                	test   %eax,%eax
8010734b:	0f 88 8b 00 00 00    	js     801073dc <sys_pipe+0xac>
    return -1;
  if (pipealloc(&rf, &wf) < 0)
80107351:	83 ec 08             	sub    $0x8,%esp
80107354:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80107357:	50                   	push   %eax
80107358:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010735b:	50                   	push   %eax
8010735c:	e8 8f dc ff ff       	call   80104ff0 <pipealloc>
80107361:	83 c4 10             	add    $0x10,%esp
80107364:	85 c0                	test   %eax,%eax
80107366:	78 74                	js     801073dc <sys_pipe+0xac>
    return -1;
  fd0 = -1;
  if ((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0)
80107368:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for (fd = 0; fd < NOFILE; fd++)
8010736b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010736d:	e8 ce e1 ff ff       	call   80105540 <myproc>
    if (curproc->ofile[fd] == 0)
80107372:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80107376:	85 f6                	test   %esi,%esi
80107378:	74 16                	je     80107390 <sys_pipe+0x60>
8010737a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for (fd = 0; fd < NOFILE; fd++)
80107380:	83 c3 01             	add    $0x1,%ebx
80107383:	83 fb 10             	cmp    $0x10,%ebx
80107386:	74 3d                	je     801073c5 <sys_pipe+0x95>
    if (curproc->ofile[fd] == 0)
80107388:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
8010738c:	85 f6                	test   %esi,%esi
8010738e:	75 f0                	jne    80107380 <sys_pipe+0x50>
      curproc->ofile[fd] = f;
80107390:	8d 73 08             	lea    0x8(%ebx),%esi
80107393:	89 7c b0 08          	mov    %edi,0x8(%eax,%esi,4)
  if ((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0)
80107397:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010739a:	e8 a1 e1 ff ff       	call   80105540 <myproc>
  for (fd = 0; fd < NOFILE; fd++)
8010739f:	31 d2                	xor    %edx,%edx
801073a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if (curproc->ofile[fd] == 0)
801073a8:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
801073ac:	85 c9                	test   %ecx,%ecx
801073ae:	74 38                	je     801073e8 <sys_pipe+0xb8>
  for (fd = 0; fd < NOFILE; fd++)
801073b0:	83 c2 01             	add    $0x1,%edx
801073b3:	83 fa 10             	cmp    $0x10,%edx
801073b6:	75 f0                	jne    801073a8 <sys_pipe+0x78>
  {
    if (fd0 >= 0)
      myproc()->ofile[fd0] = 0;
801073b8:	e8 83 e1 ff ff       	call   80105540 <myproc>
801073bd:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
801073c4:	00 
    fileclose(rf);
801073c5:	83 ec 0c             	sub    $0xc,%esp
801073c8:	ff 75 e0             	pushl  -0x20(%ebp)
801073cb:	e8 20 b7 ff ff       	call   80102af0 <fileclose>
    fileclose(wf);
801073d0:	58                   	pop    %eax
801073d1:	ff 75 e4             	pushl  -0x1c(%ebp)
801073d4:	e8 17 b7 ff ff       	call   80102af0 <fileclose>
    return -1;
801073d9:	83 c4 10             	add    $0x10,%esp
    return -1;
801073dc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801073e1:	eb 16                	jmp    801073f9 <sys_pipe+0xc9>
801073e3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801073e7:	90                   	nop
      curproc->ofile[fd] = f;
801073e8:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
  }
  fd[0] = fd0;
801073ec:	8b 45 dc             	mov    -0x24(%ebp),%eax
801073ef:	89 18                	mov    %ebx,(%eax)
  fd[1] = fd1;
801073f1:	8b 45 dc             	mov    -0x24(%ebp),%eax
801073f4:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
801073f7:	31 c0                	xor    %eax,%eax
}
...
80107410:	55                   	push   %ebp
    char *src_name;
    char suffix[] = "_copy";
80107411:	b8 79 00 00 00       	mov    $0x79,%eax
{
80107416:	89 e5                	mov    %esp,%ebp
80107418:	57                   	push   %edi
80107419:	56                   	push   %esi
8010741a:	53                   	push   %ebx
8010741b:	81 ec b4 02 00 00    	sub    $0x2b4,%esp
    char suffix[] = "_copy";
80107421:	66 89 85 66 fd ff ff 	mov    %ax,-0x29a(%ebp)
...
80107428:	8d 85 5c fd ff ff    	lea    -0x2a4(%ebp),%eax
    char suffix[] = "_copy";
8010742e:	c7 85 62 fd ff ff 5f 	movl   $0x706f635f,-0x29e(%ebp)
80107435:	63 6f 70 
    if (argstr(0, &src_name) < 0)
80107438:	50                   	push   %eax
80107439:	6a 00                	push   $0x0
8010743b:	e8 50 f3 ff ff       	call   80106790 <argstr>
80107440:	83 c4 10             	add    $0x10,%esp
80107443:	85 c0                	test   %eax,%eax
80107445:	0f 88 4a 01 00 00    	js     80107595 <sys_make_duplicate+0x185>
        return -1;

    int i = 0, j = 0;
    while (src_name[i] != '\0')
8010744b:	8b 8d 5c fd ff ff    	mov    -0x2a4(%ebp),%ecx
    int i = 0, j = 0;
80107451:	31 c0                	xor    %eax,%eax
80107453:	8d 9d 68 fd ff ff    	lea    -0x298(%ebp),%ebx
    while (src_name[i] != '\0')
80107459:	0f b6 11             	movzbl (%ecx),%edx
8010745c:	84 d2                	test   %dl,%dl
8010745e:	74 0e                	je     8010746e <sys_make_duplicate+0x5e>
    {    
     
        new_name[i] = src_name[i];
80107460:	88 14 03             	mov    %dl,(%ebx,%eax,1)
        i++;
80107463:	83 c0 01             	add    $0x1,%eax
    while (src_name[i] != '\0')
80107466:	0f b6 14 01          	movzbl (%ecx,%eax,1),%edx
8010746a:	84 d2                	test   %dl,%dl
8010746c:	75 f2                	jne    80107460 <sys_make_duplicate+0x50>
    }
    while (suffix[j] != '\0')
8010746e:	8d 8d 62 fd ff ff    	lea    -0x29e(%ebp),%ecx
80107474:	ba 5f 00 00 00       	mov    $0x5f,%edx
80107479:	29 c1                	sub    %eax,%ecx
...
8010747f:	90                   	nop
    
    {
        ...
        new_name[i] = suffix[j];
80107480:	88 14 03             	mov    %dl,(%ebx,%eax,1)
        i++;
80107483:	83 c0 01             	add    $0x1,%eax
    while (suffix[j] != '\0')
80107486:	0f b6 14 01          	movzbl (%ecx,%eax,1),%edx
8010748a:	84 d2                	test   %dl,%dl
8010748c:	75 f2                	jne    80107480 <sys_make_duplicate+0x70>
        j++;
    }
    new_name[i] = '\0';
8010748e:	c6 84 05 68 fd ff ff 	movb   $0x0,-0x298(%ebp,%eax,1)
80107495:	00 

    begin_op();
80107496:	e8 85 d4 ff ff       	call   80104920 <begin_op>

    ip_src = namei(src_name);
8010749b:	83 ec 0c             	sub    $0xc,%esp
8010749e:	ff b5 5c fd ff ff    	pushl  -0x2a4(%ebp)
801074a4:	e8 b7 c7 ff ff       	call   80103c60 <namei>
...
801074b0:	0f 84 da 00 00 00    	je     80107590 <sys_make_duplicate+0x180>
    {
        end_op();
        return -1; 
    }
...
801074ba:	e8 c1 be ff ff       	call   80103380 <ilock>


    ip_dest = create(new_name, T_FILE, 0, 0);
801074bf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801074c6:	31 c9                	xor    %ecx,%ecx
801074c8:	89 d8                	mov    %ebx,%eax
801074ca:	ba 02 00 00 00       	mov    $0x2,%edx
801074cf:	e8 ac f3 ff ff       	call   80106880 <create>
   
    if (!ip_dest)
801074d4:	83 c4 10             	add    $0x10,%esp
    ip_dest = create(new_name, T_FILE, 0, 0);
801074d7:	89 85 50 fd ff ff    	mov    %eax,-0x2b0(%ebp)
    if (!ip_dest)
801074dd:	85 c0                	test   %eax,%eax
801074df:	0f 84 bd 00 00 00    	je     801075a2 <sys_make_duplicate+0x192>
        return 1; 
    }
    ...
    j = 0;
    while (j < ip_src->size)
801074e5:	8b 46 58             	mov    0x58(%esi),%eax
    j = 0;
801074e8:	31 db                	xor    %ebx,%ebx
    while (j < ip_src->size)
801074ea:	31 c9                	xor    %ecx,%ecx
801074ec:	8d bd e8 fd ff ff    	lea    -0x218(%ebp),%edi
801074f2:	85 c0                	test   %eax,%eax
801074f4:	75 32                	jne    80107528 <sys_make_duplicate+0x118>
801074f6:	eb 53                	jmp    8010754b <sys_make_duplicate+0x13b>
...
80107501:	89 85 54 fd ff ff    	mov    %eax,-0x2ac(%ebp)
80107507:	51                   	push   %ecx
80107508:	57                   	push   %edi
80107509:	ff b5 50 fd ff ff    	pushl  -0x2b0(%ebp)
8010750f:	e8 7c c2 ff ff       	call   80103790 <writei>
        j+= n;
80107514:	8b 95 54 fd ff ff    	mov    -0x2ac(%ebp),%edx
    while (j < ip_src->size)
8010751a:	8b 46 58             	mov    0x58(%esi),%eax
8010751d:	83 c4 10             	add    $0x10,%esp
        j+= n;
80107520:	01 d3                	add    %edx,%ebx
    while (j < ip_src->size)
80107522:	89 d9                	mov    %ebx,%ecx
80107524:	39 c3                	cmp    %eax,%ebx
80107526:	73 23                	jae    8010754b <sys_make_duplicate+0x13b>
        n = readi(ip_src, buf,j, sizeof(buf));
80107528:	68 00 02 00 00       	push   $0x200
8010752d:	51                   	push   %ecx
8010752e:	89 8d 54 fd ff ff    	mov    %ecx,-0x2ac(%ebp)
80107534:	57                   	push   %edi
80107535:	56                   	push   %esi
80107536:	e8 55 c1 ff ff       	call   80103690 <readi>
        if (n <= 0){
8010753b:	83 c4 10             	add    $0x10,%esp
8010753e:	8b 8d 54 fd ff ff    	mov    -0x2ac(%ebp),%ecx
80107544:	85 c0                	test   %eax,%eax
80107546:	7f b8                	jg     80107500 <sys_make_duplicate+0xf0>
    }
    ip_dest->size = ip_src->size;
80107548:	8b 46 58             	mov    0x58(%esi),%eax
8010754b:	8b bd 50 fd ff ff    	mov    -0x2b0(%ebp),%edi
    iupdate(ip_dest);
80107551:	83 ec 0c             	sub    $0xc,%esp
    ip_dest->size = ip_src->size;
80107554:	89 47 58             	mov    %eax,0x58(%edi)
    iupdate(ip_dest);
80107557:	57                   	push   %edi
80107558:	e8 73 bd ff ff       	call   801032d0 <iupdate>
    iunlock(ip_src);
8010755d:	89 34 24             	mov    %esi,(%esp)
80107560:	e8 fb be ff ff       	call   80103460 <iunlock>
    iunlock(ip_dest);
80107565:	89 3c 24             	mov    %edi,(%esp)
80107568:	e8 f3 be ff ff       	call   80103460 <iunlock>
    iput(ip_src);
8010756d:	89 34 24             	mov    %esi,(%esp)
80107570:	e8 3b bf ff ff       	call   801034b0 <iput>
    iput(ip_dest);
80107575:	89 3c 24             	mov    %edi,(%esp)
80107578:	e8 33 bf ff ff       	call   801034b0 <iput>

    end_op();
8010757d:	e8 0e d4 ff ff       	call   80104990 <end_op>

    return 0; 
80107582:	83 c4 10             	add    $0x10,%esp
80107585:	31 c0                	xor    %eax,%eax
}
...
8010758f:	90                   	nop
        end_op();
80107590:	e8 fb d3 ff ff       	call   80104990 <end_op>
}
...
801075a5:	56                   	push   %esi
801075a6:	e8 b5 be ff ff       	call   80103460 <iunlock>
        iput(ip_src);
801075ab:	89 34 24             	mov    %esi,(%esp)
801075ae:	e8 fd be ff ff       	call   801034b0 <iput>
        end_op();
801075b3:	e8 d8 d3 ff ff       	call   80104990 <end_op>
        return 1; 
801075b8:	83 c4 10             	add    $0x10,%esp
801075bb:	b8 01 00 00 00       	mov    $0x1,%eax
801075c0:	eb c5                	jmp    80107587 <sys_make_duplicate+0x177>
801075c2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801075c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801075d0 <find_substr>:
...
801075d4:	8b 45 14             	mov    0x14(%ebp),%eax
{
801075d7:	8b 7d 0c             	mov    0xc(%ebp),%edi
801075da:	56                   	push   %esi
801075db:	53                   	push   %ebx
801075dc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  if(substr_len <= 0 || str_len < substr_len) 
801075df:	85 c0                	test   %eax,%eax
801075e1:	7e 3a                	jle    8010761d <find_substr+0x4d>
801075e3:	39 7d 14             	cmp    %edi,0x14(%ebp)
801075e6:	7f 35                	jg     8010761d <find_substr+0x4d>
801075e8:	8b 55 08             	mov    0x8(%ebp),%edx
    return -1;

  for(int i = 0; i + substr_len <= str_len; i++){
801075eb:	31 f6                	xor    %esi,%esi
801075ed:	8d 76 00             	lea    0x0(%esi),%esi
    int j = 0;
801075f0:	31 c0                	xor    %eax,%eax
801075f2:	eb 0c                	jmp    80107600 <find_substr+0x30>
801075f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    while(j < substr_len && str[i + j] == substr[j]) 
      j++;
801075f8:	83 c0 01             	add    $0x1,%eax
    while(j < substr_len && str[i + j] == substr[j]) 
801075fb:	39 45 14             	cmp    %eax,0x14(%ebp)
801075fe:	7e 09                	jle    80107609 <find_substr+0x39>
80107600:	0f b6 0c 03          	movzbl (%ebx,%eax,1),%ecx
80107604:	38 0c 02             	cmp    %cl,(%edx,%eax,1)
80107607:	74 ef                	je     801075f8 <find_substr+0x28>
    if(j == substr_len) 
80107609:	3b 45 14             	cmp    0x14(%ebp),%eax
8010760c:	74 19                	je     80107627 <find_substr+0x57>
  for(int i = 0; i + substr_len <= str_len; i++){
8010760e:	8b 45 14             	mov    0x14(%ebp),%eax
80107611:	83 c6 01             	add    $0x1,%esi
80107614:	83 c2 01             	add    $0x1,%edx
80107617:	01 f0                	add    %esi,%eax
80107619:	39 c7                	cmp    %eax,%edi
8010761b:	7d d3                	jge    801075f0 <find_substr+0x20>
      return 1;
  }
...
80107627:	5b                   	pop    %ebx
      return 1;
80107628:	b8 01 00 00 00       	mov    $0x1,%eax
}
8010762d:	5e                   	pop    %esi
8010762e:	5f                   	pop    %edi
8010762f:	5d                   	pop    %ebp
...
80107645:	8d 45 d8             	lea    -0x28(%ebp),%eax
{
80107648:	53                   	push   %ebx
80107649:	83 ec 64             	sub    $0x64,%esp
  char *keyword = 0;
8010764c:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%ebp)
  char *filename = 0;  
80107653:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  char *user_buffer = 0;             
8010765a:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  int buffer_size = 0;
80107661:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  if(argstr(0, &keyword)  < 0) 
80107668:	50                   	push   %eax
80107669:	6a 00                	push   $0x0
8010766b:	e8 20 f1 ff ff       	call   80106790 <argstr>
80107670:	83 c4 10             	add    $0x10,%esp
80107673:	85 c0                	test   %eax,%eax
80107675:	0f 88 51 02 00 00    	js     801078cc <sys_grep_syscall+0x28c>
    return -1;

  if(argstr(1, &filename) < 0) 
8010767b:	83 ec 08             	sub    $0x8,%esp
8010767e:	8d 45 dc             	lea    -0x24(%ebp),%eax
80107681:	50                   	push   %eax
80107682:	6a 01                	push   $0x1
80107684:	e8 07 f1 ff ff       	call   80106790 <argstr>
80107689:	83 c4 10             	add    $0x10,%esp
8010768c:	85 c0                	test   %eax,%eax
8010768e:	0f 88 38 02 00 00    	js     801078cc <sys_grep_syscall+0x28c>
    return -1;

  if(argptr(2, &user_buffer, 0) < 0) 
80107694:	83 ec 04             	sub    $0x4,%esp
80107697:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010769a:	6a 00                	push   $0x0
8010769c:	50                   	push   %eax
8010769d:	6a 02                	push   $0x2
8010769f:	e8 7c f0 ff ff       	call   80106720 <argptr>
801076a4:	83 c4 10             	add    $0x10,%esp
801076a7:	85 c0                	test   %eax,%eax
801076a9:	0f 88 1d 02 00 00    	js     801078cc <sys_grep_syscall+0x28c>
    return -1;  

  if(argint(3, &buffer_size) < 0) 
801076af:	83 ec 08             	sub    $0x8,%esp
801076b2:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801076b5:	50                   	push   %eax
801076b6:	6a 03                	push   $0x3
801076b8:	e8 13 f0 ff ff       	call   801066d0 <argint>
801076bd:	83 c4 10             	add    $0x10,%esp
801076c0:	85 c0                	test   %eax,%eax
801076c2:	0f 88 04 02 00 00    	js     801078cc <sys_grep_syscall+0x28c>
    return -1;

  int klen = 0;
  while(keyword[klen] != 0){
801076c8:	8b 45 d8             	mov    -0x28(%ebp),%eax
801076cb:	80 38 00             	cmpb   $0x0,(%eax)
801076ce:	0f 84 f8 01 00 00    	je     801078cc <sys_grep_syscall+0x28c>
  int klen = 0;
801076d4:	31 d2                	xor    %edx,%edx
    klen++;
801076d6:	89 d7                	mov    %edx,%edi
801076d8:	83 c2 01             	add    $0x1,%edx
  while(keyword[klen] != 0){
801076db:	80 3c 10 00          	cmpb   $0x0,(%eax,%edx,1)
801076df:	75 f5                	jne    801076d6 <sys_grep_syscall+0x96>
    return -1;
  ...
  begin_op();
801076e1:	89 55 c0             	mov    %edx,-0x40(%ebp)
801076e4:	e8 37 d2 ff ff       	call   80104920 <begin_op>
  ip = namei(filename);
801076e9:	83 ec 0c             	sub    $0xc,%esp
801076ec:	ff 75 dc             	pushl  -0x24(%ebp)
801076ef:	e8 6c c5 ff ff       	call   80103c60 <namei>
  if(ip == 0){
801076f4:	83 c4 10             	add    $0x10,%esp
  ip = namei(filename);
801076f7:	89 45 b0             	mov    %eax,-0x50(%ebp)
  if(ip == 0){
801076fa:	85 c0                	test   %eax,%eax
801076fc:	0f 84 d4 01 00 00    	je     801078d6 <sys_grep_syscall+0x296>
    end_op();
    return -1;
  }
...
80107705:	ff 75 b0             	pushl  -0x50(%ebp)
80107708:	e8 73 bc ff ff       	call   80103380 <ilock>

  int chunk = BSIZE;                
  char *kernel_buf  = (char*)kalloc();     
8010770d:	e8 2e cb ff ff       	call   80104240 <kalloc>
80107712:	89 c3                	mov    %eax,%ebx
  char *kernel_line = (char*)kalloc();    
80107714:	e8 27 cb ff ff       	call   80104240 <kalloc>
  if(kernel_buf == 0 || kernel_line == 0){
80107719:	83 c4 10             	add    $0x10,%esp
  char *kernel_line = (char*)kalloc();    
8010771c:	89 45 bc             	mov    %eax,-0x44(%ebp)
  if(kernel_buf == 0 || kernel_line == 0){
8010771f:	85 db                	test   %ebx,%ebx
80107721:	0f 84 7f 01 00 00    	je     801078a6 <sys_grep_syscall+0x266>
80107727:	85 c0                	test   %eax,%eax
80107729:	0f 84 67 01 00 00    	je     80107896 <sys_grep_syscall+0x256>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  int line_len = 0;   
8010772f:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
  int curr_pos = 0;        
80107736:	31 f6                	xor    %esi,%esi
  int read_len;

  while((read_len = readi(ip, kernel_buf, curr_pos, chunk)) > 0){
80107738:	68 00 02 00 00       	push   $0x200
8010773d:	56                   	push   %esi
8010773e:	53                   	push   %ebx
8010773f:	ff 75 b0             	pushl  -0x50(%ebp)
80107742:	e8 49 bf ff ff       	call   80103690 <readi>
80107747:	83 c4 10             	add    $0x10,%esp
8010774a:	89 c1                	mov    %eax,%ecx
8010774c:	85 c0                	test   %eax,%eax
8010774e:	0f 8e fb 00 00 00    	jle    8010784f <sys_grep_syscall+0x20f>
80107754:	89 75 a8             	mov    %esi,-0x58(%ebp)
80107757:	89 da                	mov    %ebx,%edx
80107759:	8d 04 19             	lea    (%ecx,%ebx,1),%eax
8010775c:	89 5d ac             	mov    %ebx,-0x54(%ebp)
8010775f:	89 4d a4             	mov    %ecx,-0x5c(%ebp)
80107762:	eb 1a                	jmp    8010777e <sys_grep_syscall+0x13e>
...
80107768:	8b 75 c4             	mov    -0x3c(%ebp),%esi
8010776b:	8b 5d bc             	mov    -0x44(%ebp),%ebx
    while(i < read_len){
8010776e:	83 c2 01             	add    $0x1,%edx
        kernel_line[line_len++] = c;
80107771:	88 0c 33             	mov    %cl,(%ebx,%esi,1)
80107774:	83 c6 01             	add    $0x1,%esi
80107777:	89 75 c4             	mov    %esi,-0x3c(%ebp)
    while(i < read_len){
8010777a:	39 c2                	cmp    %eax,%edx
8010777c:	74 65                	je     801077e3 <sys_grep_syscall+0x1a3>
      char c = kernel_buf[i++];
8010777e:	0f b6 0a             	movzbl (%edx),%ecx
      if(c != '\n'){
80107781:	80 f9 0a             	cmp    $0xa,%cl
80107784:	75 e2                	jne    80107768 <sys_grep_syscall+0x128>
        continue;
      }

      if(find_substr(kernel_line, line_len, keyword, klen) == 1){
80107786:	8b 5d d8             	mov    -0x28(%ebp),%ebx
  if(substr_len <= 0 || str_len < substr_len) 
80107789:	8b 4d c4             	mov    -0x3c(%ebp),%ecx
8010778c:	39 4d c0             	cmp    %ecx,-0x40(%ebp)
8010778f:	7f 44                	jg     801077d5 <sys_grep_syscall+0x195>
80107791:	89 55 b8             	mov    %edx,-0x48(%ebp)
80107794:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  for(int i = 0; i + substr_len <= str_len; i++){
80107797:	31 f6                	xor    %esi,%esi
80107799:	89 45 b4             	mov    %eax,-0x4c(%ebp)
8010779c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    int j = 0;
801077a0:	31 c0                	xor    %eax,%eax
801077a2:	eb 0d                	jmp    801077b1 <sys_grep_syscall+0x171>
801077a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      j++;
801077a8:	8d 50 01             	lea    0x1(%eax),%edx
    while(j < substr_len && str[i + j] == substr[j]) 
801077ab:	39 f8                	cmp    %edi,%eax
801077ad:	89 d0                	mov    %edx,%eax
801077af:	74 09                	je     801077ba <sys_grep_syscall+0x17a>
801077b1:	0f b6 14 03          	movzbl (%ebx,%eax,1),%edx
801077b5:	38 14 01             	cmp    %dl,(%ecx,%eax,1)
801077b8:	74 ee                	je     801077a8 <sys_grep_syscall+0x168>
    if(j == substr_len) 
801077ba:	8b 55 c0             	mov    -0x40(%ebp),%edx
801077bd:	39 d0                	cmp    %edx,%eax
801077bf:	74 32                	je     801077f3 <sys_grep_syscall+0x1b3>
  for(int i = 0; i + substr_len <= str_len; i++){
801077c1:	83 c6 01             	add    $0x1,%esi
801077c4:	83 c1 01             	add    $0x1,%ecx
801077c7:	8d 04 16             	lea    (%esi,%edx,1),%eax
801077ca:	39 45 c4             	cmp    %eax,-0x3c(%ebp)
801077cd:	7d d1                	jge    801077a0 <sys_grep_syscall+0x160>
      ...
      line_len = 0;
801077cf:	8b 55 b8             	mov    -0x48(%ebp),%edx
801077d2:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    while(i < read_len){
801077d5:	83 c2 01             	add    $0x1,%edx
      line_len = 0;
801077d8:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    while(i < read_len){
801077df:	39 c2                	cmp    %eax,%edx
801077e1:	75 9b                	jne    8010777e <sys_grep_syscall+0x13e>
    }
    curr_pos += read_len;
801077e3:	8b 75 a8             	mov    -0x58(%ebp),%esi
801077e6:	8b 4d a4             	mov    -0x5c(%ebp),%ecx
801077e9:	8b 5d ac             	mov    -0x54(%ebp),%ebx
801077ec:	01 ce                	add    %ecx,%esi
801077ee:	e9 45 ff ff ff       	jmp    80107738 <sys_grep_syscall+0xf8>
        if(copy_len > buffer_size) 
801077f3:	8b 5d ac             	mov    -0x54(%ebp),%ebx
801077f6:	8b 75 e4             	mov    -0x1c(%ebp),%esi
801077f9:	8b 45 c4             	mov    -0x3c(%ebp),%eax
        if(copyout(myproc()->pgdir, (uint)user_buffer, kernel_line, copy_len) < 0){
801077fc:	8b 7d e0             	mov    -0x20(%ebp),%edi
        if(copy_len > buffer_size) 
801077ff:	39 f0                	cmp    %esi,%eax
80107801:	0f 4e f0             	cmovle %eax,%esi
        if(copyout(myproc()->pgdir, (uint)user_buffer, kernel_line, copy_len) < 0){
80107804:	e8 37 dd ff ff       	call   80105540 <myproc>
80107809:	56                   	push   %esi
8010780a:	ff 75 bc             	pushl  -0x44(%ebp)
8010780d:	57                   	push   %edi
8010780e:	ff 70 04             	pushl  0x4(%eax)
80107811:	e8 4a 1b 00 00       	call   80109360 <copyout>
80107816:	83 c4 10             	add    $0x10,%esp
80107819:	85 c0                	test   %eax,%eax
8010781b:	78 50                	js     8010786d <sys_grep_syscall+0x22d>
      ...
      if (copyout(myproc()->pgdir, (uint)user_buffer, kernel_line, copy_len) < 0) {
        ...
        if (copy_len < buffer_size) {
8010781d:	39 75 e4             	cmp    %esi,-0x1c(%ebp)
80107820:	7f 52                	jg     80107874 <sys_grep_syscall+0x234>
  }
...
80107826:	e8 55 c8 ff ff       	call   80104080 <kfree>
    kfree(kernel_line);
8010782b:	58                   	pop    %eax
8010782c:	ff 75 bc             	pushl  -0x44(%ebp)
8010782f:	e8 4c c8 ff ff       	call   80104080 <kfree>
    iunlockput(ip);
80107834:	5a                   	pop    %edx
80107835:	ff 75 b0             	pushl  -0x50(%ebp)
80107838:	e8 d3 bd ff ff       	call   80103610 <iunlockput>
    end_op();
8010783d:	e8 4e d1 ff ff       	call   80104990 <end_op>
    return return_value;
80107842:	83 c4 10             	add    $0x10,%esp
80107845:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107848:	89 f0                	mov    %esi,%eax
8010784a:	5b                   	pop    %ebx
8010784b:	5e                   	pop    %esi
8010784c:	5f                   	pop    %edi
8010784d:	5d                   	pop    %ebp
8010784e:	c3                   	ret    
  if (line_len > 0) {
8010784f:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80107852:	85 c0                	test   %eax,%eax
80107854:	7e 17                	jle    8010786d <sys_grep_syscall+0x22d>
    if (find_substr(kernel_line, line_len, keyword, klen) == 1) {
80107856:	ff 75 c0             	pushl  -0x40(%ebp)
80107859:	ff 75 d8             	pushl  -0x28(%ebp)
8010785c:	50                   	push   %eax
8010785d:	ff 75 bc             	pushl  -0x44(%ebp)
80107860:	e8 6b fd ff ff       	call   801075d0 <find_substr>
80107865:	83 c4 10             	add    $0x10,%esp
80107868:	83 f8 01             	cmp    $0x1,%eax
8010786b:	74 89                	je     801077f6 <sys_grep_syscall+0x1b6>
          return_value = -1;
8010786d:	be ff ff ff ff       	mov    $0xffffffff,%esi
80107872:	eb ae                	jmp    80107822 <sys_grep_syscall+0x1e2>
          copyout(myproc()->pgdir, (uint)user_buffer + copy_len, &nul, 1);
80107874:	8b 7d e0             	mov    -0x20(%ebp),%edi
          char nul = 0;
80107877:	c6 45 d7 00          	movb   $0x0,-0x29(%ebp)
          copyout(myproc()->pgdir, (uint)user_buffer + copy_len, &nul, 1);
8010787b:	e8 c0 dc ff ff       	call   80105540 <myproc>
80107880:	8d 55 d7             	lea    -0x29(%ebp),%edx
80107883:	6a 01                	push   $0x1
80107885:	01 f7                	add    %esi,%edi
80107887:	52                   	push   %edx
80107888:	57                   	push   %edi
80107889:	ff 70 04             	pushl  0x4(%eax)
8010788c:	e8 cf 1a 00 00       	call   80109360 <copyout>
80107891:	83 c4 10             	add    $0x10,%esp
80107894:	eb 8c                	jmp    80107822 <sys_grep_syscall+0x1e2>
    if(kernel_buf)  
80107896:	85 db                	test   %ebx,%ebx
80107898:	74 0c                	je     801078a6 <sys_grep_syscall+0x266>
      kfree(kernel_buf);
8010789a:	83 ec 0c             	sub    $0xc,%esp
8010789d:	53                   	push   %ebx
8010789e:	e8 dd c7 ff ff       	call   80104080 <kfree>
801078a3:	83 c4 10             	add    $0x10,%esp
    if(kernel_line) 
801078a6:	8b 45 bc             	mov    -0x44(%ebp),%eax
801078a9:	85 c0                	test   %eax,%eax
801078ab:	74 0c                	je     801078b9 <sys_grep_syscall+0x279>
      kfree(kernel_line);
801078ad:	83 ec 0c             	sub    $0xc,%esp
801078b0:	50                   	push   %eax
801078b1:	e8 ca c7 ff ff       	call   80104080 <kfree>
801078b6:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801078b9:	83 ec 0c             	sub    $0xc,%esp
801078bc:	ff 75 b0             	pushl  -0x50(%ebp)
801078bf:	e8 4c bd ff ff       	call   80103610 <iunlockput>
    end_op();
801078c4:	e8 c7 d0 ff ff       	call   80104990 <end_op>
    return -1;
801078c9:	83 c4 10             	add    $0x10,%esp
    return -1;
801078cc:	be ff ff ff ff       	mov    $0xffffffff,%esi
801078d1:	e9 6f ff ff ff       	jmp    80107845 <sys_grep_syscall+0x205>
    end_op();
801078d6:	e8 b5 d0 ff ff       	call   80104990 <end_op>
    return -1;
801078db:	eb ef                	jmp    801078cc <sys_grep_syscall+0x28c>
...
{
  return fork();
801078e0:	e9 fb dd ff ff       	jmp    801056e0 <fork>
801078e5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801078f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801078f6:	e8 55 e0 ff ff       	call   80105950 <exit>
...
{
  return wait();
80107900:	e9 7b e1 ff ff       	jmp    80105a80 <wait>
...
8010791c:	e8 af ed ff ff       	call   801066d0 <argint>
80107921:	83 c4 10             	add    $0x10,%esp
80107924:	85 c0                	test   %eax,%eax
80107926:	78 18                	js     80107940 <sys_kill+0x30>
    return -1;
  return kill(pid);
80107928:	83 ec 0c             	sub    $0xc,%esp
8010792b:	ff 75 f4             	pushl  -0xc(%ebp)
8010792e:	e8 ed e3 ff ff       	call   80105d20 <kill>
80107933:	83 c4 10             	add    $0x10,%esp
}
80107936:	c9                   	leave  
80107937:	c3                   	ret    
80107938:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010793f:	90                   	nop
80107940:	c9                   	leave  
    return -1;
...
80107953:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80107956:	e8 e5 db ff ff       	call   80105540 <myproc>
8010795b:	8b 40 10             	mov    0x10(%eax),%eax
}
8010795e:	c9                   	leave  
8010795f:	c3                   	ret    
...
8010796d:	e8 5e ed ff ff       	call   801066d0 <argint>
80107972:	83 c4 10             	add    $0x10,%esp
80107975:	85 c0                	test   %eax,%eax
80107977:	78 27                	js     801079a0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80107979:	e8 c2 db ff ff       	call   80105540 <myproc>
  if(growproc(n) < 0)
8010797e:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80107981:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80107983:	ff 75 f4             	pushl  -0xc(%ebp)
80107986:	e8 d5 dc ff ff       	call   80105660 <growproc>
8010798b:	83 c4 10             	add    $0x10,%esp
8010798e:	85 c0                	test   %eax,%eax
80107990:	78 0e                	js     801079a0 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80107992:	89 d8                	mov    %ebx,%eax
80107994:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107997:	c9                   	leave  
80107998:	c3                   	ret    
80107999:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return -1;
801079a0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801079a5:	eb eb                	jmp    80107992 <sys_sbrk+0x32>
...
801079b3:	53                   	push   %ebx
  ...
  if(argint(0, &n) < 0)
801079b4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
801079b7:	83 ec 1c             	sub    $0x1c,%esp
  if(argint(0, &n) < 0)
801079ba:	50                   	push   %eax
801079bb:	6a 00                	push   $0x0
801079bd:	e8 0e ed ff ff       	call   801066d0 <argint>
801079c2:	83 c4 10             	add    $0x10,%esp
801079c5:	85 c0                	test   %eax,%eax
801079c7:	78 64                	js     80107a2d <sys_sleep+0x7d>
    return -1;
  acquire(&tickslock);
801079c9:	83 ec 0c             	sub    $0xc,%esp
801079cc:	68 20 65 11 80       	push   $0x80116520
801079d1:	e8 4a e9 ff ff       	call   80106320 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801079d6:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801079d9:	8b 1d 00 65 11 80    	mov    0x80116500,%ebx
  while(ticks - ticks0 < n){
801079df:	83 c4 10             	add    $0x10,%esp
801079e2:	85 d2                	test   %edx,%edx
801079e4:	75 2b                	jne    80107a11 <sys_sleep+0x61>
801079e6:	eb 58                	jmp    80107a40 <sys_sleep+0x90>
801079e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801079ef:	90                   	nop
    if(myproc()->killed){
      release(&tickslock);
      return -1;
...
801079f3:	68 20 65 11 80       	push   $0x80116520
801079f8:	68 00 65 11 80       	push   $0x80116500
801079fd:	e8 fe e1 ff ff       	call   80105c00 <sleep>
  while(ticks - ticks0 < n){
80107a02:	a1 00 65 11 80       	mov    0x80116500,%eax
80107a07:	83 c4 10             	add    $0x10,%esp
80107a0a:	29 d8                	sub    %ebx,%eax
80107a0c:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80107a0f:	73 2f                	jae    80107a40 <sys_sleep+0x90>
    if(myproc()->killed){
80107a11:	e8 2a db ff ff       	call   80105540 <myproc>
80107a16:	8b 40 24             	mov    0x24(%eax),%eax
80107a19:	85 c0                	test   %eax,%eax
80107a1b:	74 d3                	je     801079f0 <sys_sleep+0x40>
      release(&tickslock);
80107a1d:	83 ec 0c             	sub    $0xc,%esp
80107a20:	68 20 65 11 80       	push   $0x80116520
80107a25:	e8 96 e8 ff ff       	call   801062c0 <release>
      return -1;
...
80107a2d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    return -1;
...
80107a43:	68 20 65 11 80       	push   $0x80116520
80107a48:	e8 73 e8 ff ff       	call   801062c0 <release>
}
80107a4d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  return 0;
...
80107a64:	83 ec 10             	sub    $0x10,%esp
  uint xticks;

  acquire(&tickslock);
80107a67:	68 20 65 11 80       	push   $0x80116520
80107a6c:	e8 af e8 ff ff       	call   80106320 <acquire>
  xticks = ticks;
80107a71:	8b 1d 00 65 11 80    	mov    0x80116500,%ebx
  release(&tickslock);
80107a77:	c7 04 24 20 65 11 80 	movl   $0x80116520,(%esp)
80107a7e:	e8 3d e8 ff ff       	call   801062c0 <release>
  return xticks;
}
80107a83:	89 d8                	mov    %ebx,%eax
80107a85:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107a88:	c9                   	leave  
80107a89:	c3                   	ret    
80107a8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80107a90 <sys_simple_arithmetic_syscall>:
...
80107a93:	53                   	push   %ebx
80107a94:	83 ec 04             	sub    $0x4,%esp
  int a, b, result;
  struct proc *curproc = myproc();
80107a97:	e8 a4 da ff ff       	call   80105540 <myproc>

  a = curproc->tf->ebx;
80107a9c:	8b 50 18             	mov    0x18(%eax),%edx
80107a9f:	8b 42 10             	mov    0x10(%edx),%eax
  b = curproc->tf->ecx;
80107aa2:	8b 52 18             	mov    0x18(%edx),%edx

  result = (a - b) * (a + b);
80107aa5:	89 c3                	mov    %eax,%ebx
80107aa7:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
80107aaa:	29 d3                	sub    %edx,%ebx
80107aac:	0f af d9             	imul   %ecx,%ebx

  cprintf("\nsimple_arithmetic_syscall: a = %d, b = %d, result = %d\n", a, b, result);
80107aaf:	53                   	push   %ebx
80107ab0:	52                   	push   %edx
80107ab1:	50                   	push   %eax
80107ab2:	68 6c 9d 10 80       	push   $0x80109d6c
80107ab7:	e8 14 8d ff ff       	call   801007d0 <cprintf>

  return result;
}
80107abc:	89 d8                	mov    %ebx,%eax
80107abe:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107ac1:	c9                   	leave  
80107ac2:	c3                   	ret    
80107ac3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107aca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80107ad0 <sys_show_process_family>:

int sys_show_process_family(void)
{
80107ad0:	55                   	push   %ebp
80107ad1:	89 e5                	mov    %esp,%ebp
80107ad3:	83 ec 20             	sub    $0x20,%esp
...
80107adc:	e8 ef eb ff ff       	call   801066d0 <argint>
80107ae1:	83 c4 10             	add    $0x10,%esp
80107ae4:	85 c0                	test   %eax,%eax
80107ae6:	78 18                	js     80107b00 <sys_show_process_family+0x30>
...
80107aeb:	ff 75 f4             	pushl  -0xc(%ebp)
80107aee:	e8 6d e3 ff ff       	call   80105e60 <show_process_family>
...
80107b00:	c9                   	leave  
  return -2;
80107b01:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80107b06:	c3                   	ret    
...
80107b08:	06                   	push   %es
  pushl %fs
80107b09:	0f a0                	push   %fs
  pushl %gs
80107b0b:	0f a8                	push   %gs
  pushal
80107b0d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80107b0e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80107b12:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80107b14:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80107b16:	54                   	push   %esp
  call trap
80107b17:	e8 c4 00 00 00       	call   80107be0 <trap>
  addl $4, %esp
80107b1c:	83 c4 04             	add    $0x4,%esp
...
80107b1f:	61                   	popa   
  popl %gs
80107b20:	0f a9                	pop    %gs
  popl %fs
80107b22:	0f a1                	pop    %fs
  popl %es
80107b24:	07                   	pop    %es
  popl %ds
80107b25:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80107b26:	83 c4 08             	add    $0x8,%esp
  iret
80107b29:	cf                   	iret   
80107b2a:	66 90                	xchg   %ax,%ax
80107b2c:	66 90                	xchg   %ax,%ax
...
80107b40:	8b 14 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%edx
80107b47:	c7 04 c5 62 65 11 80 	movl   $0x8e000008,-0x7fee9a9e(,%eax,8)
80107b4e:	08 00 00 8e 
80107b52:	66 89 14 c5 60 65 11 	mov    %dx,-0x7fee9aa0(,%eax,8)
80107b59:	80 
80107b5a:	c1 ea 10             	shr    $0x10,%edx
80107b5d:	66 89 14 c5 66 65 11 	mov    %dx,-0x7fee9a9a(,%eax,8)
80107b64:	80 
  for(i = 0; i < 256; i++)
80107b65:	83 c0 01             	add    $0x1,%eax
80107b68:	3d 00 01 00 00       	cmp    $0x100,%eax
80107b6d:	75 d1                	jne    80107b40 <tvinit+0x10>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);

  initlock(&tickslock, "time");
80107b6f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80107b72:	a1 08 c1 10 80       	mov    0x8010c108,%eax
80107b77:	c7 05 62 67 11 80 08 	movl   $0xef000008,0x80116762
80107b7e:	00 00 ef 
  initlock(&tickslock, "time");
80107b81:	68 a5 9d 10 80       	push   $0x80109da5
80107b86:	68 20 65 11 80       	push   $0x80116520
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80107b8b:	66 a3 60 67 11 80    	mov    %ax,0x80116760
80107b91:	c1 e8 10             	shr    $0x10,%eax
80107b94:	66 a3 66 67 11 80    	mov    %ax,0x80116766
  initlock(&tickslock, "time");
80107b9a:	e8 91 e5 ff ff       	call   80106130 <initlock>
}
80107b9f:	83 c4 10             	add    $0x10,%esp
80107ba2:	c9                   	leave  
80107ba3:	c3                   	ret    
80107ba4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80107bb0:	55                   	push   %ebp
  pd[0] = size-1;
80107bb1:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80107bb6:	89 e5                	mov    %esp,%ebp
80107bb8:	83 ec 10             	sub    $0x10,%esp
80107bbb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107bbf:	b8 60 65 11 80       	mov    $0x80116560,%eax
80107bc4:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107bc8:	c1 e8 10             	shr    $0x10,%eax
80107bcb:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80107bcf:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107bd2:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80107bd5:	c9                   	leave  
80107bd6:	c3                   	ret    
...
80107bec:	8b 43 30             	mov    0x30(%ebx),%eax
80107bef:	83 f8 40             	cmp    $0x40,%eax
80107bf2:	0f 84 58 01 00 00    	je     80107d50 <trap+0x170>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80107bf8:	83 e8 20             	sub    $0x20,%eax
80107bfb:	83 f8 1f             	cmp    $0x1f,%eax
80107bfe:	0f 87 7c 00 00 00    	ja     80107c80 <trap+0xa0>
80107c04:	ff 24 85 4c 9e 10 80 	jmp    *-0x7fef61b4(,%eax,4)
...
80107c0f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80107c10:	e8 fb c1 ff ff       	call   80103e10 <ideintr>
    lapiceoi();
80107c15:	e8 b6 c8 ff ff       	call   801044d0 <lapiceoi>
  }
...
80107c1a:	e8 21 d9 ff ff       	call   80105540 <myproc>
80107c1f:	85 c0                	test   %eax,%eax
80107c21:	74 1a                	je     80107c3d <trap+0x5d>
80107c23:	e8 18 d9 ff ff       	call   80105540 <myproc>
80107c28:	8b 50 24             	mov    0x24(%eax),%edx
80107c2b:	85 d2                	test   %edx,%edx
80107c2d:	74 0e                	je     80107c3d <trap+0x5d>
80107c2f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80107c33:	f7 d0                	not    %eax
80107c35:	a8 03                	test   $0x3,%al
80107c37:	0f 84 db 01 00 00    	je     80107e18 <trap+0x238>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80107c3d:	e8 fe d8 ff ff       	call   80105540 <myproc>
80107c42:	85 c0                	test   %eax,%eax
80107c44:	74 0f                	je     80107c55 <trap+0x75>
80107c46:	e8 f5 d8 ff ff       	call   80105540 <myproc>
80107c4b:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80107c4f:	0f 84 ab 00 00 00    	je     80107d00 <trap+0x120>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80107c55:	e8 e6 d8 ff ff       	call   80105540 <myproc>
80107c5a:	85 c0                	test   %eax,%eax
80107c5c:	74 1a                	je     80107c78 <trap+0x98>
80107c5e:	e8 dd d8 ff ff       	call   80105540 <myproc>
80107c63:	8b 40 24             	mov    0x24(%eax),%eax
80107c66:	85 c0                	test   %eax,%eax
80107c68:	74 0e                	je     80107c78 <trap+0x98>
80107c6a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80107c6e:	f7 d0                	not    %eax
80107c70:	a8 03                	test   $0x3,%al
80107c72:	0f 84 05 01 00 00    	je     80107d7d <trap+0x19d>
    exit();
}
...
80107c80:	e8 bb d8 ff ff       	call   80105540 <myproc>
80107c85:	8b 7b 38             	mov    0x38(%ebx),%edi
80107c88:	85 c0                	test   %eax,%eax
80107c8a:	0f 84 a2 01 00 00    	je     80107e32 <trap+0x252>
80107c90:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80107c94:	0f 84 98 01 00 00    	je     80107e32 <trap+0x252>
...
80107c9a:	0f 20 d1             	mov    %cr2,%ecx
80107c9d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107ca0:	e8 7b d8 ff ff       	call   80105520 <cpuid>
80107ca5:	8b 73 30             	mov    0x30(%ebx),%esi
80107ca8:	89 45 dc             	mov    %eax,-0x24(%ebp)
80107cab:	8b 43 34             	mov    0x34(%ebx),%eax
80107cae:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80107cb1:	e8 8a d8 ff ff       	call   80105540 <myproc>
80107cb6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107cb9:	e8 82 d8 ff ff       	call   80105540 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107cbe:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80107cc1:	51                   	push   %ecx
80107cc2:	57                   	push   %edi
80107cc3:	8b 55 dc             	mov    -0x24(%ebp),%edx
80107cc6:	52                   	push   %edx
80107cc7:	ff 75 e4             	pushl  -0x1c(%ebp)
80107cca:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80107ccb:	8b 75 e0             	mov    -0x20(%ebp),%esi
80107cce:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107cd1:	56                   	push   %esi
80107cd2:	ff 70 10             	pushl  0x10(%eax)
80107cd5:	68 08 9e 10 80       	push   $0x80109e08
80107cda:	e8 f1 8a ff ff       	call   801007d0 <cprintf>
    myproc()->killed = 1;
80107cdf:	83 c4 20             	add    $0x20,%esp
80107ce2:	e8 59 d8 ff ff       	call   80105540 <myproc>
80107ce7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80107cee:	e8 4d d8 ff ff       	call   80105540 <myproc>
80107cf3:	85 c0                	test   %eax,%eax
80107cf5:	0f 85 28 ff ff ff    	jne    80107c23 <trap+0x43>
80107cfb:	e9 3d ff ff ff       	jmp    80107c3d <trap+0x5d>
  if(myproc() && myproc()->state == RUNNING &&
80107d00:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80107d04:	0f 85 4b ff ff ff    	jne    80107c55 <trap+0x75>
    yield();
80107d0a:	e8 a1 de ff ff       	call   80105bb0 <yield>
80107d0f:	e9 41 ff ff ff       	jmp    80107c55 <trap+0x75>
80107d14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107d18:	8b 7b 38             	mov    0x38(%ebx),%edi
80107d1b:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80107d1f:	e8 fc d7 ff ff       	call   80105520 <cpuid>
80107d24:	57                   	push   %edi
80107d25:	56                   	push   %esi
80107d26:	50                   	push   %eax
80107d27:	68 b0 9d 10 80       	push   $0x80109db0
80107d2c:	e8 9f 8a ff ff       	call   801007d0 <cprintf>
    lapiceoi();
80107d31:	e8 9a c7 ff ff       	call   801044d0 <lapiceoi>
    break;
80107d36:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80107d39:	e8 02 d8 ff ff       	call   80105540 <myproc>
80107d3e:	85 c0                	test   %eax,%eax
80107d40:	0f 85 dd fe ff ff    	jne    80107c23 <trap+0x43>
80107d46:	e9 f2 fe ff ff       	jmp    80107c3d <trap+0x5d>
80107d4b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107d4f:	90                   	nop
    if(myproc()->killed)
80107d50:	e8 eb d7 ff ff       	call   80105540 <myproc>
80107d55:	8b 70 24             	mov    0x24(%eax),%esi
80107d58:	85 f6                	test   %esi,%esi
80107d5a:	0f 85 c8 00 00 00    	jne    80107e28 <trap+0x248>
    myproc()->tf = tf;
80107d60:	e8 db d7 ff ff       	call   80105540 <myproc>
80107d65:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80107d68:	e8 a3 ea ff ff       	call   80106810 <syscall>
    if(myproc()->killed)
80107d6d:	e8 ce d7 ff ff       	call   80105540 <myproc>
80107d72:	8b 48 24             	mov    0x24(%eax),%ecx
80107d75:	85 c9                	test   %ecx,%ecx
80107d77:	0f 84 fb fe ff ff    	je     80107c78 <trap+0x98>
}
...
80107d83:	5d                   	pop    %ebp
      exit();
80107d84:	e9 c7 db ff ff       	jmp    80105950 <exit>
80107d89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80107d90:	e8 4b 02 00 00       	call   80107fe0 <uartintr>
    lapiceoi();
80107d95:	e8 36 c7 ff ff       	call   801044d0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80107d9a:	e8 a1 d7 ff ff       	call   80105540 <myproc>
80107d9f:	85 c0                	test   %eax,%eax
80107da1:	0f 85 7c fe ff ff    	jne    80107c23 <trap+0x43>
80107da7:	e9 91 fe ff ff       	jmp    80107c3d <trap+0x5d>
80107dac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80107db0:	e8 eb c5 ff ff       	call   801043a0 <kbdintr>
    lapiceoi();
80107db5:	e8 16 c7 ff ff       	call   801044d0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80107dba:	e8 81 d7 ff ff       	call   80105540 <myproc>
80107dbf:	85 c0                	test   %eax,%eax
80107dc1:	0f 85 5c fe ff ff    	jne    80107c23 <trap+0x43>
80107dc7:	e9 71 fe ff ff       	jmp    80107c3d <trap+0x5d>
80107dcc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80107dd0:	e8 4b d7 ff ff       	call   80105520 <cpuid>
80107dd5:	85 c0                	test   %eax,%eax
80107dd7:	0f 85 38 fe ff ff    	jne    80107c15 <trap+0x35>
      acquire(&tickslock);
80107ddd:	83 ec 0c             	sub    $0xc,%esp
80107de0:	68 20 65 11 80       	push   $0x80116520
80107de5:	e8 36 e5 ff ff       	call   80106320 <acquire>
      ticks++;
80107dea:	83 05 00 65 11 80 01 	addl   $0x1,0x80116500
      wakeup(&ticks);
80107df1:	c7 04 24 00 65 11 80 	movl   $0x80116500,(%esp)
80107df8:	e8 c3 de ff ff       	call   80105cc0 <wakeup>
      release(&tickslock);
80107dfd:	c7 04 24 20 65 11 80 	movl   $0x80116520,(%esp)
80107e04:	e8 b7 e4 ff ff       	call   801062c0 <release>
80107e09:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80107e0c:	e9 04 fe ff ff       	jmp    80107c15 <trap+0x35>
80107e11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80107e18:	e8 33 db ff ff       	call   80105950 <exit>
80107e1d:	e9 1b fe ff ff       	jmp    80107c3d <trap+0x5d>
80107e22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80107e28:	e8 23 db ff ff       	call   80105950 <exit>
80107e2d:	e9 2e ff ff ff       	jmp    80107d60 <trap+0x180>
80107e32:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107e35:	e8 e6 d6 ff ff       	call   80105520 <cpuid>
80107e3a:	83 ec 0c             	sub    $0xc,%esp
80107e3d:	56                   	push   %esi
80107e3e:	57                   	push   %edi
80107e3f:	50                   	push   %eax
80107e40:	ff 73 30             	pushl  0x30(%ebx)
80107e43:	68 d4 9d 10 80       	push   $0x80109dd4
80107e48:	e8 83 89 ff ff       	call   801007d0 <cprintf>
      panic("trap");
80107e4d:	83 c4 14             	add    $0x14,%esp
80107e50:	68 aa 9d 10 80       	push   $0x80109daa
80107e55:	e8 26 85 ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80107e60:	a1 60 6d 11 80       	mov    0x80116d60,%eax
80107e65:	85 c0                	test   %eax,%eax
80107e67:	74 17                	je     80107e80 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107e69:	ba fd 03 00 00       	mov    $0x3fd,%edx
80107e6e:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80107e6f:	a8 01                	test   $0x1,%al
80107e71:	74 0d                	je     80107e80 <uartgetc+0x20>
80107e73:	ba f8 03 00 00       	mov    $0x3f8,%edx
80107e78:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80107e79:	0f b6 c0             	movzbl %al,%eax
80107e7c:	c3                   	ret    
...
80107e93:	89 c8                	mov    %ecx,%eax
80107e95:	89 e5                	mov    %esp,%ebp
80107e97:	57                   	push   %edi
80107e98:	bf fa 03 00 00       	mov    $0x3fa,%edi
80107e9d:	56                   	push   %esi
80107e9e:	89 fa                	mov    %edi,%edx
80107ea0:	53                   	push   %ebx
80107ea1:	83 ec 1c             	sub    $0x1c,%esp
80107ea4:	ee                   	out    %al,(%dx)
80107ea5:	be fb 03 00 00       	mov    $0x3fb,%esi
80107eaa:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80107eaf:	89 f2                	mov    %esi,%edx
80107eb1:	ee                   	out    %al,(%dx)
80107eb2:	b8 0c 00 00 00       	mov    $0xc,%eax
80107eb7:	ba f8 03 00 00       	mov    $0x3f8,%edx
80107ebc:	ee                   	out    %al,(%dx)
80107ebd:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80107ec2:	89 c8                	mov    %ecx,%eax
80107ec4:	89 da                	mov    %ebx,%edx
80107ec6:	ee                   	out    %al,(%dx)
80107ec7:	b8 03 00 00 00       	mov    $0x3,%eax
80107ecc:	89 f2                	mov    %esi,%edx
80107ece:	ee                   	out    %al,(%dx)
80107ecf:	ba fc 03 00 00       	mov    $0x3fc,%edx
80107ed4:	89 c8                	mov    %ecx,%eax
80107ed6:	ee                   	out    %al,(%dx)
80107ed7:	b8 01 00 00 00       	mov    $0x1,%eax
80107edc:	89 da                	mov    %ebx,%edx
80107ede:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107edf:	ba fd 03 00 00       	mov    $0x3fd,%edx
80107ee4:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80107ee5:	3c ff                	cmp    $0xff,%al
80107ee7:	0f 84 7c 00 00 00    	je     80107f69 <uartinit+0xd9>
  uart = 1;
80107eed:	c7 05 60 6d 11 80 01 	movl   $0x1,0x80116d60
80107ef4:	00 00 00 
80107ef7:	89 fa                	mov    %edi,%edx
80107ef9:	ec                   	in     (%dx),%al
80107efa:	ba f8 03 00 00       	mov    $0x3f8,%edx
80107eff:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80107f00:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80107f03:	bf cc 9e 10 80       	mov    $0x80109ecc,%edi
80107f08:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80107f0d:	6a 00                	push   $0x0
80107f0f:	6a 04                	push   $0x4
80107f11:	e8 2a c1 ff ff       	call   80104040 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80107f16:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80107f1a:	83 c4 10             	add    $0x10,%esp
80107f1d:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
80107f20:	a1 60 6d 11 80       	mov    0x80116d60,%eax
80107f25:	85 c0                	test   %eax,%eax
80107f27:	74 32                	je     80107f5b <uartinit+0xcb>
80107f29:	89 f2                	mov    %esi,%edx
80107f2b:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107f2c:	a8 20                	test   $0x20,%al
80107f2e:	75 21                	jne    80107f51 <uartinit+0xc1>
80107f30:	bb 80 00 00 00       	mov    $0x80,%ebx
80107f35:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
80107f38:	83 ec 0c             	sub    $0xc,%esp
80107f3b:	6a 0a                	push   $0xa
80107f3d:	e8 ae c5 ff ff       	call   801044f0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107f42:	83 c4 10             	add    $0x10,%esp
80107f45:	83 eb 01             	sub    $0x1,%ebx
80107f48:	74 07                	je     80107f51 <uartinit+0xc1>
80107f4a:	89 f2                	mov    %esi,%edx
80107f4c:	ec                   	in     (%dx),%al
80107f4d:	a8 20                	test   $0x20,%al
80107f4f:	74 e7                	je     80107f38 <uartinit+0xa8>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107f51:	ba f8 03 00 00       	mov    $0x3f8,%edx
80107f56:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80107f5a:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80107f5b:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80107f5f:	83 c7 01             	add    $0x1,%edi
80107f62:	88 45 e7             	mov    %al,-0x19(%ebp)
80107f65:	84 c0                	test   %al,%al
80107f67:	75 b7                	jne    80107f20 <uartinit+0x90>
}
...
80107f78:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107f7f:	90                   	nop

80107f80 <uartputc>:
  if(!uart)
80107f80:	a1 60 6d 11 80       	mov    0x80116d60,%eax
80107f85:	85 c0                	test   %eax,%eax
80107f87:	74 4f                	je     80107fd8 <uartputc+0x58>
{
80107f89:	55                   	push   %ebp
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107f8a:	ba fd 03 00 00       	mov    $0x3fd,%edx
80107f8f:	89 e5                	mov    %esp,%ebp
80107f91:	56                   	push   %esi
80107f92:	53                   	push   %ebx
80107f93:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107f94:	a8 20                	test   $0x20,%al
80107f96:	75 29                	jne    80107fc1 <uartputc+0x41>
80107f98:	bb 80 00 00 00       	mov    $0x80,%ebx
80107f9d:	be fd 03 00 00       	mov    $0x3fd,%esi
80107fa2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    microdelay(10);
80107fa8:	83 ec 0c             	sub    $0xc,%esp
80107fab:	6a 0a                	push   $0xa
80107fad:	e8 3e c5 ff ff       	call   801044f0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107fb2:	83 c4 10             	add    $0x10,%esp
80107fb5:	83 eb 01             	sub    $0x1,%ebx
80107fb8:	74 07                	je     80107fc1 <uartputc+0x41>
80107fba:	89 f2                	mov    %esi,%edx
80107fbc:	ec                   	in     (%dx),%al
80107fbd:	a8 20                	test   $0x20,%al
80107fbf:	74 e7                	je     80107fa8 <uartputc+0x28>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107fc1:	8b 45 08             	mov    0x8(%ebp),%eax
80107fc4:	ba f8 03 00 00       	mov    $0x3f8,%edx
80107fc9:	ee                   	out    %al,(%dx)
}
80107fca:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107fcd:	5b                   	pop    %ebx
80107fce:	5e                   	pop    %esi
80107fcf:	5d                   	pop    %ebp
80107fd0:	c3                   	ret    
...
80107fe3:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80107fe6:	68 60 7e 10 80       	push   $0x80107e60
80107feb:	e8 20 96 ff ff       	call   80101610 <consoleintr>
}
...
80107ff7:	6a 00                	push   $0x0
  jmp alltraps
80107ff9:	e9 09 fb ff ff       	jmp    80107b07 <alltraps>
...
80107ffe:	6a 00                	push   $0x0
  pushl $1
80108000:	6a 01                	push   $0x1
  jmp alltraps
80108002:	e9 00 fb ff ff       	jmp    80107b07 <alltraps>
...
80108007:	6a 00                	push   $0x0
  pushl $2
80108009:	6a 02                	push   $0x2
  jmp alltraps
8010800b:	e9 f7 fa ff ff       	jmp    80107b07 <alltraps>
...
80108010:	6a 00                	push   $0x0
  pushl $3
80108012:	6a 03                	push   $0x3
  jmp alltraps
80108014:	e9 ee fa ff ff       	jmp    80107b07 <alltraps>
...
80108019:	6a 00                	push   $0x0
  pushl $4
8010801b:	6a 04                	push   $0x4
  jmp alltraps
8010801d:	e9 e5 fa ff ff       	jmp    80107b07 <alltraps>
...
80108022:	6a 00                	push   $0x0
  pushl $5
80108024:	6a 05                	push   $0x5
  jmp alltraps
80108026:	e9 dc fa ff ff       	jmp    80107b07 <alltraps>
...
8010802b:	6a 00                	push   $0x0
  pushl $6
8010802d:	6a 06                	push   $0x6
  jmp alltraps
8010802f:	e9 d3 fa ff ff       	jmp    80107b07 <alltraps>
...
80108034:	6a 00                	push   $0x0
  pushl $7
80108036:	6a 07                	push   $0x7
  jmp alltraps
80108038:	e9 ca fa ff ff       	jmp    80107b07 <alltraps>

8010803d <vector8>:
.globl vector8
vector8:
  pushl $8
8010803d:	6a 08                	push   $0x8
  jmp alltraps
8010803f:	e9 c3 fa ff ff       	jmp    80107b07 <alltraps>
...
80108044:	6a 00                	push   $0x0
  pushl $9
80108046:	6a 09                	push   $0x9
  jmp alltraps
80108048:	e9 ba fa ff ff       	jmp    80107b07 <alltraps>

8010804d <vector10>:
.globl vector10
vector10:
  pushl $10
8010804d:	6a 0a                	push   $0xa
  jmp alltraps
8010804f:	e9 b3 fa ff ff       	jmp    80107b07 <alltraps>

80108054 <vector11>:
.globl vector11
vector11:
  pushl $11
80108054:	6a 0b                	push   $0xb
  jmp alltraps
80108056:	e9 ac fa ff ff       	jmp    80107b07 <alltraps>

8010805b <vector12>:
.globl vector12
vector12:
  pushl $12
8010805b:	6a 0c                	push   $0xc
  jmp alltraps
8010805d:	e9 a5 fa ff ff       	jmp    80107b07 <alltraps>

80108062 <vector13>:
.globl vector13
vector13:
  pushl $13
80108062:	6a 0d                	push   $0xd
  jmp alltraps
80108064:	e9 9e fa ff ff       	jmp    80107b07 <alltraps>

80108069 <vector14>:
.globl vector14
vector14:
  pushl $14
80108069:	6a 0e                	push   $0xe
  jmp alltraps
8010806b:	e9 97 fa ff ff       	jmp    80107b07 <alltraps>
...
80108070:	6a 00                	push   $0x0
  pushl $15
80108072:	6a 0f                	push   $0xf
  jmp alltraps
80108074:	e9 8e fa ff ff       	jmp    80107b07 <alltraps>
...
80108079:	6a 00                	push   $0x0
  pushl $16
8010807b:	6a 10                	push   $0x10
  jmp alltraps
8010807d:	e9 85 fa ff ff       	jmp    80107b07 <alltraps>

80108082 <vector17>:
.globl vector17
vector17:
  pushl $17
80108082:	6a 11                	push   $0x11
  jmp alltraps
80108084:	e9 7e fa ff ff       	jmp    80107b07 <alltraps>
...
80108089:	6a 00                	push   $0x0
  pushl $18
8010808b:	6a 12                	push   $0x12
  jmp alltraps
8010808d:	e9 75 fa ff ff       	jmp    80107b07 <alltraps>
...
80108092:	6a 00                	push   $0x0
  pushl $19
80108094:	6a 13                	push   $0x13
  jmp alltraps
80108096:	e9 6c fa ff ff       	jmp    80107b07 <alltraps>
...
8010809b:	6a 00                	push   $0x0
  pushl $20
8010809d:	6a 14                	push   $0x14
  jmp alltraps
8010809f:	e9 63 fa ff ff       	jmp    80107b07 <alltraps>
...
801080a4:	6a 00                	push   $0x0
  pushl $21
801080a6:	6a 15                	push   $0x15
  jmp alltraps
801080a8:	e9 5a fa ff ff       	jmp    80107b07 <alltraps>
...
801080ad:	6a 00                	push   $0x0
  pushl $22
801080af:	6a 16                	push   $0x16
  jmp alltraps
801080b1:	e9 51 fa ff ff       	jmp    80107b07 <alltraps>
...
801080b6:	6a 00                	push   $0x0
  pushl $23
801080b8:	6a 17                	push   $0x17
  jmp alltraps
801080ba:	e9 48 fa ff ff       	jmp    80107b07 <alltraps>
...
801080bf:	6a 00                	push   $0x0
  pushl $24
801080c1:	6a 18                	push   $0x18
  jmp alltraps
801080c3:	e9 3f fa ff ff       	jmp    80107b07 <alltraps>
...
801080c8:	6a 00                	push   $0x0
  pushl $25
801080ca:	6a 19                	push   $0x19
  jmp alltraps
801080cc:	e9 36 fa ff ff       	jmp    80107b07 <alltraps>
...
801080d1:	6a 00                	push   $0x0
  pushl $26
801080d3:	6a 1a                	push   $0x1a
  jmp alltraps
801080d5:	e9 2d fa ff ff       	jmp    80107b07 <alltraps>
...
801080da:	6a 00                	push   $0x0
  pushl $27
801080dc:	6a 1b                	push   $0x1b
  jmp alltraps
801080de:	e9 24 fa ff ff       	jmp    80107b07 <alltraps>
...
801080e3:	6a 00                	push   $0x0
  pushl $28
801080e5:	6a 1c                	push   $0x1c
  jmp alltraps
801080e7:	e9 1b fa ff ff       	jmp    80107b07 <alltraps>
...
801080ec:	6a 00                	push   $0x0
  pushl $29
801080ee:	6a 1d                	push   $0x1d
  jmp alltraps
801080f0:	e9 12 fa ff ff       	jmp    80107b07 <alltraps>
...
801080f5:	6a 00                	push   $0x0
  pushl $30
801080f7:	6a 1e                	push   $0x1e
  jmp alltraps
801080f9:	e9 09 fa ff ff       	jmp    80107b07 <alltraps>
...
801080fe:	6a 00                	push   $0x0
  pushl $31
80108100:	6a 1f                	push   $0x1f
  jmp alltraps
80108102:	e9 00 fa ff ff       	jmp    80107b07 <alltraps>
...
80108107:	6a 00                	push   $0x0
  pushl $32
80108109:	6a 20                	push   $0x20
  jmp alltraps
8010810b:	e9 f7 f9 ff ff       	jmp    80107b07 <alltraps>
...
80108110:	6a 00                	push   $0x0
  pushl $33
80108112:	6a 21                	push   $0x21
  jmp alltraps
80108114:	e9 ee f9 ff ff       	jmp    80107b07 <alltraps>
...
80108119:	6a 00                	push   $0x0
  pushl $34
8010811b:	6a 22                	push   $0x22
  jmp alltraps
8010811d:	e9 e5 f9 ff ff       	jmp    80107b07 <alltraps>
...
80108122:	6a 00                	push   $0x0
  pushl $35
80108124:	6a 23                	push   $0x23
  jmp alltraps
80108126:	e9 dc f9 ff ff       	jmp    80107b07 <alltraps>
...
8010812b:	6a 00                	push   $0x0
  pushl $36
8010812d:	6a 24                	push   $0x24
  jmp alltraps
8010812f:	e9 d3 f9 ff ff       	jmp    80107b07 <alltraps>
...
80108134:	6a 00                	push   $0x0
  pushl $37
80108136:	6a 25                	push   $0x25
  jmp alltraps
80108138:	e9 ca f9 ff ff       	jmp    80107b07 <alltraps>
...
8010813d:	6a 00                	push   $0x0
  pushl $38
8010813f:	6a 26                	push   $0x26
  jmp alltraps
80108141:	e9 c1 f9 ff ff       	jmp    80107b07 <alltraps>
...
80108146:	6a 00                	push   $0x0
  pushl $39
80108148:	6a 27                	push   $0x27
  jmp alltraps
8010814a:	e9 b8 f9 ff ff       	jmp    80107b07 <alltraps>
...
8010814f:	6a 00                	push   $0x0
  pushl $40
80108151:	6a 28                	push   $0x28
  jmp alltraps
80108153:	e9 af f9 ff ff       	jmp    80107b07 <alltraps>
...
80108158:	6a 00                	push   $0x0
  pushl $41
8010815a:	6a 29                	push   $0x29
  jmp alltraps
8010815c:	e9 a6 f9 ff ff       	jmp    80107b07 <alltraps>
...
80108161:	6a 00                	push   $0x0
  pushl $42
80108163:	6a 2a                	push   $0x2a
  jmp alltraps
80108165:	e9 9d f9 ff ff       	jmp    80107b07 <alltraps>
...
8010816a:	6a 00                	push   $0x0
  pushl $43
8010816c:	6a 2b                	push   $0x2b
  jmp alltraps
8010816e:	e9 94 f9 ff ff       	jmp    80107b07 <alltraps>
...
80108173:	6a 00                	push   $0x0
  pushl $44
80108175:	6a 2c                	push   $0x2c
  jmp alltraps
80108177:	e9 8b f9 ff ff       	jmp    80107b07 <alltraps>
...
8010817c:	6a 00                	push   $0x0
  pushl $45
8010817e:	6a 2d                	push   $0x2d
  jmp alltraps
80108180:	e9 82 f9 ff ff       	jmp    80107b07 <alltraps>
...
80108185:	6a 00                	push   $0x0
  pushl $46
80108187:	6a 2e                	push   $0x2e
  jmp alltraps
80108189:	e9 79 f9 ff ff       	jmp    80107b07 <alltraps>
...
8010818e:	6a 00                	push   $0x0
  pushl $47
80108190:	6a 2f                	push   $0x2f
  jmp alltraps
80108192:	e9 70 f9 ff ff       	jmp    80107b07 <alltraps>
...
80108197:	6a 00                	push   $0x0
  pushl $48
80108199:	6a 30                	push   $0x30
  jmp alltraps
8010819b:	e9 67 f9 ff ff       	jmp    80107b07 <alltraps>
...
801081a0:	6a 00                	push   $0x0
  pushl $49
801081a2:	6a 31                	push   $0x31
  jmp alltraps
801081a4:	e9 5e f9 ff ff       	jmp    80107b07 <alltraps>
...
801081a9:	6a 00                	push   $0x0
  pushl $50
801081ab:	6a 32                	push   $0x32
  jmp alltraps
801081ad:	e9 55 f9 ff ff       	jmp    80107b07 <alltraps>
...
801081b2:	6a 00                	push   $0x0
  pushl $51
801081b4:	6a 33                	push   $0x33
  jmp alltraps
801081b6:	e9 4c f9 ff ff       	jmp    80107b07 <alltraps>
...
801081bb:	6a 00                	push   $0x0
  pushl $52
801081bd:	6a 34                	push   $0x34
  jmp alltraps
801081bf:	e9 43 f9 ff ff       	jmp    80107b07 <alltraps>
...
801081c4:	6a 00                	push   $0x0
  pushl $53
801081c6:	6a 35                	push   $0x35
  jmp alltraps
801081c8:	e9 3a f9 ff ff       	jmp    80107b07 <alltraps>
...
801081cd:	6a 00                	push   $0x0
  pushl $54
801081cf:	6a 36                	push   $0x36
  jmp alltraps
801081d1:	e9 31 f9 ff ff       	jmp    80107b07 <alltraps>
...
801081d6:	6a 00                	push   $0x0
  pushl $55
801081d8:	6a 37                	push   $0x37
  jmp alltraps
801081da:	e9 28 f9 ff ff       	jmp    80107b07 <alltraps>
...
801081e1:	6a 38                	push   $0x38
  jmp alltraps
801081e3:	e9 1f f9 ff ff       	jmp    80107b07 <alltraps>
...
801081e8:	6a 00                	push   $0x0
  pushl $57
801081ea:	6a 39                	push   $0x39
  jmp alltraps
801081ec:	e9 16 f9 ff ff       	jmp    80107b07 <alltraps>
...
801081f1:	6a 00                	push   $0x0
  pushl $58
801081f3:	6a 3a                	push   $0x3a
  jmp alltraps
801081f5:	e9 0d f9 ff ff       	jmp    80107b07 <alltraps>
...
801081fa:	6a 00                	push   $0x0
  pushl $59
801081fc:	6a 3b                	push   $0x3b
  jmp alltraps
801081fe:	e9 04 f9 ff ff       	jmp    80107b07 <alltraps>
...
80108203:	6a 00                	push   $0x0
  pushl $60
80108205:	6a 3c                	push   $0x3c
  jmp alltraps
80108207:	e9 fb f8 ff ff       	jmp    80107b07 <alltraps>
...
8010820c:	6a 00                	push   $0x0
  pushl $61
8010820e:	6a 3d                	push   $0x3d
  jmp alltraps
80108210:	e9 f2 f8 ff ff       	jmp    80107b07 <alltraps>
...
80108215:	6a 00                	push   $0x0
  pushl $62
80108217:	6a 3e                	push   $0x3e
  jmp alltraps
80108219:	e9 e9 f8 ff ff       	jmp    80107b07 <alltraps>
...
8010821e:	6a 00                	push   $0x0
  pushl $63
80108220:	6a 3f                	push   $0x3f
  jmp alltraps
80108222:	e9 e0 f8 ff ff       	jmp    80107b07 <alltraps>
...
80108227:	6a 00                	push   $0x0
  pushl $64
80108229:	6a 40                	push   $0x40
  jmp alltraps
8010822b:	e9 d7 f8 ff ff       	jmp    80107b07 <alltraps>
...
80108230:	6a 00                	push   $0x0
  pushl $65
80108232:	6a 41                	push   $0x41
  jmp alltraps
80108234:	e9 ce f8 ff ff       	jmp    80107b07 <alltraps>
...
80108239:	6a 00                	push   $0x0
  pushl $66
8010823b:	6a 42                	push   $0x42
  jmp alltraps
8010823d:	e9 c5 f8 ff ff       	jmp    80107b07 <alltraps>
...
80108242:	6a 00                	push   $0x0
  pushl $67
80108244:	6a 43                	push   $0x43
  jmp alltraps
80108246:	e9 bc f8 ff ff       	jmp    80107b07 <alltraps>
...
8010824b:	6a 00                	push   $0x0
  pushl $68
8010824d:	6a 44                	push   $0x44
  jmp alltraps
8010824f:	e9 b3 f8 ff ff       	jmp    80107b07 <alltraps>
...
80108254:	6a 00                	push   $0x0
  pushl $69
80108256:	6a 45                	push   $0x45
  jmp alltraps
80108258:	e9 aa f8 ff ff       	jmp    80107b07 <alltraps>
...
8010825d:	6a 00                	push   $0x0
  pushl $70
8010825f:	6a 46                	push   $0x46
  jmp alltraps
80108261:	e9 a1 f8 ff ff       	jmp    80107b07 <alltraps>
...
80108266:	6a 00                	push   $0x0
  pushl $71
80108268:	6a 47                	push   $0x47
  jmp alltraps
8010826a:	e9 98 f8 ff ff       	jmp    80107b07 <alltraps>
...
8010826f:	6a 00                	push   $0x0
  pushl $72
80108271:	6a 48                	push   $0x48
  jmp alltraps
80108273:	e9 8f f8 ff ff       	jmp    80107b07 <alltraps>
...
80108278:	6a 00                	push   $0x0
  pushl $73
8010827a:	6a 49                	push   $0x49
  jmp alltraps
8010827c:	e9 86 f8 ff ff       	jmp    80107b07 <alltraps>
...
80108281:	6a 00                	push   $0x0
  pushl $74
80108283:	6a 4a                	push   $0x4a
  jmp alltraps
80108285:	e9 7d f8 ff ff       	jmp    80107b07 <alltraps>
...
8010828a:	6a 00                	push   $0x0
  pushl $75
8010828c:	6a 4b                	push   $0x4b
  jmp alltraps
8010828e:	e9 74 f8 ff ff       	jmp    80107b07 <alltraps>
...
80108293:	6a 00                	push   $0x0
  pushl $76
80108295:	6a 4c                	push   $0x4c
  jmp alltraps
80108297:	e9 6b f8 ff ff       	jmp    80107b07 <alltraps>
...
8010829c:	6a 00                	push   $0x0
  pushl $77
8010829e:	6a 4d                	push   $0x4d
  jmp alltraps
801082a0:	e9 62 f8 ff ff       	jmp    80107b07 <alltraps>
...
801082a5:	6a 00                	push   $0x0
  pushl $78
801082a7:	6a 4e                	push   $0x4e
  jmp alltraps
801082a9:	e9 59 f8 ff ff       	jmp    80107b07 <alltraps>
...
801082ae:	6a 00                	push   $0x0
  pushl $79
801082b0:	6a 4f                	push   $0x4f
  jmp alltraps
801082b2:	e9 50 f8 ff ff       	jmp    80107b07 <alltraps>
...
801082b7:	6a 00                	push   $0x0
  pushl $80
801082b9:	6a 50                	push   $0x50
  jmp alltraps
801082bb:	e9 47 f8 ff ff       	jmp    80107b07 <alltraps>
...
801082c0:	6a 00                	push   $0x0
  pushl $81
801082c2:	6a 51                	push   $0x51
  jmp alltraps
801082c4:	e9 3e f8 ff ff       	jmp    80107b07 <alltraps>
...
801082c9:	6a 00                	push   $0x0
  pushl $82
801082cb:	6a 52                	push   $0x52
  jmp alltraps
801082cd:	e9 35 f8 ff ff       	jmp    80107b07 <alltraps>
...
801082d2:	6a 00                	push   $0x0
  pushl $83
801082d4:	6a 53                	push   $0x53
  jmp alltraps
801082d6:	e9 2c f8 ff ff       	jmp    80107b07 <alltraps>
...
801082db:	6a 00                	push   $0x0
  pushl $84
801082dd:	6a 54                	push   $0x54
  jmp alltraps
801082df:	e9 23 f8 ff ff       	jmp    80107b07 <alltraps>
...
801082e4:	6a 00                	push   $0x0
  pushl $85
801082e6:	6a 55                	push   $0x55
  jmp alltraps
801082e8:	e9 1a f8 ff ff       	jmp    80107b07 <alltraps>
...
801082ed:	6a 00                	push   $0x0
  pushl $86
801082ef:	6a 56                	push   $0x56
  jmp alltraps
801082f1:	e9 11 f8 ff ff       	jmp    80107b07 <alltraps>
...
801082f6:	6a 00                	push   $0x0
  pushl $87
801082f8:	6a 57                	push   $0x57
  jmp alltraps
801082fa:	e9 08 f8 ff ff       	jmp    80107b07 <alltraps>
...
801082ff:	6a 00                	push   $0x0
  pushl $88
80108301:	6a 58                	push   $0x58
  jmp alltraps
80108303:	e9 ff f7 ff ff       	jmp    80107b07 <alltraps>
...
80108308:	6a 00                	push   $0x0
  pushl $89
8010830a:	6a 59                	push   $0x59
  jmp alltraps
8010830c:	e9 f6 f7 ff ff       	jmp    80107b07 <alltraps>
...
80108311:	6a 00                	push   $0x0
  pushl $90
80108313:	6a 5a                	push   $0x5a
  jmp alltraps
80108315:	e9 ed f7 ff ff       	jmp    80107b07 <alltraps>
...
8010831a:	6a 00                	push   $0x0
  pushl $91
8010831c:	6a 5b                	push   $0x5b
  jmp alltraps
8010831e:	e9 e4 f7 ff ff       	jmp    80107b07 <alltraps>
...
80108323:	6a 00                	push   $0x0
  pushl $92
80108325:	6a 5c                	push   $0x5c
  jmp alltraps
80108327:	e9 db f7 ff ff       	jmp    80107b07 <alltraps>
...
8010832c:	6a 00                	push   $0x0
  pushl $93
8010832e:	6a 5d                	push   $0x5d
  jmp alltraps
80108330:	e9 d2 f7 ff ff       	jmp    80107b07 <alltraps>
...
80108335:	6a 00                	push   $0x0
  pushl $94
80108337:	6a 5e                	push   $0x5e
  jmp alltraps
80108339:	e9 c9 f7 ff ff       	jmp    80107b07 <alltraps>
...
8010833e:	6a 00                	push   $0x0
  pushl $95
80108340:	6a 5f                	push   $0x5f
  jmp alltraps
80108342:	e9 c0 f7 ff ff       	jmp    80107b07 <alltraps>
...
80108347:	6a 00                	push   $0x0
  pushl $96
80108349:	6a 60                	push   $0x60
  jmp alltraps
8010834b:	e9 b7 f7 ff ff       	jmp    80107b07 <alltraps>
...
80108350:	6a 00                	push   $0x0
  pushl $97
80108352:	6a 61                	push   $0x61
  jmp alltraps
80108354:	e9 ae f7 ff ff       	jmp    80107b07 <alltraps>
...
80108359:	6a 00                	push   $0x0
  pushl $98
8010835b:	6a 62                	push   $0x62
  jmp alltraps
8010835d:	e9 a5 f7 ff ff       	jmp    80107b07 <alltraps>
...
80108362:	6a 00                	push   $0x0
  pushl $99
80108364:	6a 63                	push   $0x63
  jmp alltraps
80108366:	e9 9c f7 ff ff       	jmp    80107b07 <alltraps>
...
8010836b:	6a 00                	push   $0x0
  pushl $100
8010836d:	6a 64                	push   $0x64
  jmp alltraps
8010836f:	e9 93 f7 ff ff       	jmp    80107b07 <alltraps>
...
80108374:	6a 00                	push   $0x0
  pushl $101
80108376:	6a 65                	push   $0x65
  jmp alltraps
80108378:	e9 8a f7 ff ff       	jmp    80107b07 <alltraps>
...
8010837d:	6a 00                	push   $0x0
  pushl $102
8010837f:	6a 66                	push   $0x66
  jmp alltraps
80108381:	e9 81 f7 ff ff       	jmp    80107b07 <alltraps>
...
80108386:	6a 00                	push   $0x0
  pushl $103
80108388:	6a 67                	push   $0x67
  jmp alltraps
8010838a:	e9 78 f7 ff ff       	jmp    80107b07 <alltraps>
...
8010838f:	6a 00                	push   $0x0
  pushl $104
80108391:	6a 68                	push   $0x68
  jmp alltraps
80108393:	e9 6f f7 ff ff       	jmp    80107b07 <alltraps>
...
80108398:	6a 00                	push   $0x0
  pushl $105
8010839a:	6a 69                	push   $0x69
  jmp alltraps
8010839c:	e9 66 f7 ff ff       	jmp    80107b07 <alltraps>
...
801083a1:	6a 00                	push   $0x0
  pushl $106
801083a3:	6a 6a                	push   $0x6a
  jmp alltraps
801083a5:	e9 5d f7 ff ff       	jmp    80107b07 <alltraps>
...
801083aa:	6a 00                	push   $0x0
  pushl $107
801083ac:	6a 6b                	push   $0x6b
  jmp alltraps
801083ae:	e9 54 f7 ff ff       	jmp    80107b07 <alltraps>
...
801083b3:	6a 00                	push   $0x0
  pushl $108
801083b5:	6a 6c                	push   $0x6c
  jmp alltraps
801083b7:	e9 4b f7 ff ff       	jmp    80107b07 <alltraps>
...
801083bc:	6a 00                	push   $0x0
  pushl $109
801083be:	6a 6d                	push   $0x6d
  jmp alltraps
801083c0:	e9 42 f7 ff ff       	jmp    80107b07 <alltraps>
...
801083c5:	6a 00                	push   $0x0
  pushl $110
801083c7:	6a 6e                	push   $0x6e
  jmp alltraps
801083c9:	e9 39 f7 ff ff       	jmp    80107b07 <alltraps>
...
801083ce:	6a 00                	push   $0x0
  pushl $111
801083d0:	6a 6f                	push   $0x6f
  jmp alltraps
801083d2:	e9 30 f7 ff ff       	jmp    80107b07 <alltraps>
...
801083d7:	6a 00                	push   $0x0
  pushl $112
801083d9:	6a 70                	push   $0x70
  jmp alltraps
801083db:	e9 27 f7 ff ff       	jmp    80107b07 <alltraps>
...
801083e0:	6a 00                	push   $0x0
  pushl $113
801083e2:	6a 71                	push   $0x71
  jmp alltraps
801083e4:	e9 1e f7 ff ff       	jmp    80107b07 <alltraps>
...
801083e9:	6a 00                	push   $0x0
  pushl $114
801083eb:	6a 72                	push   $0x72
  jmp alltraps
801083ed:	e9 15 f7 ff ff       	jmp    80107b07 <alltraps>
...
801083f2:	6a 00                	push   $0x0
  pushl $115
801083f4:	6a 73                	push   $0x73
  jmp alltraps
801083f6:	e9 0c f7 ff ff       	jmp    80107b07 <alltraps>
...
801083fb:	6a 00                	push   $0x0
  pushl $116
801083fd:	6a 74                	push   $0x74
  jmp alltraps
801083ff:	e9 03 f7 ff ff       	jmp    80107b07 <alltraps>
...
80108404:	6a 00                	push   $0x0
  pushl $117
80108406:	6a 75                	push   $0x75
  jmp alltraps
80108408:	e9 fa f6 ff ff       	jmp    80107b07 <alltraps>
...
8010840d:	6a 00                	push   $0x0
  pushl $118
8010840f:	6a 76                	push   $0x76
  jmp alltraps
80108411:	e9 f1 f6 ff ff       	jmp    80107b07 <alltraps>
...
80108416:	6a 00                	push   $0x0
  pushl $119
80108418:	6a 77                	push   $0x77
  jmp alltraps
8010841a:	e9 e8 f6 ff ff       	jmp    80107b07 <alltraps>
...
8010841f:	6a 00                	push   $0x0
  pushl $120
80108421:	6a 78                	push   $0x78
  jmp alltraps
80108423:	e9 df f6 ff ff       	jmp    80107b07 <alltraps>
...
80108428:	6a 00                	push   $0x0
  pushl $121
8010842a:	6a 79                	push   $0x79
  jmp alltraps
8010842c:	e9 d6 f6 ff ff       	jmp    80107b07 <alltraps>
...
80108431:	6a 00                	push   $0x0
  pushl $122
80108433:	6a 7a                	push   $0x7a
  jmp alltraps
80108435:	e9 cd f6 ff ff       	jmp    80107b07 <alltraps>
...
8010843a:	6a 00                	push   $0x0
  pushl $123
8010843c:	6a 7b                	push   $0x7b
  jmp alltraps
8010843e:	e9 c4 f6 ff ff       	jmp    80107b07 <alltraps>
...
80108443:	6a 00                	push   $0x0
  pushl $124
80108445:	6a 7c                	push   $0x7c
  jmp alltraps
80108447:	e9 bb f6 ff ff       	jmp    80107b07 <alltraps>
...
8010844c:	6a 00                	push   $0x0
  pushl $125
8010844e:	6a 7d                	push   $0x7d
  jmp alltraps
80108450:	e9 b2 f6 ff ff       	jmp    80107b07 <alltraps>
...
80108455:	6a 00                	push   $0x0
  pushl $126
80108457:	6a 7e                	push   $0x7e
  jmp alltraps
80108459:	e9 a9 f6 ff ff       	jmp    80107b07 <alltraps>
...
8010845e:	6a 00                	push   $0x0
  pushl $127
80108460:	6a 7f                	push   $0x7f
  jmp alltraps
80108462:	e9 a0 f6 ff ff       	jmp    80107b07 <alltraps>
...
80108467:	6a 00                	push   $0x0
  pushl $128
80108469:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010846e:	e9 94 f6 ff ff       	jmp    80107b07 <alltraps>
...
80108473:	6a 00                	push   $0x0
  pushl $129
80108475:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010847a:	e9 88 f6 ff ff       	jmp    80107b07 <alltraps>
...
8010847f:	6a 00                	push   $0x0
  pushl $130
80108481:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80108486:	e9 7c f6 ff ff       	jmp    80107b07 <alltraps>
...
8010848b:	6a 00                	push   $0x0
  pushl $131
8010848d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80108492:	e9 70 f6 ff ff       	jmp    80107b07 <alltraps>
...
80108497:	6a 00                	push   $0x0
  pushl $132
80108499:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010849e:	e9 64 f6 ff ff       	jmp    80107b07 <alltraps>
...
801084a3:	6a 00                	push   $0x0
  pushl $133
801084a5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801084aa:	e9 58 f6 ff ff       	jmp    80107b07 <alltraps>
...
801084af:	6a 00                	push   $0x0
  pushl $134
801084b1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801084b6:	e9 4c f6 ff ff       	jmp    80107b07 <alltraps>
...
801084bb:	6a 00                	push   $0x0
  pushl $135
801084bd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801084c2:	e9 40 f6 ff ff       	jmp    80107b07 <alltraps>
...
801084c7:	6a 00                	push   $0x0
  pushl $136
801084c9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801084ce:	e9 34 f6 ff ff       	jmp    80107b07 <alltraps>
...
801084d3:	6a 00                	push   $0x0
  pushl $137
801084d5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801084da:	e9 28 f6 ff ff       	jmp    80107b07 <alltraps>
...
801084df:	6a 00                	push   $0x0
  pushl $138
801084e1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801084e6:	e9 1c f6 ff ff       	jmp    80107b07 <alltraps>
...
801084eb:	6a 00                	push   $0x0
  pushl $139
801084ed:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801084f2:	e9 10 f6 ff ff       	jmp    80107b07 <alltraps>
...
801084f7:	6a 00                	push   $0x0
  pushl $140
801084f9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801084fe:	e9 04 f6 ff ff       	jmp    80107b07 <alltraps>
...
80108503:	6a 00                	push   $0x0
  pushl $141
80108505:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010850a:	e9 f8 f5 ff ff       	jmp    80107b07 <alltraps>
...
8010850f:	6a 00                	push   $0x0
  pushl $142
80108511:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80108516:	e9 ec f5 ff ff       	jmp    80107b07 <alltraps>
...
8010851b:	6a 00                	push   $0x0
  pushl $143
8010851d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80108522:	e9 e0 f5 ff ff       	jmp    80107b07 <alltraps>
...
80108527:	6a 00                	push   $0x0
  pushl $144
80108529:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010852e:	e9 d4 f5 ff ff       	jmp    80107b07 <alltraps>
...
80108533:	6a 00                	push   $0x0
  pushl $145
80108535:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010853a:	e9 c8 f5 ff ff       	jmp    80107b07 <alltraps>
...
8010853f:	6a 00                	push   $0x0
  pushl $146
80108541:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80108546:	e9 bc f5 ff ff       	jmp    80107b07 <alltraps>
...
8010854b:	6a 00                	push   $0x0
  pushl $147
8010854d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80108552:	e9 b0 f5 ff ff       	jmp    80107b07 <alltraps>
...
80108557:	6a 00                	push   $0x0
  pushl $148
80108559:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010855e:	e9 a4 f5 ff ff       	jmp    80107b07 <alltraps>
...
80108563:	6a 00                	push   $0x0
  pushl $149
80108565:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010856a:	e9 98 f5 ff ff       	jmp    80107b07 <alltraps>
...
8010856f:	6a 00                	push   $0x0
  pushl $150
80108571:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80108576:	e9 8c f5 ff ff       	jmp    80107b07 <alltraps>
...
8010857b:	6a 00                	push   $0x0
  pushl $151
8010857d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80108582:	e9 80 f5 ff ff       	jmp    80107b07 <alltraps>
...
80108587:	6a 00                	push   $0x0
  pushl $152
80108589:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010858e:	e9 74 f5 ff ff       	jmp    80107b07 <alltraps>
...
80108593:	6a 00                	push   $0x0
  pushl $153
80108595:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010859a:	e9 68 f5 ff ff       	jmp    80107b07 <alltraps>
...
8010859f:	6a 00                	push   $0x0
  pushl $154
801085a1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801085a6:	e9 5c f5 ff ff       	jmp    80107b07 <alltraps>
...
801085ab:	6a 00                	push   $0x0
  pushl $155
801085ad:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801085b2:	e9 50 f5 ff ff       	jmp    80107b07 <alltraps>
...
801085b7:	6a 00                	push   $0x0
  pushl $156
801085b9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801085be:	e9 44 f5 ff ff       	jmp    80107b07 <alltraps>
...
801085c3:	6a 00                	push   $0x0
  pushl $157
801085c5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801085ca:	e9 38 f5 ff ff       	jmp    80107b07 <alltraps>
...
801085cf:	6a 00                	push   $0x0
  pushl $158
801085d1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801085d6:	e9 2c f5 ff ff       	jmp    80107b07 <alltraps>
...
801085db:	6a 00                	push   $0x0
  pushl $159
801085dd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801085e2:	e9 20 f5 ff ff       	jmp    80107b07 <alltraps>
...
801085e7:	6a 00                	push   $0x0
  pushl $160
801085e9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801085ee:	e9 14 f5 ff ff       	jmp    80107b07 <alltraps>
...
801085f3:	6a 00                	push   $0x0
  pushl $161
801085f5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801085fa:	e9 08 f5 ff ff       	jmp    80107b07 <alltraps>
...
801085ff:	6a 00                	push   $0x0
  pushl $162
80108601:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80108606:	e9 fc f4 ff ff       	jmp    80107b07 <alltraps>
...
8010860b:	6a 00                	push   $0x0
  pushl $163
8010860d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80108612:	e9 f0 f4 ff ff       	jmp    80107b07 <alltraps>
...
80108617:	6a 00                	push   $0x0
  pushl $164
80108619:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010861e:	e9 e4 f4 ff ff       	jmp    80107b07 <alltraps>
...
80108623:	6a 00                	push   $0x0
  pushl $165
80108625:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010862a:	e9 d8 f4 ff ff       	jmp    80107b07 <alltraps>
...
8010862f:	6a 00                	push   $0x0
  pushl $166
80108631:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80108636:	e9 cc f4 ff ff       	jmp    80107b07 <alltraps>
...
8010863b:	6a 00                	push   $0x0
  pushl $167
8010863d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80108642:	e9 c0 f4 ff ff       	jmp    80107b07 <alltraps>
...
80108647:	6a 00                	push   $0x0
  pushl $168
80108649:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010864e:	e9 b4 f4 ff ff       	jmp    80107b07 <alltraps>
...
80108653:	6a 00                	push   $0x0
  pushl $169
80108655:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010865a:	e9 a8 f4 ff ff       	jmp    80107b07 <alltraps>
...
8010865f:	6a 00                	push   $0x0
  pushl $170
80108661:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80108666:	e9 9c f4 ff ff       	jmp    80107b07 <alltraps>
...
8010866b:	6a 00                	push   $0x0
  pushl $171
8010866d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80108672:	e9 90 f4 ff ff       	jmp    80107b07 <alltraps>
...
80108677:	6a 00                	push   $0x0
  pushl $172
80108679:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010867e:	e9 84 f4 ff ff       	jmp    80107b07 <alltraps>
...
80108683:	6a 00                	push   $0x0
  pushl $173
80108685:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010868a:	e9 78 f4 ff ff       	jmp    80107b07 <alltraps>
...
8010868f:	6a 00                	push   $0x0
  pushl $174
80108691:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80108696:	e9 6c f4 ff ff       	jmp    80107b07 <alltraps>
...
8010869b:	6a 00                	push   $0x0
  pushl $175
8010869d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801086a2:	e9 60 f4 ff ff       	jmp    80107b07 <alltraps>
...
801086a7:	6a 00                	push   $0x0
  pushl $176
801086a9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801086ae:	e9 54 f4 ff ff       	jmp    80107b07 <alltraps>
...
801086b3:	6a 00                	push   $0x0
  pushl $177
801086b5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801086ba:	e9 48 f4 ff ff       	jmp    80107b07 <alltraps>
...
801086bf:	6a 00                	push   $0x0
  pushl $178
801086c1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801086c6:	e9 3c f4 ff ff       	jmp    80107b07 <alltraps>
...
801086cb:	6a 00                	push   $0x0
  pushl $179
801086cd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801086d2:	e9 30 f4 ff ff       	jmp    80107b07 <alltraps>
...
801086d7:	6a 00                	push   $0x0
  pushl $180
801086d9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801086de:	e9 24 f4 ff ff       	jmp    80107b07 <alltraps>
...
801086e3:	6a 00                	push   $0x0
  pushl $181
801086e5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801086ea:	e9 18 f4 ff ff       	jmp    80107b07 <alltraps>
...
801086ef:	6a 00                	push   $0x0
  pushl $182
801086f1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801086f6:	e9 0c f4 ff ff       	jmp    80107b07 <alltraps>
...
801086fb:	6a 00                	push   $0x0
  pushl $183
801086fd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80108702:	e9 00 f4 ff ff       	jmp    80107b07 <alltraps>
...
80108707:	6a 00                	push   $0x0
  pushl $184
80108709:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010870e:	e9 f4 f3 ff ff       	jmp    80107b07 <alltraps>
...
80108713:	6a 00                	push   $0x0
  pushl $185
80108715:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010871a:	e9 e8 f3 ff ff       	jmp    80107b07 <alltraps>
...
8010871f:	6a 00                	push   $0x0
  pushl $186
80108721:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80108726:	e9 dc f3 ff ff       	jmp    80107b07 <alltraps>
...
8010872b:	6a 00                	push   $0x0
  pushl $187
8010872d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80108732:	e9 d0 f3 ff ff       	jmp    80107b07 <alltraps>
...
80108737:	6a 00                	push   $0x0
  pushl $188
80108739:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010873e:	e9 c4 f3 ff ff       	jmp    80107b07 <alltraps>
...
80108743:	6a 00                	push   $0x0
  pushl $189
80108745:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010874a:	e9 b8 f3 ff ff       	jmp    80107b07 <alltraps>
...
8010874f:	6a 00                	push   $0x0
  pushl $190
80108751:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80108756:	e9 ac f3 ff ff       	jmp    80107b07 <alltraps>
...
8010875b:	6a 00                	push   $0x0
  pushl $191
8010875d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80108762:	e9 a0 f3 ff ff       	jmp    80107b07 <alltraps>
...
80108767:	6a 00                	push   $0x0
  pushl $192
80108769:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010876e:	e9 94 f3 ff ff       	jmp    80107b07 <alltraps>
...
80108773:	6a 00                	push   $0x0
  pushl $193
80108775:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010877a:	e9 88 f3 ff ff       	jmp    80107b07 <alltraps>
...
8010877f:	6a 00                	push   $0x0
  pushl $194
80108781:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80108786:	e9 7c f3 ff ff       	jmp    80107b07 <alltraps>
...
8010878b:	6a 00                	push   $0x0
  pushl $195
8010878d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80108792:	e9 70 f3 ff ff       	jmp    80107b07 <alltraps>
...
80108797:	6a 00                	push   $0x0
  pushl $196
80108799:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010879e:	e9 64 f3 ff ff       	jmp    80107b07 <alltraps>
...
801087a3:	6a 00                	push   $0x0
  pushl $197
801087a5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801087aa:	e9 58 f3 ff ff       	jmp    80107b07 <alltraps>
...
801087af:	6a 00                	push   $0x0
  pushl $198
801087b1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801087b6:	e9 4c f3 ff ff       	jmp    80107b07 <alltraps>
...
801087bb:	6a 00                	push   $0x0
  pushl $199
801087bd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801087c2:	e9 40 f3 ff ff       	jmp    80107b07 <alltraps>
...
801087c7:	6a 00                	push   $0x0
  pushl $200
801087c9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801087ce:	e9 34 f3 ff ff       	jmp    80107b07 <alltraps>
...
801087d3:	6a 00                	push   $0x0
  pushl $201
801087d5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801087da:	e9 28 f3 ff ff       	jmp    80107b07 <alltraps>
...
801087df:	6a 00                	push   $0x0
  pushl $202
801087e1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801087e6:	e9 1c f3 ff ff       	jmp    80107b07 <alltraps>
...
801087eb:	6a 00                	push   $0x0
  pushl $203
801087ed:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801087f2:	e9 10 f3 ff ff       	jmp    80107b07 <alltraps>
...
801087f7:	6a 00                	push   $0x0
  pushl $204
801087f9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801087fe:	e9 04 f3 ff ff       	jmp    80107b07 <alltraps>
...
80108803:	6a 00                	push   $0x0
  pushl $205
80108805:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010880a:	e9 f8 f2 ff ff       	jmp    80107b07 <alltraps>
...
8010880f:	6a 00                	push   $0x0
  pushl $206
80108811:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80108816:	e9 ec f2 ff ff       	jmp    80107b07 <alltraps>
...
8010881b:	6a 00                	push   $0x0
  pushl $207
8010881d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80108822:	e9 e0 f2 ff ff       	jmp    80107b07 <alltraps>
...
80108827:	6a 00                	push   $0x0
  pushl $208
80108829:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010882e:	e9 d4 f2 ff ff       	jmp    80107b07 <alltraps>
...
80108833:	6a 00                	push   $0x0
  pushl $209
80108835:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010883a:	e9 c8 f2 ff ff       	jmp    80107b07 <alltraps>
...
8010883f:	6a 00                	push   $0x0
  pushl $210
80108841:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80108846:	e9 bc f2 ff ff       	jmp    80107b07 <alltraps>
...
8010884b:	6a 00                	push   $0x0
  pushl $211
8010884d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80108852:	e9 b0 f2 ff ff       	jmp    80107b07 <alltraps>
...
80108857:	6a 00                	push   $0x0
  pushl $212
80108859:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010885e:	e9 a4 f2 ff ff       	jmp    80107b07 <alltraps>
...
80108863:	6a 00                	push   $0x0
  pushl $213
80108865:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010886a:	e9 98 f2 ff ff       	jmp    80107b07 <alltraps>
...
8010886f:	6a 00                	push   $0x0
  pushl $214
80108871:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80108876:	e9 8c f2 ff ff       	jmp    80107b07 <alltraps>
...
8010887b:	6a 00                	push   $0x0
  pushl $215
8010887d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80108882:	e9 80 f2 ff ff       	jmp    80107b07 <alltraps>
...
80108887:	6a 00                	push   $0x0
  pushl $216
80108889:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010888e:	e9 74 f2 ff ff       	jmp    80107b07 <alltraps>
...
80108893:	6a 00                	push   $0x0
  pushl $217
80108895:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010889a:	e9 68 f2 ff ff       	jmp    80107b07 <alltraps>
...
8010889f:	6a 00                	push   $0x0
  pushl $218
801088a1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801088a6:	e9 5c f2 ff ff       	jmp    80107b07 <alltraps>
...
801088ab:	6a 00                	push   $0x0
  pushl $219
801088ad:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801088b2:	e9 50 f2 ff ff       	jmp    80107b07 <alltraps>
...
801088b7:	6a 00                	push   $0x0
  pushl $220
801088b9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801088be:	e9 44 f2 ff ff       	jmp    80107b07 <alltraps>
...
801088c3:	6a 00                	push   $0x0
  pushl $221
801088c5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801088ca:	e9 38 f2 ff ff       	jmp    80107b07 <alltraps>
...
801088cf:	6a 00                	push   $0x0
  pushl $222
801088d1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801088d6:	e9 2c f2 ff ff       	jmp    80107b07 <alltraps>
...
801088db:	6a 00                	push   $0x0
  pushl $223
801088dd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801088e2:	e9 20 f2 ff ff       	jmp    80107b07 <alltraps>
...
801088e7:	6a 00                	push   $0x0
  pushl $224
801088e9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801088ee:	e9 14 f2 ff ff       	jmp    80107b07 <alltraps>
...
801088f3:	6a 00                	push   $0x0
  pushl $225
801088f5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801088fa:	e9 08 f2 ff ff       	jmp    80107b07 <alltraps>
...
801088ff:	6a 00                	push   $0x0
  pushl $226
80108901:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80108906:	e9 fc f1 ff ff       	jmp    80107b07 <alltraps>
...
8010890b:	6a 00                	push   $0x0
  pushl $227
8010890d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80108912:	e9 f0 f1 ff ff       	jmp    80107b07 <alltraps>
...
80108917:	6a 00                	push   $0x0
  pushl $228
80108919:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010891e:	e9 e4 f1 ff ff       	jmp    80107b07 <alltraps>
...
80108923:	6a 00                	push   $0x0
  pushl $229
80108925:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010892a:	e9 d8 f1 ff ff       	jmp    80107b07 <alltraps>
...
8010892f:	6a 00                	push   $0x0
  pushl $230
80108931:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80108936:	e9 cc f1 ff ff       	jmp    80107b07 <alltraps>
...
8010893b:	6a 00                	push   $0x0
  pushl $231
8010893d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80108942:	e9 c0 f1 ff ff       	jmp    80107b07 <alltraps>
...
80108947:	6a 00                	push   $0x0
  pushl $232
80108949:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010894e:	e9 b4 f1 ff ff       	jmp    80107b07 <alltraps>
...
80108953:	6a 00                	push   $0x0
  pushl $233
80108955:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010895a:	e9 a8 f1 ff ff       	jmp    80107b07 <alltraps>
...
8010895f:	6a 00                	push   $0x0
  pushl $234
80108961:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80108966:	e9 9c f1 ff ff       	jmp    80107b07 <alltraps>
...
8010896b:	6a 00                	push   $0x0
  pushl $235
8010896d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80108972:	e9 90 f1 ff ff       	jmp    80107b07 <alltraps>
...
80108977:	6a 00                	push   $0x0
  pushl $236
80108979:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010897e:	e9 84 f1 ff ff       	jmp    80107b07 <alltraps>
...
80108983:	6a 00                	push   $0x0
  pushl $237
80108985:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010898a:	e9 78 f1 ff ff       	jmp    80107b07 <alltraps>
...
8010898f:	6a 00                	push   $0x0
  pushl $238
80108991:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80108996:	e9 6c f1 ff ff       	jmp    80107b07 <alltraps>
...
8010899b:	6a 00                	push   $0x0
  pushl $239
8010899d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801089a2:	e9 60 f1 ff ff       	jmp    80107b07 <alltraps>
...
801089a7:	6a 00                	push   $0x0
  pushl $240
801089a9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801089ae:	e9 54 f1 ff ff       	jmp    80107b07 <alltraps>
...
801089b3:	6a 00                	push   $0x0
  pushl $241
801089b5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801089ba:	e9 48 f1 ff ff       	jmp    80107b07 <alltraps>
...
801089bf:	6a 00                	push   $0x0
  pushl $242
801089c1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801089c6:	e9 3c f1 ff ff       	jmp    80107b07 <alltraps>
...
801089cb:	6a 00                	push   $0x0
  pushl $243
801089cd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801089d2:	e9 30 f1 ff ff       	jmp    80107b07 <alltraps>
...
801089d7:	6a 00                	push   $0x0
  pushl $244
801089d9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801089de:	e9 24 f1 ff ff       	jmp    80107b07 <alltraps>
...
801089e3:	6a 00                	push   $0x0
  pushl $245
801089e5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801089ea:	e9 18 f1 ff ff       	jmp    80107b07 <alltraps>
...
801089ef:	6a 00                	push   $0x0
  pushl $246
801089f1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801089f6:	e9 0c f1 ff ff       	jmp    80107b07 <alltraps>
...
801089fb:	6a 00                	push   $0x0
  pushl $247
801089fd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80108a02:	e9 00 f1 ff ff       	jmp    80107b07 <alltraps>
...
80108a07:	6a 00                	push   $0x0
  pushl $248
80108a09:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80108a0e:	e9 f4 f0 ff ff       	jmp    80107b07 <alltraps>
...
80108a13:	6a 00                	push   $0x0
  pushl $249
80108a15:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80108a1a:	e9 e8 f0 ff ff       	jmp    80107b07 <alltraps>
...
80108a1f:	6a 00                	push   $0x0
  pushl $250
80108a21:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80108a26:	e9 dc f0 ff ff       	jmp    80107b07 <alltraps>
...
80108a2b:	6a 00                	push   $0x0
  pushl $251
80108a2d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80108a32:	e9 d0 f0 ff ff       	jmp    80107b07 <alltraps>
...
80108a37:	6a 00                	push   $0x0
  pushl $252
80108a39:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80108a3e:	e9 c4 f0 ff ff       	jmp    80107b07 <alltraps>
...
80108a43:	6a 00                	push   $0x0
  pushl $253
80108a45:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80108a4a:	e9 b8 f0 ff ff       	jmp    80107b07 <alltraps>
...
80108a4f:	6a 00                	push   $0x0
  pushl $254
80108a51:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80108a56:	e9 ac f0 ff ff       	jmp    80107b07 <alltraps>
...
80108a5b:	6a 00                	push   $0x0
  pushl $255
80108a5d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80108a62:	e9 a0 f0 ff ff       	jmp    80107b07 <alltraps>
80108a67:	66 90                	xchg   %ax,%ax
80108a69:	66 90                	xchg   %ax,%ax
80108a6b:	66 90                	xchg   %ax,%ax
80108a6d:	66 90                	xchg   %ax,%ax
80108a6f:	90                   	nop

80108a70 <deallocuvm.part.0>:
...
80108a75:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
80108a76:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
80108a7c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80108a82:	83 ec 1c             	sub    $0x1c,%esp
  for(; a  < oldsz; a += PGSIZE){
80108a85:	39 d3                	cmp    %edx,%ebx
80108a87:	73 56                	jae    80108adf <deallocuvm.part.0+0x6f>
80108a89:	89 4d e0             	mov    %ecx,-0x20(%ebp)
80108a8c:	89 c6                	mov    %eax,%esi
80108a8e:	89 d7                	mov    %edx,%edi
80108a90:	eb 12                	jmp    80108aa4 <deallocuvm.part.0+0x34>
80108a92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80108a98:	83 c2 01             	add    $0x1,%edx
80108a9b:	89 d3                	mov    %edx,%ebx
80108a9d:	c1 e3 16             	shl    $0x16,%ebx
  for(; a  < oldsz; a += PGSIZE){
80108aa0:	39 fb                	cmp    %edi,%ebx
80108aa2:	73 38                	jae    80108adc <deallocuvm.part.0+0x6c>
  pde = &pgdir[PDX(va)];
80108aa4:	89 da                	mov    %ebx,%edx
80108aa6:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80108aa9:	8b 04 96             	mov    (%esi,%edx,4),%eax
80108aac:	a8 01                	test   $0x1,%al
80108aae:	74 e8                	je     80108a98 <deallocuvm.part.0+0x28>
  return &pgtab[PTX(va)];
80108ab0:	89 d9                	mov    %ebx,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80108ab2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80108ab7:	c1 e9 0a             	shr    $0xa,%ecx
80108aba:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
80108ac0:	8d 84 08 00 00 00 80 	lea    -0x80000000(%eax,%ecx,1),%eax
    if(!pte)
80108ac7:	85 c0                	test   %eax,%eax
80108ac9:	74 cd                	je     80108a98 <deallocuvm.part.0+0x28>
    else if((*pte & PTE_P) != 0){
80108acb:	8b 10                	mov    (%eax),%edx
80108acd:	f6 c2 01             	test   $0x1,%dl
80108ad0:	75 1e                	jne    80108af0 <deallocuvm.part.0+0x80>
  for(; a  < oldsz; a += PGSIZE){
80108ad2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80108ad8:	39 fb                	cmp    %edi,%ebx
80108ada:	72 c8                	jb     80108aa4 <deallocuvm.part.0+0x34>
80108adc:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      kfree(v);
      *pte = 0;
    }
  }
...
80108adf:	8d 65 f4             	lea    -0xc(%ebp),%esp
80108ae2:	89 c8                	mov    %ecx,%eax
80108ae4:	5b                   	pop    %ebx
80108ae5:	5e                   	pop    %esi
80108ae6:	5f                   	pop    %edi
80108ae7:	5d                   	pop    %ebp
80108ae8:	c3                   	ret    
80108ae9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(pa == 0)
80108af0:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80108af6:	74 26                	je     80108b1e <deallocuvm.part.0+0xae>
      kfree(v);
80108af8:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80108afb:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80108b01:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108b04:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80108b0a:	52                   	push   %edx
80108b0b:	e8 70 b5 ff ff       	call   80104080 <kfree>
      *pte = 0;
80108b10:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(; a  < oldsz; a += PGSIZE){
80108b13:	83 c4 10             	add    $0x10,%esp
      *pte = 0;
80108b16:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80108b1c:	eb 82                	jmp    80108aa0 <deallocuvm.part.0+0x30>
        panic("kfree");
80108b1e:	83 ec 0c             	sub    $0xc,%esp
80108b21:	68 76 97 10 80       	push   $0x80109776
80108b26:	e8 55 78 ff ff       	call   80100380 <panic>
...
80108b36:	89 d3                	mov    %edx,%ebx
80108b38:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
80108b3e:	83 ec 1c             	sub    $0x1c,%esp
80108b41:	89 45 e0             	mov    %eax,-0x20(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80108b44:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80108b48:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108b4d:	89 45 dc             	mov    %eax,-0x24(%ebp)
80108b50:	8b 45 08             	mov    0x8(%ebp),%eax
80108b53:	29 d8                	sub    %ebx,%eax
80108b55:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80108b58:	eb 3f                	jmp    80108b99 <mappages+0x69>
80108b5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80108b60:	89 da                	mov    %ebx,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80108b62:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80108b67:	c1 ea 0a             	shr    $0xa,%edx
80108b6a:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80108b70:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80108b77:	85 c0                	test   %eax,%eax
80108b79:	74 75                	je     80108bf0 <mappages+0xc0>
    if(*pte & PTE_P)
80108b7b:	f6 00 01             	testb  $0x1,(%eax)
80108b7e:	0f 85 86 00 00 00    	jne    80108c0a <mappages+0xda>
    *pte = pa | perm | PTE_P;
80108b84:	0b 75 0c             	or     0xc(%ebp),%esi
80108b87:	83 ce 01             	or     $0x1,%esi
80108b8a:	89 30                	mov    %esi,(%eax)
    if(a == last)
80108b8c:	8b 45 dc             	mov    -0x24(%ebp),%eax
80108b8f:	39 c3                	cmp    %eax,%ebx
80108b91:	74 6d                	je     80108c00 <mappages+0xd0>
    a += PGSIZE;
80108b93:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80108b99:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  pde = &pgdir[PDX(va)];
80108b9c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80108b9f:	8d 34 03             	lea    (%ebx,%eax,1),%esi
80108ba2:	89 d8                	mov    %ebx,%eax
80108ba4:	c1 e8 16             	shr    $0x16,%eax
80108ba7:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80108baa:	8b 07                	mov    (%edi),%eax
80108bac:	a8 01                	test   $0x1,%al
80108bae:	75 b0                	jne    80108b60 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80108bb0:	e8 8b b6 ff ff       	call   80104240 <kalloc>
80108bb5:	85 c0                	test   %eax,%eax
80108bb7:	74 37                	je     80108bf0 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80108bb9:	83 ec 04             	sub    $0x4,%esp
80108bbc:	68 00 10 00 00       	push   $0x1000
80108bc1:	6a 00                	push   $0x0
80108bc3:	50                   	push   %eax
80108bc4:	89 45 d8             	mov    %eax,-0x28(%ebp)
80108bc7:	e8 54 d8 ff ff       	call   80106420 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80108bcc:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80108bcf:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80108bd2:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80108bd8:	83 c8 07             	or     $0x7,%eax
80108bdb:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80108bdd:	89 d8                	mov    %ebx,%eax
80108bdf:	c1 e8 0a             	shr    $0xa,%eax
80108be2:	25 fc 0f 00 00       	and    $0xffc,%eax
80108be7:	01 d0                	add    %edx,%eax
80108be9:	eb 90                	jmp    80108b7b <mappages+0x4b>
80108beb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80108bef:	90                   	nop
}
80108bf0:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
80108bf3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80108bf8:	5b                   	pop    %ebx
80108bf9:	5e                   	pop    %esi
80108bfa:	5f                   	pop    %edi
...
80108c00:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
80108c03:	31 c0                	xor    %eax,%eax
}
80108c05:	5b                   	pop    %ebx
80108c06:	5e                   	pop    %esi
80108c07:	5f                   	pop    %edi
...
80108c0d:	68 d4 9e 10 80       	push   $0x80109ed4
80108c12:	e8 69 77 ff ff       	call   80100380 <panic>
80108c17:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80108c1e:	66 90                	xchg   %ax,%ax

80108c20 <seginit>:
{
80108c20:	55                   	push   %ebp
80108c21:	89 e5                	mov    %esp,%ebp
80108c23:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80108c26:	e8 f5 c8 ff ff       	call   80105520 <cpuid>
  pd[0] = size-1;
80108c2b:	ba 2f 00 00 00       	mov    $0x2f,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80108c30:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80108c36:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
80108c3a:	c7 80 b8 40 11 80 ff 	movl   $0xffff,-0x7feebf48(%eax)
80108c41:	ff 00 00 
80108c44:	c7 80 bc 40 11 80 00 	movl   $0xcf9a00,-0x7feebf44(%eax)
80108c4b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108c4e:	c7 80 c0 40 11 80 ff 	movl   $0xffff,-0x7feebf40(%eax)
80108c55:	ff 00 00 
80108c58:	c7 80 c4 40 11 80 00 	movl   $0xcf9200,-0x7feebf3c(%eax)
80108c5f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80108c62:	c7 80 c8 40 11 80 ff 	movl   $0xffff,-0x7feebf38(%eax)
80108c69:	ff 00 00 
80108c6c:	c7 80 cc 40 11 80 00 	movl   $0xcffa00,-0x7feebf34(%eax)
80108c73:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108c76:	c7 80 d0 40 11 80 ff 	movl   $0xffff,-0x7feebf30(%eax)
80108c7d:	ff 00 00 
80108c80:	c7 80 d4 40 11 80 00 	movl   $0xcff200,-0x7feebf2c(%eax)
80108c87:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80108c8a:	05 b0 40 11 80       	add    $0x801140b0,%eax
  pd[1] = (uint)p;
80108c8f:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80108c93:	c1 e8 10             	shr    $0x10,%eax
80108c96:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80108c9a:	8d 45 f2             	lea    -0xe(%ebp),%eax
80108c9d:	0f 01 10             	lgdtl  (%eax)
}
80108ca0:	c9                   	leave  
80108ca1:	c3                   	ret    
80108ca2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80108ca9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80108cb0 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80108cb0:	a1 64 6d 11 80       	mov    0x80116d64,%eax
80108cb5:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80108cba:	0f 22 d8             	mov    %eax,%cr3
}
80108cbd:	c3                   	ret    
80108cbe:	66 90                	xchg   %ax,%ax
...
80108cc6:	83 ec 1c             	sub    $0x1c,%esp
80108cc9:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80108ccc:	85 f6                	test   %esi,%esi
80108cce:	0f 84 cb 00 00 00    	je     80108d9f <switchuvm+0xdf>
  if(p->kstack == 0)
80108cd4:	8b 46 08             	mov    0x8(%esi),%eax
80108cd7:	85 c0                	test   %eax,%eax
80108cd9:	0f 84 da 00 00 00    	je     80108db9 <switchuvm+0xf9>
  if(p->pgdir == 0)
80108cdf:	8b 46 04             	mov    0x4(%esi),%eax
80108ce2:	85 c0                	test   %eax,%eax
80108ce4:	0f 84 c2 00 00 00    	je     80108dac <switchuvm+0xec>
  pushcli();
80108cea:	e8 e1 d4 ff ff       	call   801061d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80108cef:	e8 cc c7 ff ff       	call   801054c0 <mycpu>
80108cf4:	89 c3                	mov    %eax,%ebx
80108cf6:	e8 c5 c7 ff ff       	call   801054c0 <mycpu>
80108cfb:	89 c7                	mov    %eax,%edi
80108cfd:	e8 be c7 ff ff       	call   801054c0 <mycpu>
80108d02:	83 c7 08             	add    $0x8,%edi
80108d05:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80108d08:	e8 b3 c7 ff ff       	call   801054c0 <mycpu>
80108d0d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80108d10:	ba 67 00 00 00       	mov    $0x67,%edx
80108d15:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80108d1c:	83 c0 08             	add    $0x8,%eax
80108d1f:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80108d26:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80108d2b:	83 c1 08             	add    $0x8,%ecx
80108d2e:	c1 e8 18             	shr    $0x18,%eax
80108d31:	c1 e9 10             	shr    $0x10,%ecx
80108d34:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80108d3a:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80108d40:	b9 99 40 00 00       	mov    $0x4099,%ecx
80108d45:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80108d4c:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80108d51:	e8 6a c7 ff ff       	call   801054c0 <mycpu>
80108d56:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80108d5d:	e8 5e c7 ff ff       	call   801054c0 <mycpu>
80108d62:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80108d66:	8b 5e 08             	mov    0x8(%esi),%ebx
80108d69:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80108d6f:	e8 4c c7 ff ff       	call   801054c0 <mycpu>
80108d74:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80108d77:	e8 44 c7 ff ff       	call   801054c0 <mycpu>
80108d7c:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80108d80:	b8 28 00 00 00       	mov    $0x28,%eax
80108d85:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80108d88:	8b 46 04             	mov    0x4(%esi),%eax
80108d8b:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80108d90:	0f 22 d8             	mov    %eax,%cr3
}
80108d93:	8d 65 f4             	lea    -0xc(%ebp),%esp
80108d96:	5b                   	pop    %ebx
80108d97:	5e                   	pop    %esi
80108d98:	5f                   	pop    %edi
80108d99:	5d                   	pop    %ebp
  popcli();
80108d9a:	e9 81 d4 ff ff       	jmp    80106220 <popcli>
    panic("switchuvm: no process");
80108d9f:	83 ec 0c             	sub    $0xc,%esp
80108da2:	68 da 9e 10 80       	push   $0x80109eda
80108da7:	e8 d4 75 ff ff       	call   80100380 <panic>
    panic("switchuvm: no pgdir");
80108dac:	83 ec 0c             	sub    $0xc,%esp
80108daf:	68 05 9f 10 80       	push   $0x80109f05
80108db4:	e8 c7 75 ff ff       	call   80100380 <panic>
    panic("switchuvm: no kstack");
80108db9:	83 ec 0c             	sub    $0xc,%esp
80108dbc:	68 f0 9e 10 80       	push   $0x80109ef0
80108dc1:	e8 ba 75 ff ff       	call   80100380 <panic>
...
80108dd3:	57                   	push   %edi
80108dd4:	56                   	push   %esi
80108dd5:	53                   	push   %ebx
80108dd6:	83 ec 1c             	sub    $0x1c,%esp
80108dd9:	8b 45 08             	mov    0x8(%ebp),%eax
80108ddc:	8b 75 10             	mov    0x10(%ebp),%esi
80108ddf:	8b 7d 0c             	mov    0xc(%ebp),%edi
80108de2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80108de5:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80108deb:	77 49                	ja     80108e36 <inituvm+0x66>
  mem = kalloc();
80108ded:	e8 4e b4 ff ff       	call   80104240 <kalloc>
  memset(mem, 0, PGSIZE);
80108df2:	83 ec 04             	sub    $0x4,%esp
80108df5:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80108dfa:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80108dfc:	6a 00                	push   $0x0
80108dfe:	50                   	push   %eax
80108dff:	e8 1c d6 ff ff       	call   80106420 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80108e04:	58                   	pop    %eax
80108e05:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80108e0b:	5a                   	pop    %edx
80108e0c:	6a 06                	push   $0x6
80108e0e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80108e13:	31 d2                	xor    %edx,%edx
80108e15:	50                   	push   %eax
80108e16:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108e19:	e8 12 fd ff ff       	call   80108b30 <mappages>
  memmove(mem, init, sz);
80108e1e:	89 75 10             	mov    %esi,0x10(%ebp)
80108e21:	83 c4 10             	add    $0x10,%esp
80108e24:	89 7d 0c             	mov    %edi,0xc(%ebp)
80108e27:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80108e2a:	8d 65 f4             	lea    -0xc(%ebp),%esp
80108e2d:	5b                   	pop    %ebx
80108e2e:	5e                   	pop    %esi
80108e2f:	5f                   	pop    %edi
80108e30:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80108e31:	e9 7a d6 ff ff       	jmp    801064b0 <memmove>
    panic("inituvm: more than a page");
80108e36:	83 ec 0c             	sub    $0xc,%esp
80108e39:	68 19 9f 10 80       	push   $0x80109f19
80108e3e:	e8 3d 75 ff ff       	call   80100380 <panic>
80108e43:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80108e4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80108e59:	8b 75 0c             	mov    0xc(%ebp),%esi
{
80108e5c:	8b 7d 18             	mov    0x18(%ebp),%edi
  if((uint) addr % PGSIZE != 0)
80108e5f:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80108e65:	0f 85 a2 00 00 00    	jne    80108f0d <loaduvm+0xbd>
  for(i = 0; i < sz; i += PGSIZE){
80108e6b:	85 ff                	test   %edi,%edi
80108e6d:	74 7d                	je     80108eec <loaduvm+0x9c>
80108e6f:	90                   	nop
  pde = &pgdir[PDX(va)];
80108e70:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80108e73:	8b 55 08             	mov    0x8(%ebp),%edx
80108e76:	01 f0                	add    %esi,%eax
  pde = &pgdir[PDX(va)];
80108e78:	89 c1                	mov    %eax,%ecx
80108e7a:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80108e7d:	8b 0c 8a             	mov    (%edx,%ecx,4),%ecx
80108e80:	f6 c1 01             	test   $0x1,%cl
80108e83:	75 13                	jne    80108e98 <loaduvm+0x48>
      panic("loaduvm: address should exist");
80108e85:	83 ec 0c             	sub    $0xc,%esp
80108e88:	68 33 9f 10 80       	push   $0x80109f33
80108e8d:	e8 ee 74 ff ff       	call   80100380 <panic>
80108e92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80108e98:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80108e9b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80108ea1:	25 fc 0f 00 00       	and    $0xffc,%eax
80108ea6:	8d 8c 01 00 00 00 80 	lea    -0x80000000(%ecx,%eax,1),%ecx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80108ead:	85 c9                	test   %ecx,%ecx
80108eaf:	74 d4                	je     80108e85 <loaduvm+0x35>
    if(sz - i < PGSIZE)
80108eb1:	89 fb                	mov    %edi,%ebx
80108eb3:	b8 00 10 00 00       	mov    $0x1000,%eax
80108eb8:	29 f3                	sub    %esi,%ebx
80108eba:	39 c3                	cmp    %eax,%ebx
80108ebc:	0f 47 d8             	cmova  %eax,%ebx
    if(readi(ip, P2V(pa), offset+i, n) != n)
80108ebf:	53                   	push   %ebx
80108ec0:	8b 45 14             	mov    0x14(%ebp),%eax
80108ec3:	01 f0                	add    %esi,%eax
80108ec5:	50                   	push   %eax
    pa = PTE_ADDR(*pte);
80108ec6:	8b 01                	mov    (%ecx),%eax
80108ec8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80108ecd:	05 00 00 00 80       	add    $0x80000000,%eax
80108ed2:	50                   	push   %eax
80108ed3:	ff 75 10             	pushl  0x10(%ebp)
80108ed6:	e8 b5 a7 ff ff       	call   80103690 <readi>
80108edb:	83 c4 10             	add    $0x10,%esp
80108ede:	39 d8                	cmp    %ebx,%eax
80108ee0:	75 1e                	jne    80108f00 <loaduvm+0xb0>
  for(i = 0; i < sz; i += PGSIZE){
80108ee2:	81 c6 00 10 00 00    	add    $0x1000,%esi
80108ee8:	39 fe                	cmp    %edi,%esi
80108eea:	72 84                	jb     80108e70 <loaduvm+0x20>
}
80108eec:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
80108eef:	31 c0                	xor    %eax,%eax
}
80108ef1:	5b                   	pop    %ebx
80108ef2:	5e                   	pop    %esi
80108ef3:	5f                   	pop    %edi
80108ef4:	5d                   	pop    %ebp
80108ef5:	c3                   	ret    
80108ef6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80108efd:	8d 76 00             	lea    0x0(%esi),%esi
80108f00:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
80108f03:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80108f08:	5b                   	pop    %ebx
80108f09:	5e                   	pop    %esi
80108f0a:	5f                   	pop    %edi
...
80108f10:	68 d4 9f 10 80       	push   $0x80109fd4
80108f15:	e8 66 74 ff ff       	call   80100380 <panic>
...
80108f26:	83 ec 1c             	sub    $0x1c,%esp
80108f29:	8b 75 10             	mov    0x10(%ebp),%esi
  if(newsz >= KERNBASE)
80108f2c:	85 f6                	test   %esi,%esi
80108f2e:	0f 88 98 00 00 00    	js     80108fcc <allocuvm+0xac>
80108f34:	89 f2                	mov    %esi,%edx
  if(newsz < oldsz)
80108f36:	3b 75 0c             	cmp    0xc(%ebp),%esi
80108f39:	0f 82 a1 00 00 00    	jb     80108fe0 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80108f3f:	8b 45 0c             	mov    0xc(%ebp),%eax
80108f42:	05 ff 0f 00 00       	add    $0xfff,%eax
80108f47:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108f4c:	89 c7                	mov    %eax,%edi
  for(; a < newsz; a += PGSIZE){
80108f4e:	39 f0                	cmp    %esi,%eax
80108f50:	0f 83 8d 00 00 00    	jae    80108fe3 <allocuvm+0xc3>
80108f56:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80108f59:	eb 44                	jmp    80108f9f <allocuvm+0x7f>
80108f5b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80108f5f:	90                   	nop
    memset(mem, 0, PGSIZE);
80108f60:	83 ec 04             	sub    $0x4,%esp
80108f63:	68 00 10 00 00       	push   $0x1000
80108f68:	6a 00                	push   $0x0
80108f6a:	50                   	push   %eax
80108f6b:	e8 b0 d4 ff ff       	call   80106420 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80108f70:	58                   	pop    %eax
80108f71:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80108f77:	5a                   	pop    %edx
80108f78:	6a 06                	push   $0x6
80108f7a:	b9 00 10 00 00       	mov    $0x1000,%ecx
80108f7f:	89 fa                	mov    %edi,%edx
80108f81:	50                   	push   %eax
80108f82:	8b 45 08             	mov    0x8(%ebp),%eax
80108f85:	e8 a6 fb ff ff       	call   80108b30 <mappages>
80108f8a:	83 c4 10             	add    $0x10,%esp
80108f8d:	85 c0                	test   %eax,%eax
80108f8f:	78 5f                	js     80108ff0 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
80108f91:	81 c7 00 10 00 00    	add    $0x1000,%edi
80108f97:	39 f7                	cmp    %esi,%edi
80108f99:	0f 83 89 00 00 00    	jae    80109028 <allocuvm+0x108>
    mem = kalloc();
80108f9f:	e8 9c b2 ff ff       	call   80104240 <kalloc>
80108fa4:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80108fa6:	85 c0                	test   %eax,%eax
80108fa8:	75 b6                	jne    80108f60 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80108faa:	83 ec 0c             	sub    $0xc,%esp
80108fad:	68 51 9f 10 80       	push   $0x80109f51
80108fb2:	e8 19 78 ff ff       	call   801007d0 <cprintf>
  if(newsz >= oldsz)
80108fb7:	83 c4 10             	add    $0x10,%esp
80108fba:	3b 75 0c             	cmp    0xc(%ebp),%esi
80108fbd:	74 0d                	je     80108fcc <allocuvm+0xac>
80108fbf:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80108fc2:	8b 45 08             	mov    0x8(%ebp),%eax
80108fc5:	89 f2                	mov    %esi,%edx
80108fc7:	e8 a4 fa ff ff       	call   80108a70 <deallocuvm.part.0>
    return 0;
80108fcc:	31 d2                	xor    %edx,%edx
}
80108fce:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80108fd6:	5d                   	pop    %ebp
80108fd7:	c3                   	ret    
80108fd8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80108fdf:	90                   	nop
    return oldsz;
80108fe0:	8b 55 0c             	mov    0xc(%ebp),%edx
}
80108fe3:	8d 65 f4             	lea    -0xc(%ebp),%esp
80108fe6:	89 d0                	mov    %edx,%eax
80108fe8:	5b                   	pop    %ebx
80108fe9:	5e                   	pop    %esi
80108fea:	5f                   	pop    %edi
80108feb:	5d                   	pop    %ebp
80108fec:	c3                   	ret    
80108fed:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("allocuvm out of memory (2)\n");
80108ff0:	83 ec 0c             	sub    $0xc,%esp
80108ff3:	68 69 9f 10 80       	push   $0x80109f69
80108ff8:	e8 d3 77 ff ff       	call   801007d0 <cprintf>
  if(newsz >= oldsz)
80108ffd:	83 c4 10             	add    $0x10,%esp
80109000:	3b 75 0c             	cmp    0xc(%ebp),%esi
80109003:	74 0d                	je     80109012 <allocuvm+0xf2>
80109005:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80109008:	8b 45 08             	mov    0x8(%ebp),%eax
8010900b:	89 f2                	mov    %esi,%edx
8010900d:	e8 5e fa ff ff       	call   80108a70 <deallocuvm.part.0>
      kfree(mem);
80109012:	83 ec 0c             	sub    $0xc,%esp
80109015:	53                   	push   %ebx
80109016:	e8 65 b0 ff ff       	call   80104080 <kfree>
      return 0;
8010901b:	83 c4 10             	add    $0x10,%esp
    return 0;
8010901e:	31 d2                	xor    %edx,%edx
80109020:	eb ac                	jmp    80108fce <allocuvm+0xae>
80109022:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80109028:	8b 55 e4             	mov    -0x1c(%ebp),%edx
}
...
80109033:	5d                   	pop    %ebp
80109034:	c3                   	ret    
80109035:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80109043:	8b 55 0c             	mov    0xc(%ebp),%edx
80109046:	8b 4d 10             	mov    0x10(%ebp),%ecx
80109049:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
8010904c:	39 d1                	cmp    %edx,%ecx
8010904e:	73 10                	jae    80109060 <deallocuvm+0x20>
}
80109050:	5d                   	pop    %ebp
80109051:	e9 1a fa ff ff       	jmp    80108a70 <deallocuvm.part.0>
80109056:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010905d:	8d 76 00             	lea    0x0(%esi),%esi
80109060:	89 d0                	mov    %edx,%eax
80109062:	5d                   	pop    %ebp
80109063:	c3                   	ret    
80109064:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010906b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010906f:	90                   	nop
...
80109073:	57                   	push   %edi
80109074:	56                   	push   %esi
80109075:	53                   	push   %ebx
80109076:	83 ec 0c             	sub    $0xc,%esp
80109079:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
8010907c:	85 f6                	test   %esi,%esi
8010907e:	74 59                	je     801090d9 <freevm+0x69>
  if(newsz >= oldsz)
80109080:	31 c9                	xor    %ecx,%ecx
80109082:	ba 00 00 00 80       	mov    $0x80000000,%edx
80109087:	89 f0                	mov    %esi,%eax
80109089:	89 f3                	mov    %esi,%ebx
8010908b:	e8 e0 f9 ff ff       	call   80108a70 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80109090:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80109096:	eb 0f                	jmp    801090a7 <freevm+0x37>
80109098:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010909f:	90                   	nop
801090a0:	83 c3 04             	add    $0x4,%ebx
801090a3:	39 fb                	cmp    %edi,%ebx
801090a5:	74 23                	je     801090ca <freevm+0x5a>
    if(pgdir[i] & PTE_P){
801090a7:	8b 03                	mov    (%ebx),%eax
801090a9:	a8 01                	test   $0x1,%al
801090ab:	74 f3                	je     801090a0 <freevm+0x30>
      char * v = P2V(PTE_ADDR(pgdir[i]));
801090ad:	25 00 f0 ff ff       	and    $0xfffff000,%eax
      kfree(v);
801090b2:	83 ec 0c             	sub    $0xc,%esp
  for(i = 0; i < NPDENTRIES; i++){
801090b5:	83 c3 04             	add    $0x4,%ebx
      char * v = P2V(PTE_ADDR(pgdir[i]));
801090b8:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
801090bd:	50                   	push   %eax
801090be:	e8 bd af ff ff       	call   80104080 <kfree>
801090c3:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
801090c6:	39 fb                	cmp    %edi,%ebx
801090c8:	75 dd                	jne    801090a7 <freevm+0x37>
    }
  }
  kfree((char*)pgdir);
801090ca:	89 75 08             	mov    %esi,0x8(%ebp)
}
801090cd:	8d 65 f4             	lea    -0xc(%ebp),%esp
801090d0:	5b                   	pop    %ebx
801090d1:	5e                   	pop    %esi
801090d2:	5f                   	pop    %edi
801090d3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801090d4:	e9 a7 af ff ff       	jmp    80104080 <kfree>
    panic("freevm: no pgdir");
801090d9:	83 ec 0c             	sub    $0xc,%esp
801090dc:	68 85 9f 10 80       	push   $0x80109f85
801090e1:	e8 9a 72 ff ff       	call   80100380 <panic>
801090e6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801090f3:	56                   	push   %esi
801090f4:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
801090f5:	e8 46 b1 ff ff       	call   80104240 <kalloc>
801090fa:	85 c0                	test   %eax,%eax
801090fc:	74 5e                	je     8010915c <setupkvm+0x6c>
  memset(pgdir, 0, PGSIZE);
801090fe:	83 ec 04             	sub    $0x4,%esp
80109101:	89 c6                	mov    %eax,%esi
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80109103:	bb 20 c4 10 80       	mov    $0x8010c420,%ebx
  memset(pgdir, 0, PGSIZE);
80109108:	68 00 10 00 00       	push   $0x1000
8010910d:	6a 00                	push   $0x0
8010910f:	50                   	push   %eax
80109110:	e8 0b d3 ff ff       	call   80106420 <memset>
80109115:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
80109118:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010911b:	83 ec 08             	sub    $0x8,%esp
8010911e:	8b 4b 08             	mov    0x8(%ebx),%ecx
80109121:	8b 13                	mov    (%ebx),%edx
80109123:	ff 73 0c             	pushl  0xc(%ebx)
80109126:	50                   	push   %eax
80109127:	29 c1                	sub    %eax,%ecx
80109129:	89 f0                	mov    %esi,%eax
8010912b:	e8 00 fa ff ff       	call   80108b30 <mappages>
80109130:	83 c4 10             	add    $0x10,%esp
80109133:	85 c0                	test   %eax,%eax
80109135:	78 19                	js     80109150 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80109137:	83 c3 10             	add    $0x10,%ebx
8010913a:	81 fb 60 c4 10 80    	cmp    $0x8010c460,%ebx
80109140:	75 d6                	jne    80109118 <setupkvm+0x28>
}
80109142:	8d 65 f8             	lea    -0x8(%ebp),%esp
80109145:	89 f0                	mov    %esi,%eax
80109147:	5b                   	pop    %ebx
80109148:	5e                   	pop    %esi
80109149:	5d                   	pop    %ebp
8010914a:	c3                   	ret    
...
80109153:	56                   	push   %esi
80109154:	e8 17 ff ff ff       	call   80109070 <freevm>
      return 0;
80109159:	83 c4 10             	add    $0x10,%esp
}
8010915c:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return 0;
8010915f:	31 f6                	xor    %esi,%esi
}
80109161:	89 f0                	mov    %esi,%eax
80109163:	5b                   	pop    %ebx
80109164:	5e                   	pop    %esi
80109165:	5d                   	pop    %ebp
80109166:	c3                   	ret    
80109167:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010916e:	66 90                	xchg   %ax,%ax

80109170 <kvmalloc>:
{
80109170:	55                   	push   %ebp
80109171:	89 e5                	mov    %esp,%ebp
80109173:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80109176:	e8 75 ff ff ff       	call   801090f0 <setupkvm>
8010917b:	a3 64 6d 11 80       	mov    %eax,0x80116d64
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80109180:	05 00 00 00 80       	add    $0x80000000,%eax
80109185:	0f 22 d8             	mov    %eax,%cr3
}
80109188:	c9                   	leave  
80109189:	c3                   	ret    
8010918a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80109196:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80109199:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
8010919c:	89 c1                	mov    %eax,%ecx
8010919e:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
801091a1:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
801091a4:	f6 c2 01             	test   $0x1,%dl
801091a7:	75 17                	jne    801091c0 <clearpteu+0x30>
  pte_t *pte;
...
801091ac:	68 96 9f 10 80       	push   $0x80109f96
801091b1:	e8 ca 71 ff ff       	call   80100380 <panic>
801091b6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801091bd:	8d 76 00             	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
801091c0:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801091c3:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
801091c9:	25 fc 0f 00 00       	and    $0xffc,%eax
801091ce:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
  if(pte == 0)
801091d5:	85 c0                	test   %eax,%eax
801091d7:	74 d0                	je     801091a9 <clearpteu+0x19>
  *pte &= ~PTE_U;
801091d9:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801091dc:	c9                   	leave  
801091dd:	c3                   	ret    
801091de:	66 90                	xchg   %ax,%ax
...
801091e3:	57                   	push   %edi
801091e4:	56                   	push   %esi
801091e5:	53                   	push   %ebx
801091e6:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801091e9:	e8 02 ff ff ff       	call   801090f0 <setupkvm>
801091ee:	89 45 e0             	mov    %eax,-0x20(%ebp)
801091f1:	85 c0                	test   %eax,%eax
801091f3:	0f 84 e9 00 00 00    	je     801092e2 <copyuvm+0x102>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801091f9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801091fc:	85 c9                	test   %ecx,%ecx
801091fe:	0f 84 b2 00 00 00    	je     801092b6 <copyuvm+0xd6>
80109204:	31 f6                	xor    %esi,%esi
80109206:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010920d:	8d 76 00             	lea    0x0(%esi),%esi
  if(*pde & PTE_P){
80109210:	8b 4d 08             	mov    0x8(%ebp),%ecx
  pde = &pgdir[PDX(va)];
80109213:	89 f0                	mov    %esi,%eax
80109215:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80109218:	8b 04 81             	mov    (%ecx,%eax,4),%eax
8010921b:	a8 01                	test   $0x1,%al
8010921d:	75 11                	jne    80109230 <copyuvm+0x50>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
8010921f:	83 ec 0c             	sub    $0xc,%esp
80109222:	68 a0 9f 10 80       	push   $0x80109fa0
80109227:	e8 54 71 ff ff       	call   80100380 <panic>
8010922c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  return &pgtab[PTX(va)];
80109230:	89 f2                	mov    %esi,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80109232:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80109237:	c1 ea 0a             	shr    $0xa,%edx
8010923a:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80109240:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80109247:	85 c0                	test   %eax,%eax
80109249:	74 d4                	je     8010921f <copyuvm+0x3f>
    if(!(*pte & PTE_P))
8010924b:	8b 00                	mov    (%eax),%eax
8010924d:	a8 01                	test   $0x1,%al
8010924f:	0f 84 9f 00 00 00    	je     801092f4 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80109255:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80109257:	25 ff 0f 00 00       	and    $0xfff,%eax
8010925c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
8010925f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80109265:	e8 d6 af ff ff       	call   80104240 <kalloc>
8010926a:	89 c3                	mov    %eax,%ebx
8010926c:	85 c0                	test   %eax,%eax
8010926e:	74 64                	je     801092d4 <copyuvm+0xf4>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80109270:	83 ec 04             	sub    $0x4,%esp
80109273:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80109279:	68 00 10 00 00       	push   $0x1000
8010927e:	57                   	push   %edi
8010927f:	50                   	push   %eax
80109280:	e8 2b d2 ff ff       	call   801064b0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80109285:	58                   	pop    %eax
80109286:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010928c:	5a                   	pop    %edx
8010928d:	ff 75 e4             	pushl  -0x1c(%ebp)
80109290:	b9 00 10 00 00       	mov    $0x1000,%ecx
80109295:	89 f2                	mov    %esi,%edx
80109297:	50                   	push   %eax
80109298:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010929b:	e8 90 f8 ff ff       	call   80108b30 <mappages>
801092a0:	83 c4 10             	add    $0x10,%esp
801092a3:	85 c0                	test   %eax,%eax
801092a5:	78 21                	js     801092c8 <copyuvm+0xe8>
  for(i = 0; i < sz; i += PGSIZE){
801092a7:	81 c6 00 10 00 00    	add    $0x1000,%esi
801092ad:	3b 75 0c             	cmp    0xc(%ebp),%esi
801092b0:	0f 82 5a ff ff ff    	jb     80109210 <copyuvm+0x30>
  return d;
...
801092b6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801092b9:	8d 65 f4             	lea    -0xc(%ebp),%esp
801092bc:	5b                   	pop    %ebx
801092bd:	5e                   	pop    %esi
801092be:	5f                   	pop    %edi
801092bf:	5d                   	pop    %ebp
801092c0:	c3                   	ret    
801092c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
801092c8:	83 ec 0c             	sub    $0xc,%esp
801092cb:	53                   	push   %ebx
801092cc:	e8 af ad ff ff       	call   80104080 <kfree>
      goto bad;
801092d1:	83 c4 10             	add    $0x10,%esp
  freevm(d);
801092d4:	83 ec 0c             	sub    $0xc,%esp
801092d7:	ff 75 e0             	pushl  -0x20(%ebp)
801092da:	e8 91 fd ff ff       	call   80109070 <freevm>
  return 0;
801092df:	83 c4 10             	add    $0x10,%esp
    return 0;
801092e2:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
801092e9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801092ec:	8d 65 f4             	lea    -0xc(%ebp),%esp
801092ef:	5b                   	pop    %ebx
801092f0:	5e                   	pop    %esi
801092f1:	5f                   	pop    %edi
801092f2:	5d                   	pop    %ebp
801092f3:	c3                   	ret    
      panic("copyuvm: page not present");
801092f4:	83 ec 0c             	sub    $0xc,%esp
801092f7:	68 ba 9f 10 80       	push   $0x80109fba
801092fc:	e8 7f 70 ff ff       	call   80100380 <panic>
80109301:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80109308:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010930f:	90                   	nop
...
80109313:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80109316:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
80109319:	89 c1                	mov    %eax,%ecx
8010931b:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
8010931e:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80109321:	f6 c2 01             	test   $0x1,%dl
80109324:	0f 84 f8 00 00 00    	je     80109422 <uva2ka.cold>
  return &pgtab[PTX(va)];
8010932a:	c1 e8 0c             	shr    $0xc,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010932d:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if((*pte & PTE_P) == 0)
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
80109333:	5d                   	pop    %ebp
  return &pgtab[PTX(va)];
80109334:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80109339:	8b 94 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%edx
  return (char*)P2V(PTE_ADDR(*pte));
80109340:	89 d0                	mov    %edx,%eax
80109342:	f7 d2                	not    %edx
80109344:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80109349:	05 00 00 00 80       	add    $0x80000000,%eax
8010934e:	83 e2 05             	and    $0x5,%edx
80109351:	ba 00 00 00 00       	mov    $0x0,%edx
80109356:	0f 45 c2             	cmovne %edx,%eax
}
80109359:	c3                   	ret    
...
80109369:	8b 75 14             	mov    0x14(%ebp),%esi
8010936c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010936f:	8b 55 10             	mov    0x10(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80109372:	85 f6                	test   %esi,%esi
80109374:	75 51                	jne    801093c7 <copyout+0x67>
80109376:	e9 9d 00 00 00       	jmp    80109418 <copyout+0xb8>
8010937b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010937f:	90                   	nop
  return (char*)P2V(PTE_ADDR(*pte));
80109380:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80109386:	8d 8b 00 00 00 80    	lea    -0x80000000(%ebx),%ecx
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
8010938c:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80109392:	74 74                	je     80109408 <copyout+0xa8>
      return -1;
    n = PGSIZE - (va - va0);
80109394:	89 fb                	mov    %edi,%ebx
80109396:	29 c3                	sub    %eax,%ebx
80109398:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010939e:	39 f3                	cmp    %esi,%ebx
801093a0:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801093a3:	29 f8                	sub    %edi,%eax
801093a5:	83 ec 04             	sub    $0x4,%esp
801093a8:	01 c1                	add    %eax,%ecx
801093aa:	53                   	push   %ebx
801093ab:	52                   	push   %edx
801093ac:	89 55 10             	mov    %edx,0x10(%ebp)
801093af:	51                   	push   %ecx
801093b0:	e8 fb d0 ff ff       	call   801064b0 <memmove>
    len -= n;
    buf += n;
801093b5:	8b 55 10             	mov    0x10(%ebp),%edx
    va = va0 + PGSIZE;
801093b8:	8d 87 00 10 00 00    	lea    0x1000(%edi),%eax
  while(len > 0){
801093be:	83 c4 10             	add    $0x10,%esp
    buf += n;
801093c1:	01 da                	add    %ebx,%edx
  while(len > 0){
801093c3:	29 de                	sub    %ebx,%esi
801093c5:	74 51                	je     80109418 <copyout+0xb8>
  if(*pde & PTE_P){
801093c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &pgdir[PDX(va)];
801093ca:	89 c1                	mov    %eax,%ecx
    va0 = (uint)PGROUNDDOWN(va);
801093cc:	89 c7                	mov    %eax,%edi
  pde = &pgdir[PDX(va)];
801093ce:	c1 e9 16             	shr    $0x16,%ecx
    va0 = (uint)PGROUNDDOWN(va);
801093d1:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  if(*pde & PTE_P){
801093d7:	8b 0c 8b             	mov    (%ebx,%ecx,4),%ecx
801093da:	f6 c1 01             	test   $0x1,%cl
801093dd:	0f 84 46 00 00 00    	je     80109429 <copyout.cold>
  return &pgtab[PTX(va)];
801093e3:	89 fb                	mov    %edi,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801093e5:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
801093eb:	c1 eb 0c             	shr    $0xc,%ebx
801093ee:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  if((*pte & PTE_P) == 0)
801093f4:	8b 9c 99 00 00 00 80 	mov    -0x80000000(%ecx,%ebx,4),%ebx
  if((*pte & PTE_U) == 0)
801093fb:	89 d9                	mov    %ebx,%ecx
801093fd:	f7 d1                	not    %ecx
801093ff:	83 e1 05             	and    $0x5,%ecx
80109402:	0f 84 78 ff ff ff    	je     80109380 <copyout+0x20>
  }
  return 0;
}
80109408:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
8010940b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80109410:	5b                   	pop    %ebx
80109411:	5e                   	pop    %esi
80109412:	5f                   	pop    %edi
80109413:	5d                   	pop    %ebp
80109414:	c3                   	ret    
80109415:	8d 76 00             	lea    0x0(%esi),%esi
80109418:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
8010941b:	31 c0                	xor    %eax,%eax
}
8010941d:	5b                   	pop    %ebx
8010941e:	5e                   	pop    %esi
8010941f:	5f                   	pop    %edi
...
80109422 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80109422:	a1 00 00 00 00       	mov    0x0,%eax
80109427:	0f 0b                	ud2    

80109429 <copyout.cold>:
80109429:	a1 00 00 00 00       	mov    0x0,%eax
8010942e:	0f 0b                	ud2    
