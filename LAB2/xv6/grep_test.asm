...
int main(int argc, char *argv[])
{
  ...
  73:	52                   	push   %edx
  74:	52                   	push   %edx
  75:	68 48 07 00 00       	push   $0x748
  7a:	6a 01                	push   $0x1
  7c:	e8 bf 03 00 00       	call   440 <printf>
        exit();
 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3db:	0f b6 92 c0 07 00 00 	movzbl 0x7c0(%edx),%edx
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4b4:	ff 24 85 68 07 00 00 	jmp    *0x768(,%eax,4)
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb 60 07 00 00       	mov    $0x760,%ebx
 ...
 5d1:	a1 64 0a 00 00       	mov    0xa64,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 64 0a 00 00       	mov    %eax,0xa64
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 64 0a 00 00       	mov    %eax,0xa64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ab:	3b 05 64 0a 00 00    	cmp    0xa64,%eax
