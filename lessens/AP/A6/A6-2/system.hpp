...
public:
    ...
    void setting_profile(vector<string> order_words);
    void send_TA_form(vector<string> order_words);
    void send_TA_request(vector<string> order_words);
    void close_TA_form(vector<string> order_words);
    void course_posting(vector<string> order_words);
    void find_professor_and_TAs(int course_id, vector<string> &TAs_professor);
    void find_connected_users(int course_id, vector<string> &connected_users);
    void send_notification_for_course_posting(int course_id, string course_name);
    void view_channel(vector<string> order_words);
    void view_a_post_in_channel(vector<string> order_words);
