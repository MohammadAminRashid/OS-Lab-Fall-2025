...
int main(int argc, char *argv[])
{
  ...
  13:	68 dc 07 00 00       	push   $0x7dc
  18:	6a 01                	push   $0x1
  1a:	e8 71 04 00 00       	call   490 <printf>

  pid_low = fork();
  1f:	e8 e7 02 00 00       	call   30b <fork>
  if (pid_low == 0) {
  24:	83 c4 10             	add    $0x10,%esp
  27:	85 c0                	test   %eax,%eax
  29:	75 12                	jne    3d <main+0x3d>
    heavy_loop("LowPriority");
  2b:	83 ec 0c             	sub    $0xc,%esp
  2e:	68 c3 07 00 00       	push   $0x7c3
  33:	e8 68 00 00 00       	call   a0 <heavy_loop>
    exit();
  38:	e8 d6 02 00 00       	call   313 <exit>
  3d:	89 c3                	mov    %eax,%ebx
  }

  pid_high = fork();
  3f:	e8 c7 02 00 00       	call   30b <fork>
  44:	89 c6                	mov    %eax,%esi
  if (pid_high == 0) {
  46:	85 c0                	test   %eax,%eax
  48:	74 0d                	je     57 <main+0x57>
    heavy_loop("HighPriority");
    exit();
  }

  if (pid_low > 0 && pid_high > 0) {
  4a:	85 db                	test   %ebx,%ebx
  4c:	7e 04                	jle    52 <main+0x52>
  4e:	85 c0                	test   %eax,%eax
  50:	7f 17                	jg     69 <main+0x69>
    wait();
    wait();
  ...
  exit();
  52:	e8 bc 02 00 00       	call   313 <exit>
    heavy_loop("HighPriority");
  57:	83 ec 0c             	sub    $0xc,%esp
  5a:	68 cf 07 00 00       	push   $0x7cf
  5f:	e8 3c 00 00 00       	call   a0 <heavy_loop>
    exit();
  64:	e8 aa 02 00 00       	call   313 <exit>
    set_priority_syscall(pid_low, 2);     
  69:	50                   	push   %eax
  6a:	50                   	push   %eax
  6b:	6a 02                	push   $0x2
  6d:	53                   	push   %ebx
  6e:	e8 58 03 00 00       	call   3cb <set_priority_syscall>
    set_priority_syscall(pid_high, 0);
  73:	5a                   	pop    %edx
  74:	59                   	pop    %ecx
  75:	6a 00                	push   $0x0
  77:	56                   	push   %esi
  78:	e8 4e 03 00 00       	call   3cb <set_priority_syscall>
    wait();
  7d:	e8 99 02 00 00       	call   31b <wait>
    wait();
  82:	e8 94 02 00 00       	call   31b <wait>
    printf(1, "Parent: both children finished. test completed.\n");
  87:	5b                   	pop    %ebx
  88:	5e                   	pop    %esi
  89:	68 fc 07 00 00       	push   $0x7fc
  8e:	6a 01                	push   $0x1
  90:	e8 fb 03 00 00       	call   490 <printf>
  95:	83 c4 10             	add    $0x10,%esp
  98:	eb b8                	jmp    52 <main+0x52>
  9a:	66 90                	xchg   %ax,%ax
  9c:	66 90                	xchg   %ax,%ax
  9e:	66 90                	xchg   %ax,%ax
...
000000a0 <heavy_loop>:
{
  ...
  aa:	53                   	push   %ebx
  ab:	68 98 07 00 00       	push   $0x798
  b0:	6a 01                	push   $0x1
  b2:	e8 d9 03 00 00       	call   490 <printf>
  printf(1, "Process %s: FINISHED\n", process_type);
  b7:	83 c4 0c             	add    $0xc,%esp
  ba:	53                   	push   %ebx
  bb:	68 ad 07 00 00       	push   $0x7ad
  c0:	6a 01                	push   $0x1
  c2:	e8 c9 03 00 00       	call   490 <printf>
}
...
000003c3 <grep_syscall>:
SYSCALL(grep_syscall)
 3c3:	b8 19 00 00 00       	mov    $0x19,%eax
 3c8:	cd 40                	int    $0x40
 3ca:	c3                   	ret    

000003cb <set_priority_syscall>:
SYSCALL(set_priority_syscall)
 3cb:	b8 1a 00 00 00       	mov    $0x1a,%eax
 3d0:	cd 40                	int    $0x40
 3d2:	c3                   	ret    

000003d3 <simple_arithmetic_syscall>:

.globl simple_arithmetic_syscall
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
 3d3:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
 3d7:	8b 4c 24 08          	mov    0x8(%esp),%ecx
 ...
 3f8:	89 d1                	mov    %edx,%ecx
{
 ...
 42b:	0f b6 92 8c 08 00 00 	movzbl 0x88c(%edx),%edx
 ...
 499:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 504:	ff 24 85 34 08 00 00 	jmp    *0x834(,%eax,4)
 ...
 610:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 615:	bb 2d 08 00 00       	mov    $0x82d,%ebx
 ...
 621:	a1 54 0b 00 00       	mov    0xb54,%eax
{
 ...
 65f:	5b                   	pop    %ebx
  freep = p;
 660:	a3 54 0b 00 00       	mov    %eax,0xb54
}
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 667:	5d                   	pop    %ebp
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 54 0b 00 00       	mov    %eax,0xb54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 54 0b 00 00    	mov    0xb54,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6fb:	3b 05 54 0b 00 00    	cmp    0xb54,%eax
 ...
 71e:	e8 fd fe ff ff       	call   620 <free>
  return freep;
 723:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 74c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 74f:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 54 0b 00 00 58 	movl   $0xb58,0xb54
 767:	0b 00 00 
    base.s.size = 0;
 76a:	b8 58 0b 00 00       	mov    $0xb58,%eax
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 776:	0b 00 00 
    base.s.size = 0;
 779:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 780:	00 00 00 
    if(p->s.size >= nunits){
