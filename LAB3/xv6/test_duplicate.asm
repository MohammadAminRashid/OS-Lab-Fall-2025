...
{  
  ...
  55:	50                   	push   %eax
  56:	50                   	push   %eax
  57:	68 77 07 00 00       	push   $0x777
  5c:	6a 01                	push   $0x1
  5e:	e8 dd 03 00 00       	call   440 <printf>
  63:	83 c4 10             	add    $0x10,%esp
  66:	eb d9                	jmp    41 <main+0x41>
        printf(1,"No file with this name!" );
  68:	51                   	push   %ecx
  69:	51                   	push   %ecx
  6a:	68 4a 07 00 00       	push   $0x74a
  6f:	6a 01                	push   $0x1
  71:	e8 ca 03 00 00       	call   440 <printf>
...
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
 383:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
 387:	8b 4c 24 08          	mov    0x8(%esp),%ecx
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb 7d 07 00 00       	mov    $0x77d,%ebx
...
free(void *ap)
{
 ...
 5d1:	a1 78 0a 00 00       	mov    0xa78,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 78 0a 00 00       	mov    %eax,0xa78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 78 0a 00 00    	mov    0xa78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ab:	3b 05 78 0a 00 00    	cmp    0xa78,%eax
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 78 0a 00 00    	mov    0xa78,%edx
 ...
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 7c 0a 00 00       	mov    $0xa7c,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 730:	00 00 00 
    if(p->s.size >= nunits){
