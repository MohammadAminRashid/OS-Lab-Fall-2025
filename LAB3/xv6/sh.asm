...
fork1(void)
{
  ...
  exit();
     ...
     110:	6a 02                	push   $0x2
     112:	e8 79 0e 00 00       	call   f90 <printf>
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 b0 19 00 00       	push   $0x19b0
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 b0 19 00 00       	push   $0x19b0
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 a8 19 00 00       	push   $0x19a8
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 b0 19 00 00       	push   $0x19b0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 b0 19 00 00       	push   $0x19b0
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ad5:	ff 24 85 68 13 00 00 	jmp    *0x1368(,%eax,4)
...
00000eb3 <make_duplicate>:
SYSCALL(make_duplicate)
     eb3:	b8 17 00 00 00       	mov    $0x17,%eax
     eb8:	cd 40                	int    $0x40
     eba:	c3                   	ret    

00000ebb <show_process_family>:
SYSCALL(show_process_family)
     ebb:	b8 18 00 00 00       	mov    $0x18,%eax
     ec0:	cd 40                	int    $0x40
     ec2:	c3                   	ret    

00000ec3 <grep_syscall>:
SYSCALL(grep_syscall)
     ec3:	b8 19 00 00 00       	mov    $0x19,%eax
     ec8:	cd 40                	int    $0x40
     eca:	c3                   	ret    

00000ecb <set_priority_syscall>:
SYSCALL(set_priority_syscall)
     ecb:	b8 1a 00 00 00       	mov    $0x1a,%eax
     ed0:	cd 40                	int    $0x40
     ed2:	c3                   	ret    

00000ed3 <simple_arithmetic_syscall>:

.globl simple_arithmetic_syscall
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
     ed3:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
     ed7:	8b 4c 24 08          	mov    0x8(%esp),%ecx
  movl $SYS_simple_arithmetic_syscall, %eax 
     edb:	b8 16 00 00 00       	mov    $0x16,%eax
  int $T_SYSCALL    
     ee0:	cd 40                	int    $0x40
  ret                
     ee2:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
     ef8:	89 d1                	mov    %edx,%ecx
{
     efa:	83 ec 3c             	sub    $0x3c,%esp
     efd:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
     f00:	85 d2                	test   %edx,%edx
     f02:	0f 89 80 00 00 00    	jns    f88 <printint+0x98>
     f08:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
     f0c:	74 7a                	je     f88 <printint+0x98>
    x = -xx;
     f0e:	f7 d9                	neg    %ecx
    neg = 1;
  ...
  i = 0;
     f15:	89 45 c4             	mov    %eax,-0x3c(%ebp)
     f18:	31 f6                	xor    %esi,%esi
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f2b:	0f b6 92 e0 13 00 00 	movzbl 0x13e0(%edx),%edx
     f32:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
     f36:	89 ca                	mov    %ecx,%edx
     f38:	89 c1                	mov    %eax,%ecx
     f3a:	39 da                	cmp    %ebx,%edx
     f3c:	73 e2                	jae    f20 <printint+0x30>
  if(neg)
     f3e:	8b 45 c4             	mov    -0x3c(%ebp),%eax
     f41:	85 c0                	test   %eax,%eax
     f43:	74 07                	je     f4c <printint+0x5c>
    buf[i++] = '-';
  ...
  while(--i >= 0)
     ...
     f4f:	8b 75 c0             	mov    -0x40(%ebp),%esi
     f52:	01 df                	add    %ebx,%edi
     f54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
     f58:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
     f5b:	83 ec 04             	sub    $0x4,%esp
     f5e:	88 45 d7             	mov    %al,-0x29(%ebp)
     f61:	8d 45 d7             	lea    -0x29(%ebp),%eax
     f64:	6a 01                	push   $0x1
     f66:	50                   	push   %eax
     f67:	56                   	push   %esi
     f68:	e8 c6 fe ff ff       	call   e33 <write>
  while(--i >= 0)
     f6d:	89 f8                	mov    %edi,%eax
     f6f:	83 c4 10             	add    $0x10,%esp
     f72:	83 ef 01             	sub    $0x1,%edi
     f75:	39 c3                	cmp    %eax,%ebx
     f77:	75 df                	jne    f58 <printint+0x68>
}
     f79:	8d 65 f4             	lea    -0xc(%ebp),%esp
     f7c:	5b                   	pop    %ebx
     f7d:	5e                   	pop    %esi
     f7e:	5f                   	pop    %edi
     f7f:	5d                   	pop    %ebp
  ...
  neg = 0;
     ...
     f8a:	eb 89                	jmp    f15 <printint+0x25>
...
{
     f9c:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
     f9f:	0f b6 1e             	movzbl (%esi),%ebx
     fa2:	83 c6 01             	add    $0x1,%esi
     fa5:	84 db                	test   %bl,%bl
     fa7:	74 67                	je     1010 <printf+0x80>
     fa9:	8d 4d 10             	lea    0x10(%ebp),%ecx
     fac:	31 d2                	xor    %edx,%edx
     fae:	89 4d d0             	mov    %ecx,-0x30(%ebp)
     fb1:	eb 34                	jmp    fe7 <printf+0x57>
     fb3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     fb7:	90                   	nop
     fb8:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
     fbb:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
     fc0:	83 f8 25             	cmp    $0x25,%eax
     fc3:	74 18                	je     fdd <printf+0x4d>
  write(fd, &c, 1);
     fc5:	83 ec 04             	sub    $0x4,%esp
     fc8:	8d 45 e7             	lea    -0x19(%ebp),%eax
     fcb:	88 5d e7             	mov    %bl,-0x19(%ebp)
     fce:	6a 01                	push   $0x1
     fd0:	50                   	push   %eax
     fd1:	57                   	push   %edi
     fd2:	e8 5c fe ff ff       	call   e33 <write>
     fd7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
     fda:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
     fdd:	0f b6 1e             	movzbl (%esi),%ebx
     fe0:	83 c6 01             	add    $0x1,%esi
     fe3:	84 db                	test   %bl,%bl
     fe5:	74 29                	je     1010 <printf+0x80>
    c = fmt[i] & 0xff;
     fe7:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
     fea:	85 d2                	test   %edx,%edx
     fec:	74 ca                	je     fb8 <printf+0x28>
      }
    } else if(state == '%'){
     fee:	83 fa 25             	cmp    $0x25,%edx
     ff1:	75 ea                	jne    fdd <printf+0x4d>
      if(c == 'd'){
     ff3:	83 f8 25             	cmp    $0x25,%eax
     ff6:	0f 84 04 01 00 00    	je     1100 <printf+0x170>
     ffc:	83 e8 63             	sub    $0x63,%eax
     fff:	83 f8 15             	cmp    $0x15,%eax
    1002:	77 1c                	ja     1020 <printf+0x90>
    1004:	ff 24 85 88 13 00 00 	jmp    *0x1388(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    1023:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1026:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    102a:	6a 01                	push   $0x1
    102c:	52                   	push   %edx
    102d:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    1030:	57                   	push   %edi
    1031:	e8 fd fd ff ff       	call   e33 <write>
    1036:	83 c4 0c             	add    $0xc,%esp
    1039:	88 5d e7             	mov    %bl,-0x19(%ebp)
    103c:	6a 01                	push   $0x1
    103e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    1041:	52                   	push   %edx
    1042:	57                   	push   %edi
    1043:	e8 eb fd ff ff       	call   e33 <write>
        putc(fd, c);
    1048:	83 c4 10             	add    $0x10,%esp
      state = 0;
    104b:	31 d2                	xor    %edx,%edx
    104d:	eb 8e                	jmp    fdd <printf+0x4d>
    104f:	90                   	nop
        printint(fd, *ap, 16, 0);
    1050:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1053:	83 ec 0c             	sub    $0xc,%esp
    1056:	b9 10 00 00 00       	mov    $0x10,%ecx
    105b:	8b 13                	mov    (%ebx),%edx
    105d:	6a 00                	push   $0x0
    105f:	89 f8                	mov    %edi,%eax
        ap++;
    1061:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    1064:	e8 87 fe ff ff       	call   ef0 <printint>
        ap++;
    1069:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    106c:	83 c4 10             	add    $0x10,%esp
      state = 0;
    106f:	31 d2                	xor    %edx,%edx
    1071:	e9 67 ff ff ff       	jmp    fdd <printf+0x4d>
        s = (char*)*ap;
    1076:	8b 45 d0             	mov    -0x30(%ebp),%eax
    1079:	8b 18                	mov    (%eax),%ebx
        ap++;
    107b:	83 c0 04             	add    $0x4,%eax
    107e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    1081:	85 db                	test   %ebx,%ebx
    1083:	0f 84 87 00 00 00    	je     1110 <printf+0x180>
        while(*s != 0){
    1089:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    108c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    108e:	84 c0                	test   %al,%al
    1090:	0f 84 47 ff ff ff    	je     fdd <printf+0x4d>
    1096:	8d 55 e7             	lea    -0x19(%ebp),%edx
    1099:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    109c:	89 de                	mov    %ebx,%esi
    109e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
  ...
  write(fd, &c, 1);
    ...
    10ab:	53                   	push   %ebx
    10ac:	57                   	push   %edi
    10ad:	e8 81 fd ff ff       	call   e33 <write>
        while(*s != 0){
    ...
    10c1:	e9 17 ff ff ff       	jmp    fdd <printf+0x4d>
        printint(fd, *ap, 10, 1);
    10c6:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    10c9:	83 ec 0c             	sub    $0xc,%esp
    10cc:	b9 0a 00 00 00       	mov    $0xa,%ecx
    10d1:	8b 13                	mov    (%ebx),%edx
    10d3:	6a 01                	push   $0x1
    10d5:	eb 88                	jmp    105f <printf+0xcf>
        putc(fd, *ap);
    10d7:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    10da:	83 ec 04             	sub    $0x4,%esp
    10dd:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    10e0:	8b 03                	mov    (%ebx),%eax
        ap++;
    10e2:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    10e5:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    10e8:	6a 01                	push   $0x1
    10ea:	52                   	push   %edx
    10eb:	57                   	push   %edi
    10ec:	e8 42 fd ff ff       	call   e33 <write>
        ap++;
    10f1:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    10f4:	83 c4 10             	add    $0x10,%esp
      state = 0;
    10f7:	31 d2                	xor    %edx,%edx
    10f9:	e9 df fe ff ff       	jmp    fdd <printf+0x4d>
  ...
  write(fd, &c, 1);
    ...
    1109:	6a 01                	push   $0x1
    110b:	e9 31 ff ff ff       	jmp    1041 <printf+0xb1>
    1110:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1115:	bb 80 13 00 00       	mov    $0x1380,%ebx
    111a:	e9 77 ff ff ff       	jmp    1096 <printf+0x106>
    111f:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1121:	a1 24 1a 00 00       	mov    0x1a24,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1138:	8b 10                	mov    (%eax),%edx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    113a:	39 c8                	cmp    %ecx,%eax
  ...
  freep = p;
    ...
    115f:	5b                   	pop    %ebx
  freep = p;
    1160:	a3 24 1a 00 00       	mov    %eax,0x1a24
}
    1165:	5e                   	pop    %esi
    1166:	5f                   	pop    %edi
    1167:	5d                   	pop    %ebp
    ...
    1176:	72 ce                	jb     1146 <free+0x26>
{
  ...
  freep = p;
    119a:	a3 24 1a 00 00       	mov    %eax,0x1a24
    p->s.size += bp->s.size;
    119f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    11a2:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    11a5:	89 08                	mov    %ecx,(%eax)
}
    11a7:	5b                   	pop    %ebx
    11a8:	5e                   	pop    %esi
    11a9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    11bc:	8b 15 24 1a 00 00    	mov    0x1a24,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11fb:	3b 05 24 1a 00 00    	cmp    0x1a24,%eax
  ...
  return freep;
    1223:	8b 15 24 1a 00 00    	mov    0x1a24,%edx
    ...
    124c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    124f:	89 15 24 1a 00 00    	mov    %edx,0x1a24
}
    ...
    125f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1260:	c7 05 24 1a 00 00 28 	movl   $0x1a28,0x1a24
    1267:	1a 00 00 
    base.s.size = 0;
    126a:	b8 28 1a 00 00       	mov    $0x1a28,%eax
    base.s.ptr = freep = prevp = &base;
    126f:	c7 05 28 1a 00 00 28 	movl   $0x1a28,0x1a28
    1276:	1a 00 00 
    base.s.size = 0;
    1279:	c7 05 2c 1a 00 00 00 	movl   $0x0,0x1a2c
    1280:	00 00 00 
    if(p->s.size >= nunits){
