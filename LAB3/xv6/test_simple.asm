  ...
  13:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  34:	e8 f7 01 00 00       	call   230 <atoi>
  39:	89 c6                	mov    %eax,%esi
  b = atoi(argv[2]);
  3b:	58                   	pop    %eax
  3c:	ff 73 08             	pushl  0x8(%ebx)
  3f:	e8 ec 01 00 00       	call   230 <atoi>
  ...
  46:	50                   	push   %eax
  47:	56                   	push   %esi
  48:	e8 16 03 00 00       	call   363 <simple_arithmetic_syscall>
    
  exit();
  4d:	e8 51 02 00 00       	call   2a3 <exit>
  52:	66 90                	xchg   %ax,%ax
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
...
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
 363:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
 367:	8b 4c 24 08          	mov    0x8(%esp),%ecx
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb 40 07 00 00       	mov    $0x740,%ebx
