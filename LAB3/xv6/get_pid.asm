...
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
 333:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
 337:	8b 4c 24 08          	mov    0x8(%esp),%ecx
 ...
 358:	89 d1                	mov    %edx,%ecx
{
 ...
 38b:	0f b6 92 64 07 00 00 	movzbl 0x764(%edx),%edx
 ...
 3f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 464:	ff 24 85 0c 07 00 00 	jmp    *0x70c(,%eax,4)
 ...
 570:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 575:	bb 03 07 00 00       	mov    $0x703,%ebx
...
free(void *ap)
{
 ...
 581:	a1 00 0a 00 00       	mov    0xa00,%eax
{
 ...
 5bf:	5b                   	pop    %ebx
  freep = p;
 5c0:	a3 00 0a 00 00       	mov    %eax,0xa00
}
 5c5:	5e                   	pop    %esi
 5c6:	5f                   	pop    %edi
 5c7:	5d                   	pop    %ebp
 ...
 5d6:	72 ce                	jb     5a6 <free+0x26>
{
 ...
 5f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5fa:	a3 00 0a 00 00       	mov    %eax,0xa00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 00 0a 00 00    	mov    0xa00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65b:	3b 05 00 0a 00 00    	cmp    0xa00,%eax
 ...
 67e:	e8 fd fe ff ff       	call   580 <free>
  return freep;
 683:	8b 15 00 0a 00 00    	mov    0xa00,%edx
 ...
 6ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6af:	89 15 00 0a 00 00    	mov    %edx,0xa00
}
 ...
 6bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6c0:	c7 05 00 0a 00 00 04 	movl   $0xa04,0xa00
 6c7:	0a 00 00 
    base.s.size = 0;
 6ca:	b8 04 0a 00 00       	mov    $0xa04,%eax
    base.s.ptr = freep = prevp = &base;
 6cf:	c7 05 04 0a 00 00 04 	movl   $0xa04,0xa04
 6d6:	0a 00 00 
    base.s.size = 0;
 6d9:	c7 05 08 0a 00 00 00 	movl   $0x0,0xa08
 6e0:	00 00 00 
    if(p->s.size >= nunits){
