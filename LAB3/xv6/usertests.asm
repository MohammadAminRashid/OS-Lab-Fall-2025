...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 38 5e 00 00    	pushl  0x5e38
     ...
     2a0:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    exit();
     ...
     2ce:	ff 35 38 5e 00 00    	pushl  0x5e38
     ...
     2e5:	ff 35 38 5e 00 00    	pushl  0x5e38
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 38 5e 00 00    	pushl  0x5e38
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 38 5e 00 00    	pushl  0x5e38
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 38 5e 00 00    	pushl  0x5e38
     ...
     5de:	ff 35 38 5e 00 00    	pushl  0x5e38
     ...
     5f7:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 38 5e 00 00    	pushl  0x5e38
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 38 5e 00 00    	pushl  0x5e38
     ...
     793:	ff 35 38 5e 00 00    	pushl  0x5e38
     ...
     7aa:	ff 35 38 5e 00 00    	pushl  0x5e38
     ...
     7c3:	ff 35 38 5e 00 00    	pushl  0x5e38
     ...
     7de:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 38 5e 00 00    	pushl  0x5e38
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 38 5e 00 00    	pushl  0x5e38
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 38 5e 00 00    	pushl  0x5e38
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test OK\n");
    ...
    2d18:	50                   	push   %eax
    2d19:	50                   	push   %eax
    2d1a:	68 a8 52 00 00       	push   $0x52a8
    2d1f:	6a 01                	push   $0x1
    ...
    2d35:	31 f6                	xor    %esi,%esi
{
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2faa:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    302e:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3049:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3063:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3082:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3099:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    30b0:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    30c7:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    30de:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    310d:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3124:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    313b:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3152:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3184:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    318f:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "validate ok\n");
    ...
    31f9:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    321b:	ff 35 38 5e 00 00    	pushl  0x5e38
...
00003230 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    323b:	ff 35 38 5e 00 00    	pushl  0x5e38
  ...
  printf(stdout, "bss test ok\n");
    ...
    326b:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    3283:	ff 35 38 5e 00 00    	pushl  0x5e38
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32fb:	c7 04 85 80 a5 00 00 	movl   $0x53c0,0xa580(,%eax,4)
    3302:	c0 53 00 00 
    for(i = 0; i < MAXARG-1; i++)
    3306:	b8 01 00 00 00       	mov    $0x1,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    330b:	c7 04 85 80 a5 00 00 	movl   $0x53c0,0xa580(,%eax,4)
    3312:	c0 53 00 00 
    3316:	c7 04 85 84 a5 00 00 	movl   $0x53c0,0xa584(,%eax,4)
    331d:	c0 53 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    3332:	ff 35 38 5e 00 00    	pushl  0x5e38
    args[MAXARG-1] = 0;
    ...
    335b:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    338b:	ff 35 38 5e 00 00    	pushl  0x5e38
    ...
    33a2:	ff 35 38 5e 00 00    	pushl  0x5e38
...
00003590 <uio>:
{
  ...
  printf(1, "uio test done\n");
    ...
    35da:	52                   	push   %edx
    35db:	52                   	push   %edx
    35dc:	68 a0 54 00 00       	push   $0x54a0
    35e1:	6a 01                	push   $0x1
...
simple_arithmetic_syscall:
  movl 4(%esp), %ebx  
    3993:	8b 5c 24 04          	mov    0x4(%esp),%ebx
  movl 8(%esp), %ecx  
    3997:	8b 4c 24 08          	mov    0x8(%esp),%ecx
    ...
    3a59:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3a73:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3a77:	90                   	nop
