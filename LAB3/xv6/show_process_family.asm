  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  27:	e8 1f 03 00 00       	call   34b <show_process_family>
    
    if (ret == -1)
  2c:	83 c4 10             	add    $0x10,%esp
  2f:	83 c0 01             	add    $0x1,%eax
  32:	74 18                	je     4c <main+0x4c>
    ...
    exit();
  34:	e8 6a 02 00 00       	call   2a3 <exit>
        printf(1, "\n");
  39:	52                   	push   %edx
  3a:	52                   	push   %edx
  3b:	68 28 07 00 00       	push   $0x728
  40:	6a 01                	push   $0x1
  ...
  4c:	50                   	push   %eax
  4d:	50                   	push   %eax
  4e:	68 2a 07 00 00       	push   $0x72a
  53:	6a 01                	push   $0x1
  55:	e8 c6 03 00 00       	call   420 <printf>
  5a:	83 c4 10             	add    $0x10,%esp
  5d:	eb d5                	jmp    34 <main+0x34>
  5f:	90                   	nop
